...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Intermediate Catch Event To Alternative Flow</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link BpmnToUseCaseIntegration.impl.IntermediateCatchEventToAlternativeFlowImpl#getSource <em>Source</em>}</li>
 *   <li>{@link BpmnToUseCaseIntegration.impl.IntermediateCatchEventToAlternativeFlowImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntermediateCatchEventToAlternativeFlowImpl extends
	 ...
	 * @generated
	 */
	protected IntermediateCatchEventToAlternativeFlowImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BpmnToUseCaseIntegrationPackage.Literals.INTERMEDIATE_CATCH_EVENT_TO_ALTERNATIVE_FLOW;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							BpmnToUseCaseIntegrationPackage.INTERMEDIATE_CATCH_EVENT_TO_ALTERNATIVE_FLOW__SOURCE,
							oldSource, source));
			}
		}
		return source;
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							BpmnToUseCaseIntegrationPackage.INTERMEDIATE_CATCH_EVENT_TO_ALTERNATIVE_FLOW__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BpmnToUseCaseIntegrationPackage.INTERMEDIATE_CATCH_EVENT_TO_ALTERNATIVE_FLOW__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case BpmnToUseCaseIntegrationPackage.INTERMEDIATE_CATCH_EVENT_TO_ALTERNATIVE_FLOW__TARGET:
			if (resolve)
				return getTarget();
	...
	// [user code injected with eMoflon] -->
} //IntermediateCatchEventToAlternativeFlowImpl
