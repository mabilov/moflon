...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sequence Flow To Alternative Flow Alternative</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link BpmnToUseCaseIntegration.impl.SequenceFlowToAlternativeFlowAlternativeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link BpmnToUseCaseIntegration.impl.SequenceFlowToAlternativeFlowAlternativeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SequenceFlowToAlternativeFlowAlternativeImpl extends
	 ...
	 * @generated
	 */
	protected SequenceFlowToAlternativeFlowAlternativeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BpmnToUseCaseIntegrationPackage.Literals.SEQUENCE_FLOW_TO_ALTERNATIVE_FLOW_ALTERNATIVE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							BpmnToUseCaseIntegrationPackage.SEQUENCE_FLOW_TO_ALTERNATIVE_FLOW_ALTERNATIVE__SOURCE,
							oldSource, source));
			}
		}
		return source;
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							BpmnToUseCaseIntegrationPackage.SEQUENCE_FLOW_TO_ALTERNATIVE_FLOW_ALTERNATIVE__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BpmnToUseCaseIntegrationPackage.SEQUENCE_FLOW_TO_ALTERNATIVE_FLOW_ALTERNATIVE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case BpmnToUseCaseIntegrationPackage.SEQUENCE_FLOW_TO_ALTERNATIVE_FLOW_ALTERNATIVE__TARGET:
			if (resolve)
				return getTarget();
	...
	// [user code injected with eMoflon] -->
} //SequenceFlowToAlternativeFlowAlternativeImpl
