...
public class UserTaskToStepAfterSERuleImpl extends AbstractRuleImpl implements
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_205(
		...
		FlowElementsContainer __DEC_outFlow_flowElements_510330 = null;
		FlowElementsContainer __DEC_task_flowElements_843426 = null;
		Iterator fujaba__IterTaskTo__DEC_task_targetRef_695357 = null;
		SequenceFlow __DEC_task_targetRef_695357 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_510330 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_510330 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_510330 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_510330
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_510330 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_510330
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_task_flowElements_843426 = task
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) task
													.eContainer() : null;

											// check object __DEC_task_flowElements_843426 is really bound
											JavaSDM.ensure(__DEC_task_flowElements_843426 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_task_flowElements_843426
													.getFlowElements()
													.contains(task));

											// check isomorphic binding between objects __DEC_task_flowElements_843426 and process 
											JavaSDM.ensure(!__DEC_task_flowElements_843426
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from task to __DEC_task_targetRef_695357
											fujaba__Success = false;

											fujaba__IterTaskTo__DEC_task_targetRef_695357 = new ArrayList(
													task.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterTaskTo__DEC_task_targetRef_695357
															.hasNext()) {
												try {
													__DEC_task_targetRef_695357 = (SequenceFlow) fujaba__IterTaskTo__DEC_task_targetRef_695357
															.next();

													// check object __DEC_task_targetRef_695357 is really bound
													JavaSDM.ensure(__DEC_task_targetRef_695357 != null);
													// check isomorphic binding between objects __DEC_task_targetRef_695357 and inFlow 
													JavaSDM.ensure(!__DEC_task_targetRef_695357
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_task_targetRef_695357 and outFlow 
													JavaSDM.ensure(!__DEC_task_targetRef_695357
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_206(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_outFlow_flowElements_485006 = null;
		FlowElementsContainer __DEC_task_flowElements_845956 = null;
		Iterator fujaba__IterTaskTo__DEC_task_targetRef_946282 = null;
		SequenceFlow __DEC_task_targetRef_946282 = null;
		Match match = null;
										...
										try {
											...
											try {
												...
												try {
													...
													// bind object
													__DEC_outFlow_flowElements_485006 = outFlow
															.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
															.eContainer()
															: null;

													// check object __DEC_outFlow_flowElements_485006 is really bound
													JavaSDM.ensure(__DEC_outFlow_flowElements_485006 != null);

													// check if contained via correct reference
													JavaSDM.ensure(__DEC_outFlow_flowElements_485006
															.getFlowElements()
															.contains(outFlow));

													// check isomorphic binding between objects __DEC_outFlow_flowElements_485006 and process 
													JavaSDM.ensure(!__DEC_outFlow_flowElements_485006
															.equals(process));
												...
												try {
													...
													// bind object
													__DEC_task_flowElements_845956 = task
															.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) task
															.eContainer()
															: null;

													// check object __DEC_task_flowElements_845956 is really bound
													JavaSDM.ensure(__DEC_task_flowElements_845956 != null);

													// check if contained via correct reference
													JavaSDM.ensure(__DEC_task_flowElements_845956
															.getFlowElements()
															.contains(task));

													// check isomorphic binding between objects __DEC_task_flowElements_845956 and process 
													JavaSDM.ensure(!__DEC_task_flowElements_845956
															.equals(process));
												...
												try {
													...
													// iterate to-many link incoming from task to __DEC_task_targetRef_946282
													fujaba__Success = false;

													fujaba__IterTaskTo__DEC_task_targetRef_946282 = new ArrayList(
															task.getIncoming())
															.iterator();

													while (!(fujaba__Success)
															&& fujaba__IterTaskTo__DEC_task_targetRef_946282
																	.hasNext()) {
														try {
															__DEC_task_targetRef_946282 = (SequenceFlow) fujaba__IterTaskTo__DEC_task_targetRef_946282
																	.next();

															// check object __DEC_task_targetRef_946282 is really bound
															JavaSDM.ensure(__DEC_task_targetRef_946282 != null);
															// check isomorphic binding between objects __DEC_task_targetRef_946282 and inFlow 
															JavaSDM.ensure(!__DEC_task_targetRef_946282
																	.equals(inFlow));

															// check isomorphic binding between objects __DEC_task_targetRef_946282 and outFlow 
															JavaSDM.ensure(!__DEC_task_targetRef_946282
																	.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_207(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_outFlow_flowElements_511471 = null;
		FlowElementsContainer __DEC_task_flowElements_732664 = null;
		Iterator fujaba__IterTaskTo__DEC_task_targetRef_796106 = null;
		SequenceFlow __DEC_task_targetRef_796106 = null;
		Match match = null;
		Iterator fujaba__IterLaneSetToLane = null;
		Lane lane = null;
		Iterator fujaba__IterProcessToLaneSet = null;
												...
												try {
													...
													try {
														...
														try {
															...
															// bind object
															__DEC_outFlow_flowElements_511471 = outFlow
																	.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
																	.eContainer()
																	: null;

															// check object __DEC_outFlow_flowElements_511471 is really bound
															JavaSDM.ensure(__DEC_outFlow_flowElements_511471 != null);

															// check if contained via correct reference
															JavaSDM.ensure(__DEC_outFlow_flowElements_511471
																	.getFlowElements()
																	.contains(
																			outFlow));

															// check isomorphic binding between objects __DEC_outFlow_flowElements_511471 and process 
															JavaSDM.ensure(!__DEC_outFlow_flowElements_511471
																	.equals(process));
														...
														try {
															...
															// bind object
															__DEC_task_flowElements_732664 = task
																	.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) task
																	.eContainer()
																	: null;

															// check object __DEC_task_flowElements_732664 is really bound
															JavaSDM.ensure(__DEC_task_flowElements_732664 != null);

															// check if contained via correct reference
															JavaSDM.ensure(__DEC_task_flowElements_732664
																	.getFlowElements()
																	.contains(
																			task));

															// check isomorphic binding between objects __DEC_task_flowElements_732664 and process 
															JavaSDM.ensure(!__DEC_task_flowElements_732664
																	.equals(process));
														...
														try {
															...
															// iterate to-many link incoming from task to __DEC_task_targetRef_796106
															fujaba__Success = false;

															fujaba__IterTaskTo__DEC_task_targetRef_796106 = new ArrayList(
																	task.getIncoming())
																	.iterator();

															while (!(fujaba__Success)
																	&& fujaba__IterTaskTo__DEC_task_targetRef_796106
																			.hasNext()) {
																try {
																	__DEC_task_targetRef_796106 = (SequenceFlow) fujaba__IterTaskTo__DEC_task_targetRef_796106
																			.next();

																	// check object __DEC_task_targetRef_796106 is really bound
																	JavaSDM.ensure(__DEC_task_targetRef_796106 != null);
																	// check isomorphic binding between objects __DEC_task_targetRef_796106 and inFlow 
																	JavaSDM.ensure(!__DEC_task_targetRef_796106
																			.equals(inFlow));

																	// check isomorphic binding between objects __DEC_task_targetRef_796106 and outFlow 
																	JavaSDM.ensure(!__DEC_task_targetRef_796106
																			.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_208(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_outFlow_flowElements_609363 = null;
		FlowElementsContainer __DEC_task_flowElements_394083 = null;
		Iterator fujaba__IterTaskTo__DEC_task_targetRef_95670 = null;
		SequenceFlow __DEC_task_targetRef_95670 = null;
		Match match = null;
		Iterator fujaba__IterLaneSetToLane = null;
		Lane lane = null;
		Iterator fujaba__IterProcessToLaneSet = null;
										...
										try {
											...
											try {
												...
												try {
													...
													// bind object
													__DEC_outFlow_flowElements_609363 = outFlow
															.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
															.eContainer()
															: null;

													// check object __DEC_outFlow_flowElements_609363 is really bound
													JavaSDM.ensure(__DEC_outFlow_flowElements_609363 != null);

													// check if contained via correct reference
													JavaSDM.ensure(__DEC_outFlow_flowElements_609363
															.getFlowElements()
															.contains(outFlow));

													// check isomorphic binding between objects __DEC_outFlow_flowElements_609363 and process 
													JavaSDM.ensure(!__DEC_outFlow_flowElements_609363
															.equals(process));
												...
												try {
													...
													// bind object
													__DEC_task_flowElements_394083 = task
															.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) task
															.eContainer()
															: null;

													// check object __DEC_task_flowElements_394083 is really bound
													JavaSDM.ensure(__DEC_task_flowElements_394083 != null);

													// check if contained via correct reference
													JavaSDM.ensure(__DEC_task_flowElements_394083
															.getFlowElements()
															.contains(task));

													// check isomorphic binding between objects __DEC_task_flowElements_394083 and process 
													JavaSDM.ensure(!__DEC_task_flowElements_394083
															.equals(process));
												...
												try {
													...
													// iterate to-many link incoming from task to __DEC_task_targetRef_95670
													fujaba__Success = false;

													fujaba__IterTaskTo__DEC_task_targetRef_95670 = new ArrayList(
															task.getIncoming())
															.iterator();

													while (!(fujaba__Success)
															&& fujaba__IterTaskTo__DEC_task_targetRef_95670
																	.hasNext()) {
														try {
															__DEC_task_targetRef_95670 = (SequenceFlow) fujaba__IterTaskTo__DEC_task_targetRef_95670
																	.next();

															// check object __DEC_task_targetRef_95670 is really bound
															JavaSDM.ensure(__DEC_task_targetRef_95670 != null);
															// check isomorphic binding between objects __DEC_task_targetRef_95670 and inFlow 
															JavaSDM.ensure(!__DEC_task_targetRef_95670
																	.equals(inFlow));

															// check isomorphic binding between objects __DEC_task_targetRef_95670 and outFlow 
															JavaSDM.ensure(!__DEC_task_targetRef_95670
																	.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_209(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_outFlow_flowElements_125714 = null;
		FlowElementsContainer __DEC_task_flowElements_525764 = null;
		Iterator fujaba__IterTaskTo__DEC_task_targetRef_949411 = null;
		SequenceFlow __DEC_task_targetRef_949411 = null;
		Match match = null;
		Iterator fujaba__IterLaneSetToLane = null;
		Lane lane = null;
		Iterator fujaba__IterProcessToLaneSet = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_125714 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_125714 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_125714 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_125714
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_125714 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_125714
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_task_flowElements_525764 = task
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) task
													.eContainer() : null;

											// check object __DEC_task_flowElements_525764 is really bound
											JavaSDM.ensure(__DEC_task_flowElements_525764 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_task_flowElements_525764
													.getFlowElements()
													.contains(task));

											// check isomorphic binding between objects __DEC_task_flowElements_525764 and process 
											JavaSDM.ensure(!__DEC_task_flowElements_525764
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from task to __DEC_task_targetRef_949411
											fujaba__Success = false;

											fujaba__IterTaskTo__DEC_task_targetRef_949411 = new ArrayList(
													task.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterTaskTo__DEC_task_targetRef_949411
															.hasNext()) {
												try {
													__DEC_task_targetRef_949411 = (SequenceFlow) fujaba__IterTaskTo__DEC_task_targetRef_949411
															.next();

													// check object __DEC_task_targetRef_949411 is really bound
													JavaSDM.ensure(__DEC_task_targetRef_949411 != null);
													// check isomorphic binding between objects __DEC_task_targetRef_949411 and inFlow 
													JavaSDM.ensure(!__DEC_task_targetRef_949411
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_task_targetRef_949411 and outFlow 
													JavaSDM.ensure(!__DEC_task_targetRef_949411
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_210(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_outFlow_flowElements_290984 = null;
		FlowElementsContainer __DEC_task_flowElements_99420 = null;
		Iterator fujaba__IterTaskTo__DEC_task_targetRef_258900 = null;
		SequenceFlow __DEC_task_targetRef_258900 = null;
		Match match = null;
										...
										try {
											...
											try {
												...
												try {
													...
													// bind object
													__DEC_outFlow_flowElements_290984 = outFlow
															.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
															.eContainer()
															: null;

													// check object __DEC_outFlow_flowElements_290984 is really bound
													JavaSDM.ensure(__DEC_outFlow_flowElements_290984 != null);

													// check if contained via correct reference
													JavaSDM.ensure(__DEC_outFlow_flowElements_290984
															.getFlowElements()
															.contains(outFlow));

													// check isomorphic binding between objects __DEC_outFlow_flowElements_290984 and process 
													JavaSDM.ensure(!__DEC_outFlow_flowElements_290984
															.equals(process));
												...
												try {
													...
													// bind object
													__DEC_task_flowElements_99420 = task
															.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) task
															.eContainer()
															: null;

													// check object __DEC_task_flowElements_99420 is really bound
													JavaSDM.ensure(__DEC_task_flowElements_99420 != null);

													// check if contained via correct reference
													JavaSDM.ensure(__DEC_task_flowElements_99420
															.getFlowElements()
															.contains(task));

													// check isomorphic binding between objects __DEC_task_flowElements_99420 and process 
													JavaSDM.ensure(!__DEC_task_flowElements_99420
															.equals(process));
												...
												try {
													...
													// iterate to-many link incoming from task to __DEC_task_targetRef_258900
													fujaba__Success = false;

													fujaba__IterTaskTo__DEC_task_targetRef_258900 = new ArrayList(
															task.getIncoming())
															.iterator();

													while (!(fujaba__Success)
															&& fujaba__IterTaskTo__DEC_task_targetRef_258900
																	.hasNext()) {
														try {
															__DEC_task_targetRef_258900 = (SequenceFlow) fujaba__IterTaskTo__DEC_task_targetRef_258900
																	.next();

															// check object __DEC_task_targetRef_258900 is really bound
															JavaSDM.ensure(__DEC_task_targetRef_258900 != null);
															// check isomorphic binding between objects __DEC_task_targetRef_258900 and inFlow 
															JavaSDM.ensure(!__DEC_task_targetRef_258900
																	.equals(inFlow));

															// check isomorphic binding between objects __DEC_task_targetRef_258900 and outFlow 
															JavaSDM.ensure(!__DEC_task_targetRef_258900
																	.equals(outFlow));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_64(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_641197 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_257297 = null;
		Step __DEC_normalStep_next_257297 = null;
		Match match = null;
		Actor actor = null;
		Flow flow = null;
		NormalStep normalStep = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_641197 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_641197 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_641197 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_641197.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_641197 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_641197.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_257297
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_257297 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_257297
									.hasNext()) {
						try {
							__DEC_normalStep_next_257297 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_257297
									.next();

							// check object __DEC_normalStep_next_257297 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_257297 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_257297 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_257297
									.equals(normalStep));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_65(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_910457 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_314667 = null;
		Step __DEC_normalStep_next_314667 = null;
		Match match = null;
		Actor actor = null;
		NormalStep normalStep = null;
		Flow flow = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_910457 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_910457 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_910457 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_910457.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_910457 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_910457.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_314667
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_314667 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_314667
									.hasNext()) {
						try {
							__DEC_normalStep_next_314667 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_314667
									.next();

							// check object __DEC_normalStep_next_314667 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_314667 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_314667 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_314667
									.equals(normalStep));
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STARTEVENT_LANE_USERTASK_ACTOR_LANETOACTOR_SEQUENCEFLOW_PROCESS_SEQUENCEFLOW_NORMALSTEP_FLOWNODETOSTEP_SEQUENCEFLOWTOUCFLOW_SEQUENCEFLOWTOSTEP_SEQUENCEFLOWTOUCFLOW_FLOW_LANESET_MODELGENERATORRULERESULT:
