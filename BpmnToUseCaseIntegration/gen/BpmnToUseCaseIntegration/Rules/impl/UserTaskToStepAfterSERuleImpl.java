...
public class UserTaskToStepAfterSERuleImpl extends AbstractRuleImpl implements
	...
	public boolean isAppropriate_FWD(Match match, StartEvent flowNode,
		...
		// initial bindings
		Object[] result1_black = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_0_1_blackBBBBBBBBB(this,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_0_2_bindingAndBlackFBBBBBBBBB(
		...
		// Check CSP
		if (UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_0_3_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_0_4_blackBBBBBBBB(match,
			...
			UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_0_4_greenBBBBBBFFFFFFF(
			...
			Object[] result5_black = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_0_5_blackBBBBBBBB(match,
							flowNode, lane, task, inFlow, process, outFlow,
							laneSet);
			...
			UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_0_5_greenBBBBBBFFFFFF(
			...
			UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_0_6_expressionBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet);
			return UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_0_7_expressionF();
		} else {
			return UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_1_bindingAndBlackFFFFFFFFFFFFBB(
		...
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_1_greenBBBFFFFBB(task,
		...
		Object[] result2_black = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_2_blackBBBBBB(task,
		...
		Object[] result2_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_2_greenFBBBBBB(task,
						outFlow, normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_3_blackBBBBBBBBBBBBBBBB(
		...
		UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		// register objects
		UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_5_expressionBBBBBBBBBBBBBBBBB(
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_2_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_2_1_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_2_2_bindingFFFFFFFB(match);
		...
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_2_2_blackBBBFFBBBFFBB(
						flowNode, lane, task, inFlow, process, outFlow,
						laneSet, match)) {
			...
			for (Object[] result3_black : UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_2_3_blackBBBBBBBBBBB(
							flowNode, lane, task, actor, laneToActor, inFlow,
							process, outFlow, inFlowToFlow, flow, laneSet)) {
				Object[] result3_green = UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_2_3_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFF(
				...
				// solve CSP
				Object[] result4_bindingAndBlack = UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_2_4_bindingAndBlackFBBBBBBBBBBBBB(
				...
				// check CSP
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_2_5_expressionFBB(
								this, csp)) {

					// add match to rule result
					Object[] result6_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_2_6_blackBB(
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_2_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_2_7_expressionFB(ruleresult);
	}
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {// Create CSP
	...
	public boolean isAppropriate_BWD(Match match, Actor actor,
		...
		// initial bindings
		Object[] result1_black = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_10_1_blackBBBBB(this, match,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_10_2_bindingAndBlackFBBBBB(
		...
		// Check CSP
		if (UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_10_3_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_10_4_blackBBBB(match,
							actor, normalStep, flow);
			if (result4_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect elements to be translated] failed."
			...
			UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_10_4_greenBBBBFF(match,
							actor, normalStep, flow);
			...
			// collect context elements
			Object[] result5_black = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_10_5_blackBBBB(match,
							actor, normalStep, flow);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect context elements] failed."
			...
			UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_10_5_greenBBB(match,
							actor, flow);

			// register objects to match
			UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_10_6_expressionBBBBB(
							this, match, actor, normalStep, flow);
			return UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_10_7_expressionF();
		} else {
			return UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_1_bindingAndBlackFFFFFFFFFFFBB(
						this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [perform transformation] failed."
		...
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_1_greenBFBBFBFFFBB(lane,
		...
		// collect translated elements
		Object[] result2_black = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_2_blackBBBBBB(task,
						outFlow, normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep);
		if (result2_black == null) {
			throw new RuntimeException(
		...
		Object[] result2_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_2_greenFBBBBBB(task,
						outFlow, normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		// bookkeeping for edges
		Object[] result3_black = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_3_blackBBBBBBBBBBBBBBBB(
						ruleresult, flowNode, lane, task, actor, laneToActor,
						inFlow, process, outFlow, normalStep, taskToNormalStep,
						outFlowToFlow, outFlowToNormalStep, inFlowToFlow, flow,
						laneSet);
		...
		UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
						ruleresult, lane, task, actor, inFlow, process,
						outFlow, normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep, flow);
		// EMoflonEdge lane__task____flowNodeRefs = (EMoflonEdge) result3_green[12];
		...
		// register objects
		UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_5_expressionBBBBBBBBBBBBBBBBB(
						this, ruleresult, flowNode, lane, task, actor,
						laneToActor, inFlow, process, outFlow, normalStep,
						taskToNormalStep, outFlowToFlow, outFlowToNormalStep,
						inFlowToFlow, flow, laneSet);
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_12_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		// EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_12_1_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_12_2_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException("Binding in node core match failed."
					+ " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_12_2_blackFBFFBFBB(actor,
			...
			// ForEach find context
			for (Object[] result3_black : UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_12_3_blackFBBBBFBBBF(
				...
				Object[] result3_green = UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_12_3_greenBBBBBBBBBBFFFFFFFFFFFFF(
				...
				// solve CSP
				Object[] result4_bindingAndBlack = UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_12_4_bindingAndBlackFBBBBBBBBBBBB(
				...
				// check CSP
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_12_5_expressionFBB(
								this, csp)) {

					// add match to rule result
					Object[] result6_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_12_6_blackBB(
									ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_12_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_12_7_expressionFB(ruleresult);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_396(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_20_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_20_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_20_2_blackFFFFFFFB(_edge_flowNodeRefs)) {
			...
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_20_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_20_3_expressionFBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_20_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_20_5_blackBBB(
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_20_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_20_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_397(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_21_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_21_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_21_2_blackFFFFFFFB(_edge_targetRef)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			Lane lane = (Lane) result2_black[1];
			UserTask task = (UserTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_21_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_21_3_expressionFBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_21_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_21_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_21_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_21_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_398(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_22_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_22_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_22_2_blackFFFFFFFB(_edge_incoming)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			Lane lane = (Lane) result2_black[1];
			UserTask task = (UserTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_22_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_22_3_expressionFBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_22_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_22_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_22_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_22_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_399(
			EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_23_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_23_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_23_2_blackFFFFFFFB(_edge_flowElements)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			Lane lane = (Lane) result2_black[1];
			UserTask task = (UserTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_23_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_23_3_expressionFBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_23_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_23_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_23_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_23_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_400(
			EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_24_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_24_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_24_2_blackFFFFFFFB(_edge_flowElements)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			Lane lane = (Lane) result2_black[1];
			UserTask task = (UserTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_24_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_24_3_expressionFBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_24_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_24_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_24_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_24_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_401(
			EMoflonEdge _edge_sourceRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_25_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_25_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_25_2_blackFFFFFFFB(_edge_sourceRef)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			Lane lane = (Lane) result2_black[1];
			UserTask task = (UserTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_25_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_25_3_expressionFBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_25_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_25_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_25_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_25_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_402(
			EMoflonEdge _edge_outgoing) {
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_26_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_26_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_26_2_blackFFFFFFFB(_edge_outgoing)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			Lane lane = (Lane) result2_black[1];
			UserTask task = (UserTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_26_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_26_3_expressionFBBBBBBBBB(
							this, match, flowNode, lane, task, inFlow, process,
							outFlow, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_26_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_26_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_26_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_26_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_861(
			EMoflonEdge _edge_actor) {
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_27_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_27_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_27_2_blackFFFB(_edge_actor)) {
			Actor actor = (Actor) result2_black[0];
			NormalStep normalStep = (NormalStep) result2_black[1];
			Flow flow = (Flow) result2_black[2];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_27_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_27_3_expressionFBBBBB(
							this, match, actor, normalStep, flow)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_27_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_27_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_27_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_27_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_862(
			EMoflonEdge _edge_steps) {
		// prepare return value
		Object[] result1_bindingAndBlack = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_28_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_28_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_28_2_blackFFFB(_edge_steps)) {
			Actor actor = (Actor) result2_black[0];
			NormalStep normalStep = (NormalStep) result2_black[1];
			Flow flow = (Flow) result2_black[2];
			Object[] result2_green = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_28_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_28_3_expressionFBBBBB(
							this, match, actor, normalStep, flow)) {
				// Ensure that the correct types of elements are matched
				if (UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_28_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_28_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_28_5_greenBBB(
									match, __performOperation, __result);
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_28_6_expressionFB(__result);
	}
	...
	public ModelgeneratorRuleResult generateModel(
		...
		// create result
		Object[] result1_black = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_31_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_31_1_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_31_2_blackFFFFFFFFFFBB(
			...
			// solve CSP
			Object[] result3_bindingAndBlack = UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_31_3_bindingAndBlackFBBBBBBBBBBBB(
							this, isApplicableMatch, flowNode, lane, actor,
			...
			// check CSP
			if (UserTaskToStepAfterSERuleImpl
					.pattern_UserTaskToStepAfterSERule_31_4_expressionFBB(this,
							csp)) {
				// check nacs
				Object[] result5_black = UserTaskToStepAfterSERuleImpl
						.pattern_UserTaskToStepAfterSERule_31_5_blackBBBBBBBBB(
								flowNode, lane, actor, laneToActor, inFlow,
				...
				if (result5_black != null) {
					...
					// perform
					Object[] result6_black = UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_31_6_blackBBBBBBBBBB(
									flowNode, lane, actor, laneToActor, inFlow,
									process, inFlowToFlow, flow, laneSet,
									ruleResult);
					if (result6_black == null) {
					...
					UserTaskToStepAfterSERuleImpl
							.pattern_UserTaskToStepAfterSERule_31_6_greenBFBBBFFFFFBBB(
		...
		return UserTaskToStepAfterSERuleImpl
				.pattern_UserTaskToStepAfterSERule_31_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_396__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_396((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_397__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_397((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_398__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_398((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_399__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_399((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_400__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_400((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_401__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_401((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_402__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_402((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_861__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_861((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_862__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_862((EMoflonEdge) arguments
					.get(0));
		...
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___GENERATE_MODEL__RULEENTRYCONTAINER_LANETOACTOR:
			return generateModel((RuleEntryContainer) arguments.get(0),
					(LaneToActor) arguments.get(1));
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STARTEVENT_LANE_ACTOR_LANETOACTOR_SEQUENCEFLOW_PROCESS_SEQUENCEFLOWTOUCFLOW_FLOW_LANESET_MODELGENERATORRULERESULT:
		...
		case RulesPackage.USER_TASK_TO_STEP_AFTER_SE_RULE___GENERATE_MODEL_CHECK_CSP_BWD__CSP:
			return generateModel_checkCsp_BWD((CSP) arguments.get(0));
		}
		return super.eInvoke(operationID, arguments);
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_0_1_blackBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_0_2_bindingFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_0_2_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_0_2_bindingAndBlackFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
		Object[] result_pattern_UserTaskToStepAfterSERule_0_2_binding = pattern_UserTaskToStepAfterSERule_0_2_bindingFBBBBBBBBB(
				_this, match, flowNode, lane, task, inFlow, process, outFlow,
				laneSet);
		if (result_pattern_UserTaskToStepAfterSERule_0_2_binding != null) {
			CSP csp = (CSP) result_pattern_UserTaskToStepAfterSERule_0_2_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_0_2_black = pattern_UserTaskToStepAfterSERule_0_2_blackB(csp);
			if (result_pattern_UserTaskToStepAfterSERule_0_2_black != null) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_0_3_expressionFBB(
			UserTaskToStepAfterSERule _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_0_4_blackBBBBBBBB(
			Match match, StartEvent flowNode, Lane lane, UserTask task,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_0_4_greenBBBBBBFFFFFFF(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_0_5_blackBBBBBBBB(
			Match match, StartEvent flowNode, Lane lane, UserTask task,
			SequenceFlow inFlow, bpmn2.Process process, SequenceFlow outFlow,
			LaneSet laneSet) {
		if (!inFlow.equals(outFlow)) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_0_5_greenBBBBBBFFFFFF(
			Match match, StartEvent flowNode, Lane lane, SequenceFlow inFlow,
	...
	public static final void pattern_UserTaskToStepAfterSERule_0_6_expressionBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_UserTaskToStepAfterSERule_0_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_1_1_bindingFFFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_1_1_blackBBBBBBBBBBBFBB(
			StartEvent flowNode, Lane lane, UserTask task, Actor actor,
			LaneToActor laneToActor, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
			UserTaskToStepAfterSERule _this, IsApplicableMatch isApplicableMatch) {
		if (!inFlow.equals(outFlow)) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_1_1_bindingAndBlackFFFFFFFFFFFFBB(
			UserTaskToStepAfterSERule _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_UserTaskToStepAfterSERule_1_1_binding = pattern_UserTaskToStepAfterSERule_1_1_bindingFFFFFFFFFFFB(isApplicableMatch);
		if (result_pattern_UserTaskToStepAfterSERule_1_1_binding != null) {
			StartEvent flowNode = (StartEvent) result_pattern_UserTaskToStepAfterSERule_1_1_binding[0];
			Lane lane = (Lane) result_pattern_UserTaskToStepAfterSERule_1_1_binding[1];
			UserTask task = (UserTask) result_pattern_UserTaskToStepAfterSERule_1_1_binding[2];
			Actor actor = (Actor) result_pattern_UserTaskToStepAfterSERule_1_1_binding[3];
			LaneToActor laneToActor = (LaneToActor) result_pattern_UserTaskToStepAfterSERule_1_1_binding[4];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_UserTaskToStepAfterSERule_1_1_binding[5];
			bpmn2.Process process = (bpmn2.Process) result_pattern_UserTaskToStepAfterSERule_1_1_binding[6];
			SequenceFlow outFlow = (SequenceFlow) result_pattern_UserTaskToStepAfterSERule_1_1_binding[7];
			SequenceFlowToUCFlow inFlowToFlow = (SequenceFlowToUCFlow) result_pattern_UserTaskToStepAfterSERule_1_1_binding[8];
			Flow flow = (Flow) result_pattern_UserTaskToStepAfterSERule_1_1_binding[9];
			LaneSet laneSet = (LaneSet) result_pattern_UserTaskToStepAfterSERule_1_1_binding[10];

			Object[] result_pattern_UserTaskToStepAfterSERule_1_1_black = pattern_UserTaskToStepAfterSERule_1_1_blackBBBBBBBBBBBFBB(
					flowNode, lane, task, actor, laneToActor, inFlow, process,
					outFlow, inFlowToFlow, flow, laneSet, _this,
					isApplicableMatch);
			if (result_pattern_UserTaskToStepAfterSERule_1_1_black != null) {
				CSP csp = (CSP) result_pattern_UserTaskToStepAfterSERule_1_1_black[11];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_1_1_greenBBBFFFFBB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_1_2_blackBBBBBB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_1_2_greenFBBBBBB(
			UserTask task, SequenceFlow outFlow, NormalStep normalStep,
			FlowNodeToStep taskToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow,
			SequenceFlowToStep outFlowToNormalStep) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_1_3_blackBBBBBBBBBBBBBBBB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_1_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		EMoflonEdge flow__normalStep____steps = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		String ruleresult_ruleName_prime = "UserTaskToStepAfterSERule";
		String lane__task____flowNodeRefs_name_prime = "flowNodeRefs";
		String inFlow__task____targetRef_name_prime = "targetRef";
		String task__inFlow____incoming_name_prime = "incoming";
		String process__task____flowElements_name_prime = "flowElements";
	...
	public static final void pattern_UserTaskToStepAfterSERule_1_5_expressionBBBBBBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this, PerformRuleResult ruleresult,
			EObject flowNode, EObject lane, EObject task, EObject actor,
			EObject laneToActor, EObject inFlow, EObject process,
			EObject outFlow, EObject normalStep, EObject taskToNormalStep,
			EObject outFlowToFlow, EObject outFlowToNormalStep,
	...
	public static final PerformRuleResult pattern_UserTaskToStepAfterSERule_1_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_2_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_1_blackFBB(
			EClass eClass, UserTaskToStepAfterSERule _this) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_2_1_binding = pattern_UserTaskToStepAfterSERule_2_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_2_1_binding != null) {
			EClass eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_2_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_2_1_black = pattern_UserTaskToStepAfterSERule_2_1_blackFBB(
					eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_2_1_black != null) {
				EOperation performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_2_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "UserTaskToStepAfterSERule";
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_2_bindingFFFFFFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_2_2_blackBBBFFBBBFFBB(
			StartEvent flowNode, Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet,
			Match match) {
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_2_3_blackBBBBBBBBBBB(
			StartEvent flowNode, Lane lane, UserTask task, Actor actor,
			LaneToActor laneToActor, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_3_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFF(
			StartEvent flowNode, Lane lane, UserTask task, Actor actor,
			LaneToActor laneToActor, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_4_bindingFBBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_2_4_bindingAndBlackFBBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			Lane lane, UserTask task, Actor actor, LaneToActor laneToActor,
			SequenceFlow inFlow, bpmn2.Process process, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet) {
		Object[] result_pattern_UserTaskToStepAfterSERule_2_4_binding = pattern_UserTaskToStepAfterSERule_2_4_bindingFBBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, lane, task, actor,
				laneToActor, inFlow, process, outFlow, inFlowToFlow, flow,
				laneSet);
		if (result_pattern_UserTaskToStepAfterSERule_2_4_binding != null) {
			CSP csp = (CSP) result_pattern_UserTaskToStepAfterSERule_2_4_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_2_4_black = pattern_UserTaskToStepAfterSERule_2_4_blackB(csp);
			if (result_pattern_UserTaskToStepAfterSERule_2_4_black != null) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_2_5_expressionFBB(
			UserTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_2_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_2_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "UserTaskToStepAfterSERule";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_UserTaskToStepAfterSERule_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_10_1_blackBBBBB(
			UserTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
		return new Object[] { _this, match, actor, normalStep, flow };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_10_2_bindingFBBBBB(
			UserTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_10_2_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_10_2_bindingAndBlackFBBBBB(
			UserTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
		Object[] result_pattern_UserTaskToStepAfterSERule_10_2_binding = pattern_UserTaskToStepAfterSERule_10_2_bindingFBBBBB(
				_this, match, actor, normalStep, flow);
		if (result_pattern_UserTaskToStepAfterSERule_10_2_binding != null) {
			CSP csp = (CSP) result_pattern_UserTaskToStepAfterSERule_10_2_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_10_2_black = pattern_UserTaskToStepAfterSERule_10_2_blackB(csp);
			if (result_pattern_UserTaskToStepAfterSERule_10_2_black != null) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_10_3_expressionFBB(
			UserTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_10_4_blackBBBB(
			Match match, Actor actor, NormalStep normalStep, Flow flow) {
		return new Object[] { match, actor, normalStep, flow };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_10_4_greenBBBBFF(
			Match match, Actor actor, NormalStep normalStep, Flow flow) {
		EMoflonEdge normalStep__actor____actor = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge flow__normalStep____steps = TGGRuntimeFactory.eINSTANCE
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_10_5_blackBBBB(
			Match match, Actor actor, NormalStep normalStep, Flow flow) {
		return new Object[] { match, actor, normalStep, flow };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_10_5_greenBBB(
	...
	public static final void pattern_UserTaskToStepAfterSERule_10_6_expressionBBBBB(
			UserTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_UserTaskToStepAfterSERule_10_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_11_1_bindingFFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("flowNode");
		EObject _localVariable_1 = isApplicableMatch.getObject("lane");
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_11_1_blackBBBBBBBBBBFBB(
			StartEvent flowNode, Lane lane, Actor actor,
			LaneToActor laneToActor, SequenceFlow inFlow,
			bpmn2.Process process, NormalStep normalStep,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_11_1_bindingAndBlackFFFFFFFFFFFBB(
			UserTaskToStepAfterSERule _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_UserTaskToStepAfterSERule_11_1_binding = pattern_UserTaskToStepAfterSERule_11_1_bindingFFFFFFFFFFB(isApplicableMatch);
		if (result_pattern_UserTaskToStepAfterSERule_11_1_binding != null) {
			StartEvent flowNode = (StartEvent) result_pattern_UserTaskToStepAfterSERule_11_1_binding[0];
			Lane lane = (Lane) result_pattern_UserTaskToStepAfterSERule_11_1_binding[1];
			Actor actor = (Actor) result_pattern_UserTaskToStepAfterSERule_11_1_binding[2];
			LaneToActor laneToActor = (LaneToActor) result_pattern_UserTaskToStepAfterSERule_11_1_binding[3];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_UserTaskToStepAfterSERule_11_1_binding[4];
			bpmn2.Process process = (bpmn2.Process) result_pattern_UserTaskToStepAfterSERule_11_1_binding[5];
			NormalStep normalStep = (NormalStep) result_pattern_UserTaskToStepAfterSERule_11_1_binding[6];
			SequenceFlowToUCFlow inFlowToFlow = (SequenceFlowToUCFlow) result_pattern_UserTaskToStepAfterSERule_11_1_binding[7];
			Flow flow = (Flow) result_pattern_UserTaskToStepAfterSERule_11_1_binding[8];
			LaneSet laneSet = (LaneSet) result_pattern_UserTaskToStepAfterSERule_11_1_binding[9];

			Object[] result_pattern_UserTaskToStepAfterSERule_11_1_black = pattern_UserTaskToStepAfterSERule_11_1_blackBBBBBBBBBBFBB(
					flowNode, lane, actor, laneToActor, inFlow, process,
					normalStep, inFlowToFlow, flow, laneSet, _this,
					isApplicableMatch);
			if (result_pattern_UserTaskToStepAfterSERule_11_1_black != null) {
				CSP csp = (CSP) result_pattern_UserTaskToStepAfterSERule_11_1_black[10];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_11_1_greenBFBBFBFFFBB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_11_2_blackBBBBBB(
			UserTask task, SequenceFlow outFlow, NormalStep normalStep,
			FlowNodeToStep taskToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow,
			SequenceFlowToStep outFlowToNormalStep) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_11_2_greenFBBBBBB(
			UserTask task, SequenceFlow outFlow, NormalStep normalStep,
			FlowNodeToStep taskToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow,
			SequenceFlowToStep outFlowToNormalStep) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_11_3_blackBBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject flowNode, EObject lane,
			EObject task, EObject actor, EObject laneToActor, EObject inFlow,
			EObject process, EObject outFlow, EObject normalStep,
			EObject taskToNormalStep, EObject outFlowToFlow,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_11_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject lane, EObject task,
			EObject actor, EObject inFlow, EObject process, EObject outFlow,
			EObject normalStep, EObject taskToNormalStep,
			EObject outFlowToFlow, EObject outFlowToNormalStep, EObject flow) {
	...
	public static final void pattern_UserTaskToStepAfterSERule_11_5_expressionBBBBBBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this, PerformRuleResult ruleresult,
			EObject flowNode, EObject lane, EObject task, EObject actor,
			EObject laneToActor, EObject inFlow, EObject process,
			EObject outFlow, EObject normalStep, EObject taskToNormalStep,
	...
	public static final PerformRuleResult pattern_UserTaskToStepAfterSERule_11_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_12_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_1_blackFBB(
			EClass eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperationname = performOperation.getName();
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_12_1_binding = pattern_UserTaskToStepAfterSERule_12_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_12_1_binding != null) {
			EClass eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_12_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_12_1_black = pattern_UserTaskToStepAfterSERule_12_1_blackFBB(
					eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_12_1_black != null) {
				EOperation performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_12_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_2_bindingFFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_12_2_blackFBFFBFBB(
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_12_3_blackFBBBBFBBBF(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_3_greenBBBBBBBBBBFFFFFFFFFFFFF(
			StartEvent flowNode, Lane lane, Actor actor,
			LaneToActor laneToActor, SequenceFlow inFlow,
			bpmn2.Process process, NormalStep normalStep,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_4_bindingFBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			Lane lane, Actor actor, LaneToActor laneToActor,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_12_4_bindingAndBlackFBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			Lane lane, Actor actor, LaneToActor laneToActor,
			SequenceFlow inFlow, bpmn2.Process process, NormalStep normalStep,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet) {
		Object[] result_pattern_UserTaskToStepAfterSERule_12_4_binding = pattern_UserTaskToStepAfterSERule_12_4_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, lane, actor, laneToActor,
				inFlow, process, normalStep, inFlowToFlow, flow, laneSet);
		if (result_pattern_UserTaskToStepAfterSERule_12_4_binding != null) {
			CSP csp = (CSP) result_pattern_UserTaskToStepAfterSERule_12_4_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_12_4_black = pattern_UserTaskToStepAfterSERule_12_4_blackB(csp);
			if (result_pattern_UserTaskToStepAfterSERule_12_4_black != null) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_12_5_expressionFBB(
			UserTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_12_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_12_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
	...
	public static final IsApplicableRuleResult pattern_UserTaskToStepAfterSERule_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_20_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_20_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_20_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_20_1_binding = pattern_UserTaskToStepAfterSERule_20_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_20_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_20_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_20_1_black = pattern_UserTaskToStepAfterSERule_20_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_20_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_20_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_20_1_greenF() {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_20_2_black_nac_0B(
		...
		for (ExclusiveGateway __DEC_outFlow_default_367498 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_20_2_black_nac_1BB(
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_20_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowNodeRefs) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
					...
					for (SequenceFlow inFlow : task.getIncoming()) {
						...
						if (tmpFlowNode instanceof StartEvent) {
							...
							for (SequenceFlow outFlow : task.getOutgoing()) {
								if (!inFlow.equals(outFlow)) {
									if (pattern_UserTaskToStepAfterSERule_20_2_black_nac_0B(outFlow) == null) {
										if (pattern_UserTaskToStepAfterSERule_20_2_black_nac_1BB(
												outFlow, task) == null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_20_2_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_20_3_expressionFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_20_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_20_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_20_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_20_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_21_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_21_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_21_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_21_1_binding = pattern_UserTaskToStepAfterSERule_21_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_21_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_21_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_21_1_black = pattern_UserTaskToStepAfterSERule_21_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_21_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_21_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_21_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_21_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_569347 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_21_2_black_nac_1BB(
			SequenceFlow outFlow, UserTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_21_2_blackFFFFFFFB(
			EMoflonEdge _edge_targetRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
			...
			if (tmpTask instanceof UserTask) {
				...
				if (task.equals(inFlow.getTargetRef())) {
					...
					if (tmpFlowNode instanceof StartEvent) {
						...
						for (SequenceFlow outFlow : task.getOutgoing()) {
							if (!inFlow.equals(outFlow)) {
								if (pattern_UserTaskToStepAfterSERule_21_2_black_nac_0B(outFlow) == null) {
									if (pattern_UserTaskToStepAfterSERule_21_2_black_nac_1BB(
											outFlow, task) == null) {
										for (FlowElementsContainer tmpProcess : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(
														inFlow,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_21_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_21_3_expressionFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, flowNode,
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_21_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_21_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_21_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_21_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_22_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_22_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_22_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_22_1_binding = pattern_UserTaskToStepAfterSERule_22_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_22_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_22_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_22_1_black = pattern_UserTaskToStepAfterSERule_22_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_22_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_22_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_22_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_22_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_104087 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_22_2_black_nac_1BB(
			SequenceFlow outFlow, UserTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_22_2_blackFFFFFFFB(
			EMoflonEdge _edge_incoming) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
			...
			if (tmpInFlow instanceof SequenceFlow) {
				...
				if (task.equals(inFlow.getTargetRef())) {
					...
					if (tmpFlowNode instanceof StartEvent) {
						...
						for (SequenceFlow outFlow : task.getOutgoing()) {
							if (!inFlow.equals(outFlow)) {
								if (pattern_UserTaskToStepAfterSERule_22_2_black_nac_0B(outFlow) == null) {
									if (pattern_UserTaskToStepAfterSERule_22_2_black_nac_1BB(
											outFlow, task) == null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_22_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_22_3_expressionFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, flowNode,
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_22_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_22_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_22_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_22_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_23_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_23_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_23_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_23_1_binding = pattern_UserTaskToStepAfterSERule_23_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_23_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_23_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_23_1_black = pattern_UserTaskToStepAfterSERule_23_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_23_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_23_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_23_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_23_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_456512 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_23_2_black_nac_1BB(
			SequenceFlow outFlow, UserTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_23_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
												...
												for (FlowElement tmpOutFlow : process
													...
													if (tmpOutFlow instanceof SequenceFlow) {
														...
														if (!inFlow
															...
															if (task.equals(outFlow
																	.getSourceRef())) {
																if (pattern_UserTaskToStepAfterSERule_23_2_black_nac_0B(outFlow) == null) {
																	if (pattern_UserTaskToStepAfterSERule_23_2_black_nac_1BB(
																			outFlow,
																			task) == null) {
																		for (Lane lane : laneSet
																				.getLanes()) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_23_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_23_3_expressionFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, flowNode,
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_23_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_23_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_23_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_23_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_24_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_24_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_24_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_24_1_binding = pattern_UserTaskToStepAfterSERule_24_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_24_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_24_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_24_1_black = pattern_UserTaskToStepAfterSERule_24_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_24_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_24_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_24_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_24_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_907691 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_24_2_black_nac_1BB(
			SequenceFlow outFlow, UserTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_24_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpProcess = _edge_flowElements.getSrc();
		if (tmpProcess instanceof bpmn2.Process) {
			...
			if (tmpOutFlow instanceof SequenceFlow) {
				...
				if (process.getFlowElements().contains(outFlow)) {
					...
					if (tmpTask instanceof UserTask) {
						UserTask task = (UserTask) tmpTask;
						if (process.getFlowElements().contains(task)) {
							if (pattern_UserTaskToStepAfterSERule_24_2_black_nac_0B(outFlow) == null) {
								if (pattern_UserTaskToStepAfterSERule_24_2_black_nac_1BB(
										outFlow, task) == null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_24_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_24_3_expressionFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, flowNode,
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_24_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_24_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_24_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_24_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_25_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_25_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_25_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_25_1_binding = pattern_UserTaskToStepAfterSERule_25_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_25_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_25_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_25_1_black = pattern_UserTaskToStepAfterSERule_25_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_25_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_25_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_25_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_25_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_880037 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_25_2_black_nac_1BB(
			SequenceFlow outFlow, UserTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_25_2_blackFFFFFFFB(
			EMoflonEdge _edge_sourceRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpOutFlow instanceof SequenceFlow) {
			...
			if (tmpTask instanceof UserTask) {
				...
				if (task.equals(outFlow.getSourceRef())) {
					if (pattern_UserTaskToStepAfterSERule_25_2_black_nac_0B(outFlow) == null) {
						if (pattern_UserTaskToStepAfterSERule_25_2_black_nac_1BB(
								outFlow, task) == null) {
							for (SequenceFlow inFlow : task.getIncoming()) {
								if (!inFlow.equals(outFlow)) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_25_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_25_3_expressionFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, flowNode,
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_25_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_25_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_25_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_25_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_26_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_26_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_26_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_26_1_binding = pattern_UserTaskToStepAfterSERule_26_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_26_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_26_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_26_1_black = pattern_UserTaskToStepAfterSERule_26_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_26_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_26_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_26_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_26_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_251085 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_26_2_black_nac_1BB(
			SequenceFlow outFlow, UserTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_26_2_blackFFFFFFFB(
			EMoflonEdge _edge_outgoing) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpTask instanceof UserTask) {
			...
			if (tmpOutFlow instanceof SequenceFlow) {
				SequenceFlow outFlow = (SequenceFlow) tmpOutFlow;
				if (task.equals(outFlow.getSourceRef())) {
					if (pattern_UserTaskToStepAfterSERule_26_2_black_nac_0B(outFlow) == null) {
						if (pattern_UserTaskToStepAfterSERule_26_2_black_nac_1BB(
								outFlow, task) == null) {
							for (SequenceFlow inFlow : task.getIncoming()) {
								if (!inFlow.equals(outFlow)) {
									FlowNode tmpFlowNode = inFlow
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_26_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_26_3_expressionFBBBBBBBBB(
			UserTaskToStepAfterSERule _this, Match match, StartEvent flowNode,
			Lane lane, UserTask task, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlow outFlow, LaneSet laneSet) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, flowNode,
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_26_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_26_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_26_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_26_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_27_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_27_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_27_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_27_1_binding = pattern_UserTaskToStepAfterSERule_27_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_27_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_27_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_27_1_black = pattern_UserTaskToStepAfterSERule_27_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_27_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_27_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_27_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_27_2_blackFFFB(
			EMoflonEdge _edge_actor) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_27_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_27_3_expressionFBBBBB(
			UserTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_27_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_27_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_27_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_27_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_28_1_bindingFB(
			UserTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_28_1_blackFBB(
			EClass __eClass, UserTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_BWD")) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_28_1_bindingAndBlackFFB(
			UserTaskToStepAfterSERule _this) {
		Object[] result_pattern_UserTaskToStepAfterSERule_28_1_binding = pattern_UserTaskToStepAfterSERule_28_1_bindingFB(_this);
		if (result_pattern_UserTaskToStepAfterSERule_28_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_UserTaskToStepAfterSERule_28_1_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_28_1_black = pattern_UserTaskToStepAfterSERule_28_1_blackFBB(
					__eClass, _this);
			if (result_pattern_UserTaskToStepAfterSERule_28_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_UserTaskToStepAfterSERule_28_1_black[0];
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_28_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_28_2_blackFFFB(
			EMoflonEdge _edge_steps) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_28_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_28_3_expressionFBBBBB(
			UserTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, actor,
				normalStep, flow);
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_28_4_expressionFBB(
			UserTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_28_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_28_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_UserTaskToStepAfterSERule_28_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_31_1_blackB(
			UserTaskToStepAfterSERule _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_31_1_greenFF() {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableMatch();
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_0BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_1BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_2BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_3BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_4BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_5BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_6BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_7BB(
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_2_black_nac_8BB(
	...
	public static final Iterable<Object[]> pattern_UserTaskToStepAfterSERule_31_2_blackFFFFFFFFFFBB(
			RuleEntryContainer ruleEntryContainer,
			ModelgeneratorRuleResult ruleResult) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
			...
			for (EObject tmpLaneToActor : laneToActorList.getEntryObjects()) {
				if (tmpLaneToActor instanceof LaneToActor) {
					...
					if (lane != null) {
						Actor actor = laneToActor.getTarget();
						if (actor != null) {
							if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_4BB(
									ruleResult, laneToActor) == null) {
								if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_3BB(
										ruleResult, lane) == null) {
									if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_5BB(
											ruleResult, actor) == null) {
										for (LaneSet laneSet : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(
														lane, LaneSet.class,
														"lanes")) {
											if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_2BB(
												...
												for (FlowElementsContainer tmpProcess : org.moflon.core.utilities.eMoflonEMFUtil
													...
													if (tmpProcess instanceof bpmn2.Process) {
														bpmn2.Process process = (bpmn2.Process) tmpProcess;
														if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_1BB(
																ruleResult,
																process) == null) {
															for (FlowElement tmpFlowNode : process
																	.getFlowElements()) {
																if (tmpFlowNode instanceof StartEvent) {
																	StartEvent flowNode = (StartEvent) tmpFlowNode;
																	if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_0BB(
																			ruleResult,
																			flowNode) == null) {
																		for (FlowElement tmpInFlow : process
																				.getFlowElements()) {
																			if (tmpInFlow instanceof SequenceFlow) {
																				...
																				if (flowNode
																						.equals(inFlow
																								.getSourceRef())) {
																					if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_6BB(
																							ruleResult,
																							inFlow) == null) {
																						for (SequenceFlowToUCFlow inFlowToFlow : org.moflon.core.utilities.eMoflonEMFUtil
																								.getOppositeReferenceTyped(
																							...
																							Flow flow = inFlowToFlow
																									.getTarget();
																							if (flow != null) {
																								if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_7BB(
																										ruleResult,
																										inFlowToFlow) == null) {
																									if (pattern_UserTaskToStepAfterSERule_31_2_black_nac_8BB(
																											ruleResult,
																											flow) == null) {
																										_result.add(new Object[] {
																												laneToActorList,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_3_bindingFBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			Lane lane, Actor actor, LaneToActor laneToActor,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_3_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_UserTaskToStepAfterSERule_31_3_bindingAndBlackFBBBBBBBBBBBB(
			UserTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			Lane lane, Actor actor, LaneToActor laneToActor,
			SequenceFlow inFlow, bpmn2.Process process,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
			ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_UserTaskToStepAfterSERule_31_3_binding = pattern_UserTaskToStepAfterSERule_31_3_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, lane, actor, laneToActor,
				inFlow, process, inFlowToFlow, flow, laneSet, ruleResult);
		if (result_pattern_UserTaskToStepAfterSERule_31_3_binding != null) {
			CSP csp = (CSP) result_pattern_UserTaskToStepAfterSERule_31_3_binding[0];

			Object[] result_pattern_UserTaskToStepAfterSERule_31_3_black = pattern_UserTaskToStepAfterSERule_31_3_blackB(csp);
			if (result_pattern_UserTaskToStepAfterSERule_31_3_black != null) {
	...
	public static final boolean pattern_UserTaskToStepAfterSERule_31_4_expressionFBB(
			UserTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_5_blackBBBBBBBBB(
			StartEvent flowNode, Lane lane, Actor actor,
			LaneToActor laneToActor, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlowToUCFlow inFlowToFlow,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_6_blackBBBBBBBBBB(
			StartEvent flowNode, Lane lane, Actor actor,
			LaneToActor laneToActor, SequenceFlow inFlow,
			bpmn2.Process process, SequenceFlowToUCFlow inFlowToFlow,
	...
	public static final Object[] pattern_UserTaskToStepAfterSERule_31_6_greenBFBBBFFFFFBBB(
	...
	public static final ModelgeneratorRuleResult pattern_UserTaskToStepAfterSERule_31_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
