...
public class ICEToStepAfterSERuleImpl extends AbstractRuleImpl implements
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRule("ICEToStepAfterSERule");
							...
							try {
								...
								if (fujaba__Success) {
									...
									try {
										...
										isApplicableMatch
												.setRuleName("ICEToStepAfterSERule");
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRuleName("ICEToStepAfterSERule");
			// assign attribute __process_flowElements_outFlow
			__process_flowElements_outFlow.setName("flowElements");
			// assign attribute __process_flowElements_event
			__process_flowElements_event.setName("flowElements");
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_132(
		...
		FlowElementsContainer __DEC_event_flowElements_526797 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_142731 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_831666 = null;
		SequenceFlow __DEC_event_targetRef_831666 = null;
		Match match = null;
		StartEvent flowNode = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_526797 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_526797 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_526797 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_526797
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_526797 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_526797
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_142731 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_142731 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_142731 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_142731
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_142731 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_142731
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_831666
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_831666 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_831666
													.hasNext()) {
										try {
											__DEC_event_targetRef_831666 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_831666
													.next();

											// check object __DEC_event_targetRef_831666 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_831666 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_831666 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_831666
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_831666 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_831666
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_133(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_277392 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_261784 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_600897 = null;
		SequenceFlow __DEC_event_targetRef_600897 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_277392 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_277392 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_277392 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_277392
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_277392 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_277392
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_261784 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_261784 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_261784 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_261784
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_261784 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_261784
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_600897
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_600897 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_600897
															.hasNext()) {
												try {
													__DEC_event_targetRef_600897 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_600897
															.next();

													// check object __DEC_event_targetRef_600897 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_600897 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_600897 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_600897
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_600897 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_600897
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_134(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_542086 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_684051 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_358208 = null;
		SequenceFlow __DEC_event_targetRef_358208 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		LaneSet laneSet = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_542086 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_542086 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_542086 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_542086
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_542086 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_542086
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_684051 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_684051 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_684051 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_684051
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_684051 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_684051
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_358208
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_358208 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_358208
													.hasNext()) {
										try {
											__DEC_event_targetRef_358208 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_358208
													.next();

											// check object __DEC_event_targetRef_358208 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_358208 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_358208 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_358208
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_358208 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_358208
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_135(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_874579 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_866204 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_49072 = null;
		SequenceFlow __DEC_event_targetRef_49072 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_874579 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_874579 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_874579 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_874579
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_874579 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_874579
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_866204 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_866204 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_866204 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_866204
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_866204 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_866204
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_49072
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_49072 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_49072
															.hasNext()) {
												try {
													__DEC_event_targetRef_49072 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_49072
															.next();

													// check object __DEC_event_targetRef_49072 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_49072 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_49072 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_49072
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_49072 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_49072
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_136(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_327165 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_531811 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_633730 = null;
		SequenceFlow __DEC_event_targetRef_633730 = null;
		Match match = null;
		StartEvent flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_327165 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_327165 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_327165 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_327165
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_327165 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_327165
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_531811 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_531811 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_531811 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_531811
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_531811 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_531811
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_633730
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_633730 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_633730
													.hasNext()) {
										try {
											__DEC_event_targetRef_633730 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_633730
													.next();

											// check object __DEC_event_targetRef_633730 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_633730 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_633730 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_633730
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_633730 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_633730
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_137(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_390903 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_963725 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_586537 = null;
		SequenceFlow __DEC_event_targetRef_586537 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_390903 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_390903 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_390903 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_390903
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_390903 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_390903
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_963725 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_963725 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_963725 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_963725
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_963725 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_963725
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_586537
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_586537 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_586537
															.hasNext()) {
												try {
													__DEC_event_targetRef_586537 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_586537
															.next();

													// check object __DEC_event_targetRef_586537 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_586537 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_586537 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_586537
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_586537 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_586537
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_38(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_634092 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_365759 = null;
		Step __DEC_normalStep_next_365759 = null;
		Match match = null;
		Actor actor = null;
		Flow flow = null;
		NormalStep normalStep = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_634092 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_634092 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_634092 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_634092.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_634092 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_634092.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_365759
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_365759 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_365759
									.hasNext()) {
						try {
							__DEC_normalStep_next_365759 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_365759
									.next();

							// check object __DEC_normalStep_next_365759 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_365759 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_365759 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_365759
									.equals(normalStep));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_39(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_672978 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_222812 = null;
		Step __DEC_normalStep_next_222812 = null;
		Match match = null;
		Actor actor = null;
		NormalStep normalStep = null;
		Flow flow = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_672978 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_672978 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_672978 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_672978.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_672978 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_672978.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_222812
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_222812 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_222812
									.hasNext()) {
						try {
							__DEC_normalStep_next_222812 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_222812
									.next();

							// check object __DEC_normalStep_next_222812 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_222812 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_222812 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_222812
									.equals(normalStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_138(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_65079 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_673317 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_227776 = null;
		SequenceFlow __DEC_event_targetRef_227776 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		StartEvent flowNode = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_65079 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_65079 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_65079 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_65079
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_65079 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_65079
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_673317 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_673317 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_673317 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_673317
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_673317 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_673317
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_227776
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_227776 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_227776
													.hasNext()) {
										try {
											__DEC_event_targetRef_227776 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_227776
													.next();

											// check object __DEC_event_targetRef_227776 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_227776 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_227776 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_227776
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_227776 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_227776
													.equals(outFlow));
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.ICE_TO_STEP_AFTER_SE_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STARTEVENT_INTERMEDIATECATCHEVENT_PROCESS_SEQUENCEFLOW_SEQUENCEFLOW_ACTOR_PROCESSTOACTOR_NORMALSTEP_FLOWNODETOSTEP_SEQUENCEFLOWTOSTEP_FLOW_SEQUENCEFLOWTOUCFLOW_SEQUENCEFLOWTOUCFLOW_LANE_LANESET_MODELGENERATORRULERESULT:
