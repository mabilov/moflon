...
public class ICEToStepAfterPConvGwRuleImpl extends AbstractRuleImpl implements
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_53(
		...
		Flow __DEC_normalStep_steps_983854 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_307803 = null;
		Step __DEC_normalStep_next_307803 = null;
		Match match = null;
		Flow flow = null;
		Actor actor = null;
		NormalStep normalStep = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_983854 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_983854 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_983854 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_983854.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_983854 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_983854.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_307803
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_307803 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_307803
									.hasNext()) {
						try {
							__DEC_normalStep_next_307803 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_307803
									.next();

							// check object __DEC_normalStep_next_307803 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_307803 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_307803 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_307803
									.equals(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_next_307803 and prevStep 
							JavaSDM.ensure(!__DEC_normalStep_next_307803
									.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_174(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_556531 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_511483 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_809705 = null;
		SequenceFlow __DEC_event_targetRef_809705 = null;
		Match match = null;
		LaneSet laneSet = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_556531 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_556531 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_556531 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_556531
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_556531 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_556531
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_511483 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_511483 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_511483 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_511483
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_511483 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_511483
											.equals(process));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_809705
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_809705 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_809705
													.hasNext()) {
										try {
											__DEC_event_targetRef_809705 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_809705
													.next();

											// check object __DEC_event_targetRef_809705 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_809705 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_809705 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_809705
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_809705 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_809705
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_175(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_401934 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_749185 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_779948 = null;
		SequenceFlow __DEC_event_targetRef_779948 = null;
		Match match = null;
		ParallelGateway flowNode = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_401934 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_401934 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_401934 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_401934
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_401934 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_401934
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_749185 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_749185 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_749185 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_749185
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_749185 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_749185
													.equals(process));
										...
										try {
											...
											// iterate to-many link targetRef from event to __DEC_event_targetRef_779948
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_779948 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_779948
															.hasNext()) {
												try {
													__DEC_event_targetRef_779948 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_779948
															.next();

													// check object __DEC_event_targetRef_779948 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_779948 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_779948 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_779948
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_779948 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_779948
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_176(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_954155 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_124342 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_483912 = null;
		SequenceFlow __DEC_event_targetRef_483912 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		LaneSet laneSet = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_954155 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_954155 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_954155 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_954155
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_954155 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_954155
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_124342 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_124342 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_124342 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_124342
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_124342 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_124342
											.equals(process));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_483912
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_483912 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_483912
													.hasNext()) {
										try {
											__DEC_event_targetRef_483912 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_483912
													.next();

											// check object __DEC_event_targetRef_483912 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_483912 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_483912 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_483912
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_483912 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_483912
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_177(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_246932 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_751099 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_556946 = null;
		SequenceFlow __DEC_event_targetRef_556946 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_246932 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_246932 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_246932 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_246932
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_246932 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_246932
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_751099 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_751099 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_751099 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_751099
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_751099 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_751099
													.equals(process));
										...
										try {
											...
											// iterate to-many link targetRef from event to __DEC_event_targetRef_556946
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_556946 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_556946
															.hasNext()) {
												try {
													__DEC_event_targetRef_556946 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_556946
															.next();

													// check object __DEC_event_targetRef_556946 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_556946 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_556946 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_556946
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_556946 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_556946
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_178(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_816772 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_691976 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_21912 = null;
		SequenceFlow __DEC_event_targetRef_21912 = null;
		Match match = null;
		ParallelGateway flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_816772 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_816772 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_816772 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_816772
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_816772 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_816772
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_691976 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_691976 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_691976 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_691976
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_691976 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_691976
											.equals(process));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_21912
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_21912 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_21912
													.hasNext()) {
										try {
											__DEC_event_targetRef_21912 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_21912
													.next();

											// check object __DEC_event_targetRef_21912 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_21912 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_21912 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_21912
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_21912 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_21912
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_179(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_27565 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_363850 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_324786 = null;
		SequenceFlow __DEC_event_targetRef_324786 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_27565 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_27565 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_27565 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_27565
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_27565 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_27565
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_363850 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_363850 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_363850 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_363850
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_363850 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_363850
													.equals(process));
										...
										try {
											...
											// iterate to-many link targetRef from event to __DEC_event_targetRef_324786
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_324786 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_324786
															.hasNext()) {
												try {
													__DEC_event_targetRef_324786 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_324786
															.next();

													// check object __DEC_event_targetRef_324786 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_324786 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_324786 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_324786
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_324786 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_324786
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_54(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_447376 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_435826 = null;
		Step __DEC_normalStep_next_435826 = null;
		Match match = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_447376 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_447376 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_447376 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_447376
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_447376 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_447376
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_435826
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_435826 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_435826
											.hasNext()) {
								try {
									__DEC_normalStep_next_435826 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_435826
											.next();

									// check object __DEC_normalStep_next_435826 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_435826 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_435826 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_435826
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_435826 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_435826
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_55(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_565024 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_143114 = null;
		Step __DEC_normalStep_next_143114 = null;
		Match match = null;
		Iterator fujaba__IterNormalStepToPrevStep = null;
		Step prevStep = null;
		Actor actor = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_565024 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_565024 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_565024 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_565024
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_565024 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_565024
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_143114
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_143114 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_143114
											.hasNext()) {
								try {
									__DEC_normalStep_next_143114 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_143114
											.next();

									// check object __DEC_normalStep_next_143114 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_143114 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_143114 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_143114
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_143114 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_143114
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_180(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_33930 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_437013 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_89441 = null;
		SequenceFlow __DEC_event_targetRef_89441 = null;
		Match match = null;
		ParallelGateway flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_33930 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_33930 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_33930 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_33930
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_33930 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_33930
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_437013 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_437013 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_437013 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_437013
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_437013 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_437013
											.equals(process));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_89441
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_89441 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_89441
													.hasNext()) {
										try {
											__DEC_event_targetRef_89441 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_89441
													.next();

											// check object __DEC_event_targetRef_89441 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_89441 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_89441 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_89441
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_89441 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_89441
													.equals(outFlow));
