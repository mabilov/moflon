...
public class ICEToStepAfterPConvGwRuleImpl extends AbstractRuleImpl implements
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRule("ICEToStepAfterPConvGwRule");
									...
									try {
										...
										if (fujaba__Success) {
											...
											try {
												...
												isApplicableMatch
														.setRuleName("ICEToStepAfterPConvGwRule");
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRuleName("ICEToStepAfterPConvGwRule");
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_53(
		...
		Flow __DEC_normalStep_steps_371134 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_996262 = null;
		Step __DEC_normalStep_next_996262 = null;
		Match match = null;
		Flow flow = null;
		Actor actor = null;
		NormalStep normalStep = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_371134 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_371134 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_371134 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_371134.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_371134 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_371134.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_996262
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_996262 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_996262
									.hasNext()) {
						try {
							__DEC_normalStep_next_996262 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_996262
									.next();

							// check object __DEC_normalStep_next_996262 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_996262 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_996262 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_996262
									.equals(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_next_996262 and prevStep 
							JavaSDM.ensure(!__DEC_normalStep_next_996262
									.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_174(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_106018 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_831616 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_4080 = null;
		SequenceFlow __DEC_event_targetRef_4080 = null;
		Match match = null;
		ParallelGateway flowNode = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_106018 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_106018 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_106018 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_106018
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_106018 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_106018
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_831616 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_831616 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_831616 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_831616
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_831616 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_831616
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_4080
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_4080 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_4080
													.hasNext()) {
										try {
											__DEC_event_targetRef_4080 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_4080
													.next();

											// check object __DEC_event_targetRef_4080 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_4080 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_4080 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_4080
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_4080 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_4080
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_175(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_955116 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_618223 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_564075 = null;
		SequenceFlow __DEC_event_targetRef_564075 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_955116 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_955116 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_955116 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_955116
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_955116 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_955116
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_618223 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_618223 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_618223 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_618223
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_618223 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_618223
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_564075
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_564075 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_564075
															.hasNext()) {
												try {
													__DEC_event_targetRef_564075 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_564075
															.next();

													// check object __DEC_event_targetRef_564075 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_564075 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_564075 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_564075
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_564075 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_564075
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_176(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_15865 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_381709 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_877497 = null;
		SequenceFlow __DEC_event_targetRef_877497 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		LaneSet laneSet = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_15865 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_15865 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_15865 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_15865
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_15865 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_15865
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_381709 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_381709 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_381709 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_381709
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_381709 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_381709
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_877497
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_877497 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_877497
													.hasNext()) {
										try {
											__DEC_event_targetRef_877497 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_877497
													.next();

											// check object __DEC_event_targetRef_877497 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_877497 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_877497 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_877497
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_877497 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_877497
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_177(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_669419 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_825716 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_679660 = null;
		SequenceFlow __DEC_event_targetRef_679660 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_669419 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_669419 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_669419 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_669419
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_669419 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_669419
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_825716 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_825716 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_825716 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_825716
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_825716 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_825716
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_679660
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_679660 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_679660
															.hasNext()) {
												try {
													__DEC_event_targetRef_679660 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_679660
															.next();

													// check object __DEC_event_targetRef_679660 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_679660 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_679660 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_679660
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_679660 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_679660
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_178(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_794890 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_310139 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_894883 = null;
		SequenceFlow __DEC_event_targetRef_894883 = null;
		Match match = null;
		ParallelGateway flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_794890 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_794890 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_794890 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_794890
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_794890 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_794890
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_310139 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_310139 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_310139 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_310139
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_310139 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_310139
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_894883
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_894883 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_894883
													.hasNext()) {
										try {
											__DEC_event_targetRef_894883 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_894883
													.next();

											// check object __DEC_event_targetRef_894883 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_894883 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_894883 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_894883
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_894883 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_894883
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_179(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_216239 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_381599 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_553696 = null;
		SequenceFlow __DEC_event_targetRef_553696 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_216239 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_216239 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_216239 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_216239
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_216239 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_216239
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_381599 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_381599 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_381599 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_381599
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_381599 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_381599
													.equals(process));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_553696
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_553696 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_553696
															.hasNext()) {
												try {
													__DEC_event_targetRef_553696 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_553696
															.next();

													// check object __DEC_event_targetRef_553696 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_553696 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_553696 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_553696
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_553696 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_553696
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_54(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_857059 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_217933 = null;
		Step __DEC_normalStep_next_217933 = null;
		Match match = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_857059 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_857059 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_857059 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_857059
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_857059 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_857059
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_217933
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_217933 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_217933
											.hasNext()) {
								try {
									__DEC_normalStep_next_217933 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_217933
											.next();

									// check object __DEC_normalStep_next_217933 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_217933 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_217933 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_217933
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_217933 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_217933
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_55(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_443573 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_288199 = null;
		Step __DEC_normalStep_next_288199 = null;
		Match match = null;
		Iterator fujaba__IterNormalStepToPrevStep = null;
		Step prevStep = null;
		Actor actor = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_443573 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_443573 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_443573 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_443573
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_443573 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_443573
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_288199
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_288199 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_288199
											.hasNext()) {
								try {
									__DEC_normalStep_next_288199 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_288199
											.next();

									// check object __DEC_normalStep_next_288199 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_288199 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_288199 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_288199
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_288199 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_288199
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_180(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_982786 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_384208 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_406771 = null;
		SequenceFlow __DEC_event_targetRef_406771 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		ParallelGateway flowNode = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_982786 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_982786 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_982786 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_982786
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_982786 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_982786
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_384208 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_384208 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_384208 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_384208
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_384208 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_384208
											.equals(process));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_406771
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_406771 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_406771
													.hasNext()) {
										try {
											__DEC_event_targetRef_406771 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_406771
													.next();

											// check object __DEC_event_targetRef_406771 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_406771 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_406771 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_406771
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_406771 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_406771
													.equals(outFlow));
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_53__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_53((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_174__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_174((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_175__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_175((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_176__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_176((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_177__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_177((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_178__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_178((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_179__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_179((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_54__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_54((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_55__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_55((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_180__EMOFLONEDGE:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_PCONV_GW_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PARALLELGATEWAY_INTERMEDIATECATCHEVENT_SEQUENCEFLOW_STEP_SEQUENCEFLOWTOSTEP_NORMALSTEP_PROCESS_SEQUENCEFLOW_ACTOR_PROCESSTOACTOR_FLOWNODETOSTEP_SEQUENCEFLOWTOSTEP_FLOW_SEQUENCEFLOWTOUCFLOW_SEQUENCEFLOWTOUCFLOW_LANE_LANESET_MODELGENERATORRULERESULT:
