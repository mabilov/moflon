...
public class ICEToStepAfterEventRuleImpl extends AbstractRuleImpl implements
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_1_1_greenBBFBBFFBFB(event,
		...
		Object[] result2_black = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_1_2_blackBBBBBB(event,
		...
		Object[] result2_green = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_1_2_greenFBBBBBB(event,
						normalStep, outFlow, eventToNormalStep,
						outFlowToNormalStep, outFlowToFlow);
		...
		Object[] result3_black = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_1_3_blackBBBBBBBBBBBBBBBBBB(
		...
		ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_1_3_greenBBBBBBBBBBBBBFFFFFFFFFFFFFFFF(
		...
		// register objects
		ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_1_5_expressionBBBBBBBBBBBBBBBBBBB(
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_11_1_greenFBBBFFFBFBB(inFlow,
		...
		// collect translated elements
		Object[] result2_black = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_11_2_blackBBBBBB(event,
						normalStep, outFlow, eventToNormalStep,
						outFlowToNormalStep, outFlowToFlow);
		if (result2_black == null) {
			throw new RuntimeException(
		...
		Object[] result2_green = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_11_2_greenFBBBBBB(event,
						normalStep, outFlow, eventToNormalStep,
						outFlowToNormalStep, outFlowToFlow);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		// bookkeeping for edges
		Object[] result3_black = ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_11_3_blackBBBBBBBBBBBBBBBBBB(
						ruleresult, flowNode, event, inFlow, prevStep,
						inFlowToPrevStep, normalStep, process, outFlow, actor,
						processToActor, eventToNormalStep, outFlowToNormalStep,
						flow, inFlowToFlow, outFlowToFlow, lane, laneSet);
		...
		ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_11_3_greenBBBBBBBBBBBBBFFFFFFFFFFFFFFFF(
						ruleresult, event, inFlow, prevStep, normalStep,
						process, outFlow, actor, eventToNormalStep,
						outFlowToNormalStep, flow, outFlowToFlow, lane);
		// EMoflonEdge prevStep__normalStep____next = (EMoflonEdge) result3_green[13];
		...
		// register objects
		ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_11_5_expressionBBBBBBBBBBBBBBBBBBB(
						this, ruleresult, flowNode, event, inFlow, prevStep,
						inFlowToPrevStep, normalStep, process, outFlow, actor,
						processToActor, eventToNormalStep, outFlowToNormalStep,
						flow, inFlowToFlow, outFlowToFlow, lane, laneSet);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : ICEToStepAfterEventRuleImpl
				.pattern_ICEToStepAfterEventRule_12_2_blackFBFBFBFBFB(prevStep,
		...
		for (Object[] result2_black : ICEToStepAfterEventRuleImpl
			...
			if (ICEToStepAfterEventRuleImpl
				...
				if (result5_black != null) {
					...
					ICEToStepAfterEventRuleImpl
							.pattern_ICEToStepAfterEventRule_32_6_greenFBBFBFBFFBFBBB(
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_BWD__MATCH_STEP_NORMALSTEP_ACTOR_FLOW:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_STEP_NORMALSTEP_ACTOR_FLOW:
			registerObjectsToMatch_BWD((Match) arguments.get(0),
					(Step) arguments.get(1), (NormalStep) arguments.get(2),
					(Actor) arguments.get(3), (Flow) arguments.get(4));
			return null;
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_STEP_NORMALSTEP_ACTOR_FLOW:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
					(Step) arguments.get(1), (NormalStep) arguments.get(2),
					(Actor) arguments.get(3), (Flow) arguments.get(4));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_EVENT_SEQUENCEFLOW_STEP_SEQUENCEFLOWTOSTEP_NORMALSTEP_PROCESS_ACTOR_PROCESSTOACTOR_FLOW_SEQUENCEFLOWTOUCFLOW_LANE_LANESET:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_44__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_44((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_151__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_151((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_152__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_152((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_153__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_153((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_154__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_154((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_155__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_155((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_156__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_156((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_45__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_45((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_46__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_46((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EVENT_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_157__EMOFLONEDGE:
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_1_1_greenBBFBBFFBFB(
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_1_2_blackBBBBBB(
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_1_2_greenFBBBBBB(
			IntermediateCatchEvent event, NormalStep normalStep,
			SequenceFlow outFlow, FlowNodeToStep eventToNormalStep,
			SequenceFlowToStep outFlowToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow) {
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_1_3_blackBBBBBBBBBBBBBBBBBB(
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_1_3_greenBBBBBBBBBBBBBFFFFFFFFFFFFFFFF(
	...
	public static final void pattern_ICEToStepAfterEventRule_1_5_expressionBBBBBBBBBBBBBBBBBBB(
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_10_1_blackBBBBBB(
			ICEToStepAfterEventRule _this, Match match, Step prevStep,
			NormalStep normalStep, Actor actor, Flow flow) {
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_11_1_bindingAndBlackFFFFFFFFFFFFFBB(
		...
		if (result_pattern_ICEToStepAfterEventRule_11_1_binding != null) {
			...
			SequenceFlow inFlow = (SequenceFlow) result_pattern_ICEToStepAfterEventRule_11_1_binding[1];
			Step prevStep = (Step) result_pattern_ICEToStepAfterEventRule_11_1_binding[2];
			SequenceFlowToStep inFlowToPrevStep = (SequenceFlowToStep) result_pattern_ICEToStepAfterEventRule_11_1_binding[3];
			NormalStep normalStep = (NormalStep) result_pattern_ICEToStepAfterEventRule_11_1_binding[4];
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_11_1_greenFBBBFFFBFBB(
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_11_2_blackBBBBBB(
			IntermediateCatchEvent event, NormalStep normalStep,
			SequenceFlow outFlow, FlowNodeToStep eventToNormalStep,
			SequenceFlowToStep outFlowToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow) {
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_11_2_greenFBBBBBB(
			IntermediateCatchEvent event, NormalStep normalStep,
			SequenceFlow outFlow, FlowNodeToStep eventToNormalStep,
			SequenceFlowToStep outFlowToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow) {
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_11_3_blackBBBBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject flowNode, EObject event,
			EObject inFlow, EObject prevStep, EObject inFlowToPrevStep,
			EObject normalStep, EObject process, EObject outFlow,
			EObject actor, EObject processToActor, EObject eventToNormalStep,
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_11_3_greenBBBBBBBBBBBBBFFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject event, EObject inFlow,
			EObject prevStep, EObject normalStep, EObject process,
			EObject outFlow, EObject actor, EObject eventToNormalStep,
			EObject outFlowToNormalStep, EObject flow, EObject outFlowToFlow,
	...
	public static final void pattern_ICEToStepAfterEventRule_11_5_expressionBBBBBBBBBBBBBBBBBBB(
			ICEToStepAfterEventRule _this, PerformRuleResult ruleresult,
			EObject flowNode, EObject event, EObject inFlow, EObject prevStep,
			EObject inFlowToPrevStep, EObject normalStep, EObject process,
			EObject outFlow, EObject actor, EObject processToActor,
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterEventRule_12_2_blackFBFBFBFBFB(
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_21_2_black_nac_0B(
		...
		for (ExclusiveGateway __DEC_outFlow_default_633905 : org.moflon.util.eMoflonEMFUtil
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_22_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_772758 : org.moflon.util.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_23_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_846442 : org.moflon.util.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_24_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_905869 : org.moflon.util.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_25_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_285310 : org.moflon.util.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_26_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_825046 : org.moflon.util.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_29_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_161768 : org.moflon.util.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterEventRule_32_6_greenFBBFBFBFFBFBBB(
