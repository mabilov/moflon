...
public class ICEToStepAfterPGRuleImpl extends AbstractRuleImpl implements
	...
	public boolean isAppropriate_FWD(Match match, ParallelGateway flowNode,
		...
		Object[] result1_black = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_0_1_blackBBBBBBBBB(this, match,
		...
		Object[] result2_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_0_2_bindingAndBlackFBBBBBBBBB(
		...
		if (ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_0_3_expressionFBB(this, csp)) {

			// collect elements to be translated
			Object[] result4_black = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_0_4_blackBBBBBBBB(match,
							flowNode, event, process, inFlow, outFlow, lane,
							laneSet);
			...
			ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_0_4_greenBBBBBBFFFFFFF(match,
			...
			Object[] result5_black = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_0_5_blackBBBBBBBB(match,
							flowNode, event, process, inFlow, outFlow, lane,
							laneSet);
			...
			ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_0_5_greenBBBBBBFFFFF(match,
			...
			ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_0_6_expressionBBBBBBBBB(this,
							match, flowNode, event, process, inFlow, outFlow,
							lane, laneSet);
			return ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_0_7_expressionF();
		} else {
			return ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_1_1_bindingAndBlackFFFFFFFFFFFFBB(
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_2_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_2_1_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_2_2_bindingFFFFFFFB(match);
		...
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_2_2_blackBBBBBFFFFBBB(flowNode,
			...
			for (Object[] result3_black : ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_2_3_blackBBBBBBBBBBB(
				...
				Object[] result3_green = ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_2_3_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFF(
				...
				Object[] result4_bindingAndBlack = ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_2_4_bindingAndBlackFBBBBBBBBBBBBB(
				...
				// check CSP
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_2_5_expressionFBB(this,
								csp)) {

					// add match to rule result
					Object[] result6_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_2_6_blackBB(
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_2_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_2_7_expressionFB(ruleresult);
	}
	...
	public boolean isAppropriate_BWD(Match match, NormalStep normalStep,
		...
		// Check CSP
		if (ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_10_3_expressionFBB(this, csp)) {
			...
			ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_10_5_greenBBB(match, actor,
							flow);
			...
			return ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_11_1_bindingAndBlackFFFFFFFFFFFBB(
						this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [perform transformation] failed."
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_12_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		// EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_12_1_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_12_2_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException("Binding in node core match failed."
					+ " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
			...
			for (Object[] result3_black : ICEToStepAfterPGRuleImpl
				...
				// check CSP
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_12_5_expressionFBB(this,
								csp)) {

					// add match to rule result
					Object[] result6_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_12_6_blackBB(
									ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_12_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_333(
			EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_20_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_20_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_20_2_blackFFFFFFFB(_edge_flowElements)) {
			...
			Object[] result2_green = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_20_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_20_3_expressionFBBBBBBBBB(
							this, match, flowNode, event, process, inFlow,
							outFlow, lane, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_20_4_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_20_5_blackBBB(match,
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_20_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_334(
			EMoflonEdge _edge_flowElements) {
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_21_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_21_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_21_2_blackFFFFFFFB(_edge_flowElements)) {
			ParallelGateway flowNode = (ParallelGateway) result2_black[0];
			IntermediateCatchEvent event = (IntermediateCatchEvent) result2_black[1];
			bpmn2.Process process = (bpmn2.Process) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_21_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_21_3_expressionFBBBBBBBBB(
							this, match, flowNode, event, process, inFlow,
							outFlow, lane, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_21_4_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_21_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_21_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_21_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_335(
			EMoflonEdge _edge_targetRef) {
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_22_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_22_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_22_2_blackFFFFFFFB(_edge_targetRef)) {
			ParallelGateway flowNode = (ParallelGateway) result2_black[0];
			IntermediateCatchEvent event = (IntermediateCatchEvent) result2_black[1];
			bpmn2.Process process = (bpmn2.Process) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_22_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_22_3_expressionFBBBBBBBBB(
							this, match, flowNode, event, process, inFlow,
							outFlow, lane, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_22_4_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_22_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_22_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_22_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_336(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_23_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_23_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_23_2_blackFFFFFFFB(_edge_incoming)) {
			ParallelGateway flowNode = (ParallelGateway) result2_black[0];
			IntermediateCatchEvent event = (IntermediateCatchEvent) result2_black[1];
			bpmn2.Process process = (bpmn2.Process) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_23_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_23_3_expressionFBBBBBBBBB(
							this, match, flowNode, event, process, inFlow,
							outFlow, lane, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_23_4_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_23_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_23_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_23_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_337(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_24_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_24_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_24_2_blackFFFFFFFB(_edge_sourceRef)) {
			ParallelGateway flowNode = (ParallelGateway) result2_black[0];
			IntermediateCatchEvent event = (IntermediateCatchEvent) result2_black[1];
			bpmn2.Process process = (bpmn2.Process) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_24_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_24_3_expressionFBBBBBBBBB(
							this, match, flowNode, event, process, inFlow,
							outFlow, lane, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_24_4_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_24_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_24_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_24_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_338(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_25_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_25_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_25_2_blackFFFFFFFB(_edge_outgoing)) {
			ParallelGateway flowNode = (ParallelGateway) result2_black[0];
			IntermediateCatchEvent event = (IntermediateCatchEvent) result2_black[1];
			bpmn2.Process process = (bpmn2.Process) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_25_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_25_3_expressionFBBBBBBBBB(
							this, match, flowNode, event, process, inFlow,
							outFlow, lane, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_25_4_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_25_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_25_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_25_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_839(
			EMoflonEdge _edge_actor) {
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_26_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_26_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];
		...
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
			...
			if (ICEToStepAfterPGRuleImpl
				...
				if (ICEToStepAfterPGRuleImpl
					...
					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_26_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_26_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_26_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_840(
			EMoflonEdge _edge_steps) {
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_27_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_27_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];
		...
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
			...
			if (ICEToStepAfterPGRuleImpl
				...
				if (ICEToStepAfterPGRuleImpl
					...
					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_27_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_27_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_27_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_339(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_28_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_28_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_28_2_blackFFFFFFFB(_edge_flowNodeRefs)) {
			ParallelGateway flowNode = (ParallelGateway) result2_black[0];
			IntermediateCatchEvent event = (IntermediateCatchEvent) result2_black[1];
			bpmn2.Process process = (bpmn2.Process) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			LaneSet laneSet = (LaneSet) result2_black[6];
			Object[] result2_green = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_28_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_28_3_expressionFBBBBBBBBB(
							this, match, flowNode, event, process, inFlow,
							outFlow, lane, laneSet)) {
				// Ensure that the correct types of elements are matched
				if (ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_28_4_expressionFBB(this,
								match)) {

					// Add match to rule result
					Object[] result5_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_28_5_blackBBB(match,
									__performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_28_5_greenBBB(match,
									__performOperation, __result);
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_28_6_expressionFB(__result);
	}
	...
	public ModelgeneratorRuleResult generateModel(
		...
		// create result
		Object[] result1_black = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_31_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_31_1_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_31_2_blackFFFFFFFFFFBB(
			...
			// solve CSP
			Object[] result3_bindingAndBlack = ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_31_3_bindingAndBlackFBBBBBBBBBBBB(
			...
			// check CSP
			if (ICEToStepAfterPGRuleImpl
					.pattern_ICEToStepAfterPGRule_31_4_expressionFBB(this, csp)) {
				// check nacs
				Object[] result5_black = ICEToStepAfterPGRuleImpl
						.pattern_ICEToStepAfterPGRule_31_5_blackBBBBBBBBB(
				...
				if (result5_black != null) {
					...
					// perform
					Object[] result6_black = ICEToStepAfterPGRuleImpl
							.pattern_ICEToStepAfterPGRule_31_6_blackBBBBBBBBBB(
									flowNode, process, inFlow, actor,
									processToActor, flow, inFlowToFlow, lane,
									laneSet, ruleResult);
					if (result6_black == null) {
		...
		return ICEToStepAfterPGRuleImpl
				.pattern_ICEToStepAfterPGRule_31_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_333__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_333((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_334__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_334((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_335__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_335((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_336__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_336((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_337__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_337((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_338__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_338((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_839__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_839((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_840__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_840((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_339__EMOFLONEDGE:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_PG_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PARALLELGATEWAY_PROCESS_SEQUENCEFLOW_ACTOR_PROCESSTOACTOR_FLOW_SEQUENCEFLOWTOUCFLOW_LANE_LANESET_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_0_1_blackBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_0_2_bindingFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_0_2_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_0_2_bindingAndBlackFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
		Object[] result_pattern_ICEToStepAfterPGRule_0_2_binding = pattern_ICEToStepAfterPGRule_0_2_bindingFBBBBBBBBB(
				_this, match, flowNode, event, process, inFlow, outFlow, lane,
				laneSet);
		if (result_pattern_ICEToStepAfterPGRule_0_2_binding != null) {
			CSP csp = (CSP) result_pattern_ICEToStepAfterPGRule_0_2_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_0_2_black = pattern_ICEToStepAfterPGRule_0_2_blackB(csp);
			if (result_pattern_ICEToStepAfterPGRule_0_2_black != null) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_0_3_expressionFBB(
			ICEToStepAfterPGRule _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_0_4_blackBBBBBBBB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_0_4_greenBBBBBBFFFFFFF(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_0_5_blackBBBBBBBB(
			Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_0_5_greenBBBBBBFFFFF(
	...
	public static final void pattern_ICEToStepAfterPGRule_0_6_expressionBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ICEToStepAfterPGRule_0_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_1_1_bindingFFFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_1_1_blackBBBBBBBBBBBFBB(
			ParallelGateway flowNode, IntermediateCatchEvent event,
			bpmn2.Process process, SequenceFlow inFlow, SequenceFlow outFlow,
			Actor actor, ProcessToActor processToActor, Flow flow,
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_1_1_bindingAndBlackFFFFFFFFFFFFBB(
			ICEToStepAfterPGRule _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ICEToStepAfterPGRule_1_1_binding = pattern_ICEToStepAfterPGRule_1_1_bindingFFFFFFFFFFFB(isApplicableMatch);
		if (result_pattern_ICEToStepAfterPGRule_1_1_binding != null) {
			ParallelGateway flowNode = (ParallelGateway) result_pattern_ICEToStepAfterPGRule_1_1_binding[0];
			IntermediateCatchEvent event = (IntermediateCatchEvent) result_pattern_ICEToStepAfterPGRule_1_1_binding[1];
			bpmn2.Process process = (bpmn2.Process) result_pattern_ICEToStepAfterPGRule_1_1_binding[2];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_ICEToStepAfterPGRule_1_1_binding[3];
			SequenceFlow outFlow = (SequenceFlow) result_pattern_ICEToStepAfterPGRule_1_1_binding[4];
			Actor actor = (Actor) result_pattern_ICEToStepAfterPGRule_1_1_binding[5];
			ProcessToActor processToActor = (ProcessToActor) result_pattern_ICEToStepAfterPGRule_1_1_binding[6];
			Flow flow = (Flow) result_pattern_ICEToStepAfterPGRule_1_1_binding[7];
			SequenceFlowToUCFlow inFlowToFlow = (SequenceFlowToUCFlow) result_pattern_ICEToStepAfterPGRule_1_1_binding[8];
			Lane lane = (Lane) result_pattern_ICEToStepAfterPGRule_1_1_binding[9];
			LaneSet laneSet = (LaneSet) result_pattern_ICEToStepAfterPGRule_1_1_binding[10];

			Object[] result_pattern_ICEToStepAfterPGRule_1_1_black = pattern_ICEToStepAfterPGRule_1_1_blackBBBBBBBBBBBFBB(
					flowNode, event, process, inFlow, outFlow, actor,
					processToActor, flow, inFlowToFlow, lane, laneSet, _this,
					isApplicableMatch);
			if (result_pattern_ICEToStepAfterPGRule_1_1_black != null) {
				CSP csp = (CSP) result_pattern_ICEToStepAfterPGRule_1_1_black[11];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_1_3_greenBBBBBBBBBBBFFFFFFFFFFFFF(
		...
		EMoflonEdge lane__event____flowNodeRefs = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		String ruleresult_ruleName_prime = "ICEToStepAfterPGRule";
		String process__outFlow____flowElements_name_prime = "flowElements";
		String process__event____flowElements_name_prime = "flowElements";
		String inFlow__event____targetRef_name_prime = "targetRef";
		String event__inFlow____incoming_name_prime = "incoming";
	...
	public static final PerformRuleResult pattern_ICEToStepAfterPGRule_1_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_2_1_bindingFB(
			ICEToStepAfterPGRule _this) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_1_blackFBB(
			EClass eClass, ICEToStepAfterPGRule _this) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_2_1_binding = pattern_ICEToStepAfterPGRule_2_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_2_1_binding != null) {
			EClass eClass = (EClass) result_pattern_ICEToStepAfterPGRule_2_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_2_1_black = pattern_ICEToStepAfterPGRule_2_1_blackFBB(
					eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_2_1_black != null) {
				EOperation performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_2_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "ICEToStepAfterPGRule";
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_2_bindingFFFFFFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_2_2_blackBBBBBFFFFBBB(
			ParallelGateway flowNode, IntermediateCatchEvent event,
			bpmn2.Process process, SequenceFlow inFlow, SequenceFlow outFlow,
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_2_3_blackBBBBBBBBBBB(
			ParallelGateway flowNode, IntermediateCatchEvent event,
			bpmn2.Process process, SequenceFlow inFlow, SequenceFlow outFlow,
			Actor actor, ProcessToActor processToActor, Flow flow,
			SequenceFlowToUCFlow inFlowToFlow, Lane lane, LaneSet laneSet) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_3_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFF(
			ParallelGateway flowNode, IntermediateCatchEvent event,
			bpmn2.Process process, SequenceFlow inFlow, SequenceFlow outFlow,
			Actor actor, ProcessToActor processToActor, Flow flow,
			SequenceFlowToUCFlow inFlowToFlow, Lane lane, LaneSet laneSet) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_4_bindingFBBBBBBBBBBBBB(
			ICEToStepAfterPGRule _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway flowNode, IntermediateCatchEvent event,
			bpmn2.Process process, SequenceFlow inFlow, SequenceFlow outFlow,
			Actor actor, ProcessToActor processToActor, Flow flow,
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_4_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_2_4_bindingAndBlackFBBBBBBBBBBBBB(
			ICEToStepAfterPGRule _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway flowNode, IntermediateCatchEvent event,
			bpmn2.Process process, SequenceFlow inFlow, SequenceFlow outFlow,
			Actor actor, ProcessToActor processToActor, Flow flow,
			SequenceFlowToUCFlow inFlowToFlow, Lane lane, LaneSet laneSet) {
		Object[] result_pattern_ICEToStepAfterPGRule_2_4_binding = pattern_ICEToStepAfterPGRule_2_4_bindingFBBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, event, process, inFlow,
				outFlow, actor, processToActor, flow, inFlowToFlow, lane,
				laneSet);
		if (result_pattern_ICEToStepAfterPGRule_2_4_binding != null) {
			CSP csp = (CSP) result_pattern_ICEToStepAfterPGRule_2_4_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_2_4_black = pattern_ICEToStepAfterPGRule_2_4_blackB(csp);
			if (result_pattern_ICEToStepAfterPGRule_2_4_black != null) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_2_5_expressionFBB(
			ICEToStepAfterPGRule _this, CSP csp) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_2_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_2_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "ICEToStepAfterPGRule";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_ICEToStepAfterPGRule_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_10_2_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final boolean pattern_ICEToStepAfterPGRule_10_3_expressionFBB(
			ICEToStepAfterPGRule _this, CSP csp) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ICEToStepAfterPGRule_10_8_expressionF() {
		boolean _result = false;
		return _result;
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_11_1_bindingAndBlackFFFFFFFFFFFBB(
			ICEToStepAfterPGRule _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final PerformRuleResult pattern_ICEToStepAfterPGRule_11_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_12_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_12_1_blackFBB(
			EClass eClass, ICEToStepAfterPGRule _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperationname = performOperation.getName();
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_12_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_12_1_binding = pattern_ICEToStepAfterPGRule_12_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_12_1_binding != null) {
			EClass eClass = (EClass) result_pattern_ICEToStepAfterPGRule_12_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_12_1_black = pattern_ICEToStepAfterPGRule_12_1_blackFBB(
					eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_12_1_black != null) {
				EOperation performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_12_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_12_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_12_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_12_4_bindingAndBlackFBBBBBBBBBBBB(
		...
		if (result_pattern_ICEToStepAfterPGRule_12_4_binding != null) {
			...
			Object[] result_pattern_ICEToStepAfterPGRule_12_4_black = pattern_ICEToStepAfterPGRule_12_4_blackB(csp);
	...
	public static final boolean pattern_ICEToStepAfterPGRule_12_5_expressionFBB(
			ICEToStepAfterPGRule _this, CSP csp) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_12_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_12_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
	...
	public static final IsApplicableRuleResult pattern_ICEToStepAfterPGRule_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_20_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_20_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_20_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_20_1_binding = pattern_ICEToStepAfterPGRule_20_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_20_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_20_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_20_1_black = pattern_ICEToStepAfterPGRule_20_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_20_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_20_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_20_1_greenF() {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_20_2_black_nac_0B(
		...
		for (ExclusiveGateway __DEC_outFlow_default_973524 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_20_2_black_nac_1BB(
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_20_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
			...
			if (tmpOutFlow instanceof SequenceFlow) {
				...
				if (process.getFlowElements().contains(outFlow)) {
					...
					if (tmpEvent instanceof IntermediateCatchEvent) {
						IntermediateCatchEvent event = (IntermediateCatchEvent) tmpEvent;
						if (process.getFlowElements().contains(event)) {
							if (pattern_ICEToStepAfterPGRule_20_2_black_nac_0B(outFlow) == null) {
								if (pattern_ICEToStepAfterPGRule_20_2_black_nac_1BB(
										outFlow, event) == null) {
									for (LaneSet laneSet : process
											.getLaneSets()) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_20_2_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_20_3_expressionFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_20_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_20_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_20_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_20_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_21_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_21_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_21_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_21_1_binding = pattern_ICEToStepAfterPGRule_21_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_21_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_21_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_21_1_black = pattern_ICEToStepAfterPGRule_21_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_21_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_21_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_21_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_21_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_601153 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_21_2_black_nac_1BB(
			SequenceFlow outFlow, IntermediateCatchEvent event) {
		if (event.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, event };
		}
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_21_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpProcess = _edge_flowElements.getSrc();
		if (tmpProcess instanceof bpmn2.Process) {
											...
											if (tmpOutFlow instanceof SequenceFlow) {
												...
												if (!inFlow.equals(outFlow)) {
													if (event.equals(outFlow
															.getSourceRef())) {
														if (pattern_ICEToStepAfterPGRule_21_2_black_nac_0B(outFlow) == null) {
															if (pattern_ICEToStepAfterPGRule_21_2_black_nac_1BB(
																	outFlow,
																	event) == null) {
																for (Lane lane : laneSet
																		.getLanes()) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_21_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_21_3_expressionFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_21_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_21_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_21_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_21_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_22_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_22_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_22_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_22_1_binding = pattern_ICEToStepAfterPGRule_22_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_22_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_22_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_22_1_black = pattern_ICEToStepAfterPGRule_22_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_22_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_22_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_22_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_22_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_575046 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_22_2_black_nac_1BB(
			SequenceFlow outFlow, IntermediateCatchEvent event) {
		if (event.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, event };
		}
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_22_2_blackFFFFFFFB(
			EMoflonEdge _edge_targetRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (event.equals(inFlow.getTargetRef())) {
					...
					if (tmpFlowNode instanceof ParallelGateway) {
						...
						for (SequenceFlow outFlow : event.getOutgoing()) {
							if (!inFlow.equals(outFlow)) {
								if (pattern_ICEToStepAfterPGRule_22_2_black_nac_0B(outFlow) == null) {
									if (pattern_ICEToStepAfterPGRule_22_2_black_nac_1BB(
											outFlow, event) == null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_22_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_22_3_expressionFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_22_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_22_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_22_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_22_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_23_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_23_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_23_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_23_1_binding = pattern_ICEToStepAfterPGRule_23_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_23_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_23_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_23_1_black = pattern_ICEToStepAfterPGRule_23_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_23_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_23_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_23_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_23_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_840926 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_23_2_black_nac_1BB(
			SequenceFlow outFlow, IntermediateCatchEvent event) {
		if (event.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, event };
		}
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_23_2_blackFFFFFFFB(
			EMoflonEdge _edge_incoming) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
			...
			if (tmpInFlow instanceof SequenceFlow) {
				...
				if (event.equals(inFlow.getTargetRef())) {
					...
					if (tmpFlowNode instanceof ParallelGateway) {
						...
						for (SequenceFlow outFlow : event.getOutgoing()) {
							if (!inFlow.equals(outFlow)) {
								if (pattern_ICEToStepAfterPGRule_23_2_black_nac_0B(outFlow) == null) {
									if (pattern_ICEToStepAfterPGRule_23_2_black_nac_1BB(
											outFlow, event) == null) {
										for (FlowElementsContainer tmpProcess : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(
														event,
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_23_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_23_3_expressionFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_23_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_23_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_23_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_23_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_24_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_24_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_24_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_24_1_binding = pattern_ICEToStepAfterPGRule_24_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_24_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_24_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_24_1_black = pattern_ICEToStepAfterPGRule_24_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_24_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_24_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_24_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_24_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_829844 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_24_2_black_nac_1BB(
			SequenceFlow outFlow, IntermediateCatchEvent event) {
		if (event.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, event };
		}
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_24_2_blackFFFFFFFB(
			EMoflonEdge _edge_sourceRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpOutFlow instanceof SequenceFlow) {
			...
			if (tmpEvent instanceof IntermediateCatchEvent) {
				IntermediateCatchEvent event = (IntermediateCatchEvent) tmpEvent;
				if (event.equals(outFlow.getSourceRef())) {
					if (pattern_ICEToStepAfterPGRule_24_2_black_nac_0B(outFlow) == null) {
						if (pattern_ICEToStepAfterPGRule_24_2_black_nac_1BB(
								outFlow, event) == null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_24_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_24_3_expressionFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_24_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_24_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_24_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_24_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_25_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_25_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_25_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_25_1_binding = pattern_ICEToStepAfterPGRule_25_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_25_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_25_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_25_1_black = pattern_ICEToStepAfterPGRule_25_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_25_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_25_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_25_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_25_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_834693 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_25_2_black_nac_1BB(
			SequenceFlow outFlow, IntermediateCatchEvent event) {
		if (event.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, event };
		}
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_25_2_blackFFFFFFFB(
			EMoflonEdge _edge_outgoing) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpEvent instanceof IntermediateCatchEvent) {
			...
			if (tmpOutFlow instanceof SequenceFlow) {
				SequenceFlow outFlow = (SequenceFlow) tmpOutFlow;
				if (event.equals(outFlow.getSourceRef())) {
					if (pattern_ICEToStepAfterPGRule_25_2_black_nac_0B(outFlow) == null) {
						if (pattern_ICEToStepAfterPGRule_25_2_black_nac_1BB(
								outFlow, event) == null) {
							for (SequenceFlow inFlow : event.getIncoming()) {
								if (!inFlow.equals(outFlow)) {
									FlowNode tmpFlowNode = inFlow
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_25_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_25_3_expressionFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_25_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_25_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_25_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_25_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_26_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_26_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_26_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_26_1_binding = pattern_ICEToStepAfterPGRule_26_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_26_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_26_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_26_1_black = pattern_ICEToStepAfterPGRule_26_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_26_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_26_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_26_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_26_2_blackFFFB(
			EMoflonEdge _edge_actor) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_26_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_26_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_26_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_26_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_26_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_27_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_27_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_BWD")) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_27_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_27_1_binding = pattern_ICEToStepAfterPGRule_27_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_27_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_27_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_27_1_black = pattern_ICEToStepAfterPGRule_27_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_27_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_27_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_27_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_27_2_blackFFFB(
			EMoflonEdge _edge_steps) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_27_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_27_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_27_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_27_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_27_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_28_1_bindingFB(
			ICEToStepAfterPGRule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_28_1_blackFBB(
			EClass __eClass, ICEToStepAfterPGRule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_28_1_bindingAndBlackFFB(
			ICEToStepAfterPGRule _this) {
		Object[] result_pattern_ICEToStepAfterPGRule_28_1_binding = pattern_ICEToStepAfterPGRule_28_1_bindingFB(_this);
		if (result_pattern_ICEToStepAfterPGRule_28_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ICEToStepAfterPGRule_28_1_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_28_1_black = pattern_ICEToStepAfterPGRule_28_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ICEToStepAfterPGRule_28_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ICEToStepAfterPGRule_28_1_black[0];
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_28_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_28_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_82162 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_28_2_black_nac_1BB(
			SequenceFlow outFlow, IntermediateCatchEvent event) {
		if (event.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, event };
		}
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_28_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowNodeRefs) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (lane.getFlowNodeRefs().contains(event)) {
					for (SequenceFlow inFlow : event.getIncoming()) {
						...
						if (tmpFlowNode instanceof ParallelGateway) {
							...
							for (SequenceFlow outFlow : event.getOutgoing()) {
								if (!inFlow.equals(outFlow)) {
									if (pattern_ICEToStepAfterPGRule_28_2_black_nac_0B(outFlow) == null) {
										if (pattern_ICEToStepAfterPGRule_28_2_black_nac_1BB(
												outFlow, event) == null) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_28_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ICEToStepAfterPGRule_28_3_expressionFBBBBBBBBB(
			ICEToStepAfterPGRule _this, Match match, ParallelGateway flowNode,
			IntermediateCatchEvent event, bpmn2.Process process,
			SequenceFlow inFlow, SequenceFlow outFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_28_4_expressionFBB(
			ICEToStepAfterPGRule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_28_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_28_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ICEToStepAfterPGRule_28_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_31_1_blackB(
			ICEToStepAfterPGRule _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_31_1_greenFF() {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableMatch();
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_0BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_1BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_2BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_3BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_4BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_5BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_6BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_7BB(
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_2_black_nac_8BB(
	...
	public static final Iterable<Object[]> pattern_ICEToStepAfterPGRule_31_2_blackFFFFFFFFFFBB(
			RuleEntryContainer ruleEntryContainer,
			ModelgeneratorRuleResult ruleResult) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
			...
			for (EObject tmpProcessToActor : processToActorList
				...
				if (tmpProcessToActor instanceof ProcessToActor) {
					...
					if (process != null) {
						Actor actor = processToActor.getTarget();
						if (actor != null) {
							if (pattern_ICEToStepAfterPGRule_31_2_black_nac_5BB(
									ruleResult, processToActor) == null) {
								if (pattern_ICEToStepAfterPGRule_31_2_black_nac_2BB(
										ruleResult, process) == null) {
									if (pattern_ICEToStepAfterPGRule_31_2_black_nac_6BB(
										...
										for (FlowElement tmpInFlow : process
											...
											if (tmpInFlow instanceof SequenceFlow) {
												...
												if (tmpFlowNode instanceof ParallelGateway) {
													ParallelGateway flowNode = (ParallelGateway) tmpFlowNode;
													if (pattern_ICEToStepAfterPGRule_31_2_black_nac_1BB(
															ruleResult, inFlow) == null) {
														if (pattern_ICEToStepAfterPGRule_31_2_black_nac_0BB(
																ruleResult,
																flowNode) == null) {
															for (LaneSet laneSet : process
																	.getLaneSets()) {
																if (pattern_ICEToStepAfterPGRule_31_2_black_nac_3BB(
																		ruleResult,
																		laneSet) == null) {
																	for (Lane lane : laneSet
																			.getLanes()) {
																		if (pattern_ICEToStepAfterPGRule_31_2_black_nac_4BB(
																				ruleResult,
																				lane) == null) {
																			for (SequenceFlowToUCFlow inFlowToFlow : org.moflon.core.utilities.eMoflonEMFUtil
																					.getOppositeReferenceTyped(
																				...
																				Flow flow = inFlowToFlow
																						.getTarget();
																				if (flow != null) {
																					if (pattern_ICEToStepAfterPGRule_31_2_black_nac_7BB(
																							ruleResult,
																							inFlowToFlow) == null) {
																						if (pattern_ICEToStepAfterPGRule_31_2_black_nac_8BB(
																								ruleResult,
																								flow) == null) {
																							_result.add(new Object[] {
																									processToActorList,
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_3_bindingFBBBBBBBBBBBB(
			ICEToStepAfterPGRule _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway flowNode, bpmn2.Process process,
			SequenceFlow inFlow, Actor actor, ProcessToActor processToActor,
			Flow flow, SequenceFlowToUCFlow inFlowToFlow, Lane lane,
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_3_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ICEToStepAfterPGRule_31_3_bindingAndBlackFBBBBBBBBBBBB(
			ICEToStepAfterPGRule _this, IsApplicableMatch isApplicableMatch,
			ParallelGateway flowNode, bpmn2.Process process,
			SequenceFlow inFlow, Actor actor, ProcessToActor processToActor,
			Flow flow, SequenceFlowToUCFlow inFlowToFlow, Lane lane,
			LaneSet laneSet, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_ICEToStepAfterPGRule_31_3_binding = pattern_ICEToStepAfterPGRule_31_3_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, process, inFlow, actor,
				processToActor, flow, inFlowToFlow, lane, laneSet, ruleResult);
		if (result_pattern_ICEToStepAfterPGRule_31_3_binding != null) {
			CSP csp = (CSP) result_pattern_ICEToStepAfterPGRule_31_3_binding[0];

			Object[] result_pattern_ICEToStepAfterPGRule_31_3_black = pattern_ICEToStepAfterPGRule_31_3_blackB(csp);
			if (result_pattern_ICEToStepAfterPGRule_31_3_black != null) {
	...
	public static final boolean pattern_ICEToStepAfterPGRule_31_4_expressionFBB(
			ICEToStepAfterPGRule _this, CSP csp) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_5_blackBBBBBBBBB(
			ParallelGateway flowNode, bpmn2.Process process,
			SequenceFlow inFlow, Actor actor, ProcessToActor processToActor,
			Flow flow, SequenceFlowToUCFlow inFlowToFlow, Lane lane,
			LaneSet laneSet) {
	...
	public static final Object[] pattern_ICEToStepAfterPGRule_31_6_blackBBBBBBBBBB(
			ParallelGateway flowNode, bpmn2.Process process,
			SequenceFlow inFlow, Actor actor, ProcessToActor processToActor,
			Flow flow, SequenceFlowToUCFlow inFlowToFlow, Lane lane,
			LaneSet laneSet, ModelgeneratorRuleResult ruleResult) {
