...
public class BpModelToUseCaseModelRuleImpl extends AbstractRuleImpl implements
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			docRootToUCModel = BpmnToUseCaseIntegrationFactory.eINSTANCE
		...
		try {
			...
			org.moflon.util.eMoflonEMFUtil.addOppositeReference(ruleresult,
					docRootToUCModel, "createdLinkElements");
		...
		try {
			...
			docRootToUCModel__source__documentRoot = TGGRuntimeFactory.eINSTANCE
					.createEMoflonEdge();

			// create object docRootToUCModel__target__useCasesModel
			docRootToUCModel__target__useCasesModel = TGGRuntimeFactory.eINSTANCE
					.createEMoflonEdge();
			...
			// create link
			org.moflon.util.eMoflonEMFUtil.addOppositeReference(ruleresult,
					docRootToUCModel__source__documentRoot, "createdEdges");

			// create link
			org.moflon.util.eMoflonEMFUtil.addOppositeReference(ruleresult,
					docRootToUCModel__target__useCasesModel, "createdEdges");
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.BP_MODEL_TO_USE_CASE_MODEL_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_DOCUMENTROOT_USECASESMODEL_DOCROOTTOUCMODEL_MODELGENERATORRULERESULT:
