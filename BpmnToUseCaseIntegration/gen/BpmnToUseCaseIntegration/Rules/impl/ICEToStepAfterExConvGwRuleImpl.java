...
public class ICEToStepAfterExConvGwRuleImpl extends AbstractRuleImpl implements
	...
	public boolean isAppropriate_FWD(Match match, ExclusiveGateway flowNode,
		...
		if (fujaba__Success) {
			...
			this.registerObjectsToMatch_FWD(match, flowNode, event, inFlow,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRule("ICEToStepAfterExConvGwRule");
									...
									try {
										...
										if (fujaba__Success) {
											...
											try {
												...
												isApplicableMatch
														.setRuleName("ICEToStepAfterExConvGwRule");
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRuleName("ICEToStepAfterExConvGwRule");
		...
		this.registerObjects_FWD(ruleresult, flowNode, event, inFlow, prevStep,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// No post processing method found
		// statement node 'register objects'
		this.registerObjects_BWD(ruleresult, flowNode, event, inFlow, prevStep,
				inFlowToPrevStep, normalStep, process, outFlow, actor,
				processToActor, eventToNormalStep, outFlowToNormalStep, flow,
				inFlowToFlow, outFlowToFlow, lane, laneSet);
		return ruleresult;
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_50(
		...
		Flow __DEC_normalStep_steps_79798 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_569579 = null;
		Step __DEC_normalStep_next_569579 = null;
		Match match = null;
		Flow flow = null;
		Actor actor = null;
		NormalStep normalStep = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_79798 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_79798 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_79798 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_79798.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_79798 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_79798.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_569579
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_569579 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_569579
									.hasNext()) {
						try {
							__DEC_normalStep_next_569579 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_569579
									.next();

							// check object __DEC_normalStep_next_569579 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_569579 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_569579 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_569579
									.equals(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_next_569579 and prevStep 
							JavaSDM.ensure(!__DEC_normalStep_next_569579
									.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_167(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_321398 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_455263 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_548940 = null;
		ExclusiveGateway __DEC_outFlow_default_548940 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_672947 = null;
		SequenceFlow __DEC_event_targetRef_672947 = null;
		Match match = null;
		ExclusiveGateway flowNode = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_321398 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_321398 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_321398 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_321398
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_321398 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_321398
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_455263 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_455263 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_455263 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_455263
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_455263 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_455263
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_548940
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_548940 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_548940
													.hasNext()) {
										try {
											__DEC_outFlow_default_548940 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_548940
													.next();

											// check object __DEC_outFlow_default_548940 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_548940 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_548940 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_548940
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_672947
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_672947 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_672947
													.hasNext()) {
										try {
											__DEC_event_targetRef_672947 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_672947
													.next();

											// check object __DEC_event_targetRef_672947 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_672947 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_672947 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_672947
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_672947 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_672947
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_168(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_460512 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_917246 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_955768 = null;
		ExclusiveGateway __DEC_outFlow_default_955768 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_494849 = null;
		SequenceFlow __DEC_event_targetRef_494849 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_460512 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_460512 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_460512 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_460512
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_460512 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_460512
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_917246 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_917246 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_917246 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_917246
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_917246 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_917246
													.equals(process));
										...
										try {
											...
											// iterate to-many link default from outFlow to __DEC_outFlow_default_955768
											fujaba__Success = false;

											fujaba__IterOutFlowTo__DEC_outFlow_default_955768 = new ArrayList(
													org.moflon.util.eMoflonEMFUtil
															.getOppositeReference(
																	outFlow,
																	ExclusiveGateway.class,
											...
											while (!(fujaba__Success)
													&& fujaba__IterOutFlowTo__DEC_outFlow_default_955768
															.hasNext()) {
												try {
													__DEC_outFlow_default_955768 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_955768
															.next();

													// check object __DEC_outFlow_default_955768 is really bound
													JavaSDM.ensure(__DEC_outFlow_default_955768 != null);
													// check isomorphic binding between objects __DEC_outFlow_default_955768 and flowNode 
													JavaSDM.ensure(!__DEC_outFlow_default_955768
															.equals(flowNode));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_494849
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_494849 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_494849
															.hasNext()) {
												try {
													__DEC_event_targetRef_494849 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_494849
															.next();

													// check object __DEC_event_targetRef_494849 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_494849 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_494849 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_494849
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_494849 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_494849
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_169(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_927842 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_641731 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_733973 = null;
		ExclusiveGateway __DEC_outFlow_default_733973 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_650754 = null;
		SequenceFlow __DEC_event_targetRef_650754 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		LaneSet laneSet = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_927842 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_927842 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_927842 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_927842
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_927842 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_927842
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_641731 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_641731 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_641731 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_641731
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_641731 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_641731
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_733973
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_733973 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
													.getOppositeReference(
															outFlow,
															ExclusiveGateway.class,
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_733973
													.hasNext()) {
										try {
											__DEC_outFlow_default_733973 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_733973
													.next();

											// check object __DEC_outFlow_default_733973 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_733973 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_733973 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_733973
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_650754
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_650754 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_650754
													.hasNext()) {
										try {
											__DEC_event_targetRef_650754 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_650754
													.next();

											// check object __DEC_event_targetRef_650754 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_650754 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_650754 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_650754
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_650754 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_650754
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_170(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_422026 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_772952 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_494268 = null;
		ExclusiveGateway __DEC_outFlow_default_494268 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_270684 = null;
		SequenceFlow __DEC_event_targetRef_270684 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_422026 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_422026 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_422026 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_422026
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_422026 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_422026
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_772952 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_772952 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_772952 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_772952
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_772952 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_772952
													.equals(process));
										...
										try {
											...
											// iterate to-many link default from outFlow to __DEC_outFlow_default_494268
											fujaba__Success = false;

											fujaba__IterOutFlowTo__DEC_outFlow_default_494268 = new ArrayList(
													org.moflon.util.eMoflonEMFUtil
															.getOppositeReference(
																	outFlow,
																	ExclusiveGateway.class,
											...
											while (!(fujaba__Success)
													&& fujaba__IterOutFlowTo__DEC_outFlow_default_494268
															.hasNext()) {
												try {
													__DEC_outFlow_default_494268 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_494268
															.next();

													// check object __DEC_outFlow_default_494268 is really bound
													JavaSDM.ensure(__DEC_outFlow_default_494268 != null);
													// check isomorphic binding between objects __DEC_outFlow_default_494268 and flowNode 
													JavaSDM.ensure(!__DEC_outFlow_default_494268
															.equals(flowNode));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_270684
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_270684 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_270684
															.hasNext()) {
												try {
													__DEC_event_targetRef_270684 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_270684
															.next();

													// check object __DEC_event_targetRef_270684 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_270684 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_270684 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_270684
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_270684 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_270684
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_171(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_916383 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_251451 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_335229 = null;
		ExclusiveGateway __DEC_outFlow_default_335229 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_921585 = null;
		SequenceFlow __DEC_event_targetRef_921585 = null;
		Match match = null;
		ExclusiveGateway flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_916383 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_916383 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_916383 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_916383
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_916383 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_916383
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_251451 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_251451 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_251451 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_251451
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_251451 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_251451
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_335229
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_335229 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
													.getOppositeReference(
															outFlow,
															ExclusiveGateway.class,
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_335229
													.hasNext()) {
										try {
											__DEC_outFlow_default_335229 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_335229
													.next();

											// check object __DEC_outFlow_default_335229 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_335229 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_335229 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_335229
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_921585
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_921585 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_921585
													.hasNext()) {
										try {
											__DEC_event_targetRef_921585 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_921585
													.next();

											// check object __DEC_event_targetRef_921585 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_921585 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_921585 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_921585
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_921585 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_921585
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_172(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_612905 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_270442 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_79886 = null;
		ExclusiveGateway __DEC_outFlow_default_79886 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_947585 = null;
		SequenceFlow __DEC_event_targetRef_947585 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_612905 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_612905 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_612905 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_612905
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_612905 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_612905
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_270442 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_270442 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_270442 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_270442
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_270442 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_270442
													.equals(process));
										...
										try {
											...
											// iterate to-many link default from outFlow to __DEC_outFlow_default_79886
											fujaba__Success = false;

											fujaba__IterOutFlowTo__DEC_outFlow_default_79886 = new ArrayList(
													org.moflon.util.eMoflonEMFUtil
															.getOppositeReference(
																	outFlow,
																	ExclusiveGateway.class,
											...
											while (!(fujaba__Success)
													&& fujaba__IterOutFlowTo__DEC_outFlow_default_79886
															.hasNext()) {
												try {
													__DEC_outFlow_default_79886 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_79886
															.next();

													// check object __DEC_outFlow_default_79886 is really bound
													JavaSDM.ensure(__DEC_outFlow_default_79886 != null);
													// check isomorphic binding between objects __DEC_outFlow_default_79886 and flowNode 
													JavaSDM.ensure(!__DEC_outFlow_default_79886
															.equals(flowNode));
										...
										try {
											...
											// iterate to-many link incoming from event to __DEC_event_targetRef_947585
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_947585 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_947585
															.hasNext()) {
												try {
													__DEC_event_targetRef_947585 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_947585
															.next();

													// check object __DEC_event_targetRef_947585 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_947585 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_947585 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_947585
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_947585 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_947585
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_51(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_572206 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_206976 = null;
		Step __DEC_normalStep_next_206976 = null;
		Match match = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_572206 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_572206 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_572206 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_572206
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_572206 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_572206
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_206976
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_206976 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_206976
											.hasNext()) {
								try {
									__DEC_normalStep_next_206976 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_206976
											.next();

									// check object __DEC_normalStep_next_206976 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_206976 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_206976 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_206976
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_206976 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_206976
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_52(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_765860 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_408743 = null;
		Step __DEC_normalStep_next_408743 = null;
		Match match = null;
		Iterator fujaba__IterNormalStepToPrevStep = null;
		Step prevStep = null;
		Actor actor = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_765860 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_765860 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_765860 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_765860
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_765860 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_765860
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_408743
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_408743 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_408743
											.hasNext()) {
								try {
									__DEC_normalStep_next_408743 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_408743
											.next();

									// check object __DEC_normalStep_next_408743 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_408743 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_408743 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_408743
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_408743 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_408743
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_173(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_427761 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_144301 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_542005 = null;
		ExclusiveGateway __DEC_outFlow_default_542005 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_473887 = null;
		SequenceFlow __DEC_event_targetRef_473887 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		ExclusiveGateway flowNode = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_427761 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_427761 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_427761 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_427761
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_427761 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_427761
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_144301 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_144301 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_144301 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_144301
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_144301 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_144301
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_542005
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_542005 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
													.getOppositeReference(
															outFlow,
															ExclusiveGateway.class,
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_542005
													.hasNext()) {
										try {
											__DEC_outFlow_default_542005 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_542005
													.next();

											// check object __DEC_outFlow_default_542005 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_542005 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_542005 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_542005
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link incoming from event to __DEC_event_targetRef_473887
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_473887 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_473887
													.hasNext()) {
										try {
											__DEC_event_targetRef_473887 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_473887
													.next();

											// check object __DEC_event_targetRef_473887 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_473887 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_473887 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_473887
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_473887 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_473887
													.equals(outFlow));
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___IS_APPROPRIATE_BWD__MATCH_STEP_NORMALSTEP_ACTOR_FLOW:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_STEP_NORMALSTEP_ACTOR_FLOW:
			registerObjectsToMatch_BWD((Match) arguments.get(0),
					(Step) arguments.get(1), (NormalStep) arguments.get(2),
					(Actor) arguments.get(3), (Flow) arguments.get(4));
			return null;
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_STEP_NORMALSTEP_ACTOR_FLOW:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
					(Step) arguments.get(1), (NormalStep) arguments.get(2),
					(Actor) arguments.get(3), (Flow) arguments.get(4));
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_EXCLUSIVEGATEWAY_SEQUENCEFLOW_STEP_SEQUENCEFLOWTOSTEP_NORMALSTEP_PROCESS_ACTOR_PROCESSTOACTOR_FLOW_SEQUENCEFLOWTOUCFLOW_LANE_LANESET:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_170__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_170((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_171__EMOFLONEDGE:
		...
		case RulesPackage.ICE_TO_STEP_AFTER_EX_CONV_GW_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_EXCLUSIVEGATEWAY_INTERMEDIATECATCHEVENT_SEQUENCEFLOW_STEP_SEQUENCEFLOWTOSTEP_NORMALSTEP_PROCESS_SEQUENCEFLOW_ACTOR_PROCESSTOACTOR_FLOWNODETOSTEP_SEQUENCEFLOWTOSTEP_FLOW_SEQUENCEFLOWTOUCFLOW_SEQUENCEFLOWTOUCFLOW_LANE_LANESET_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD(
					...
					(SequenceFlow) arguments.get(8), (Actor) arguments.get(9),
