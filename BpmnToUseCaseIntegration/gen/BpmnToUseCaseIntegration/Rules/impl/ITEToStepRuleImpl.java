...
public class ITEToStepRuleImpl extends AbstractRuleImpl implements
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_11(
		...
		Flow __DEC_normalStep_steps_431416 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_752030 = null;
		Step __DEC_normalStep_next_752030 = null;
		Match match = null;
		Flow flow = null;
		Actor actor = null;
		NormalStep normalStep = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_normalStep_steps_431416 = normalStep.eContainer() instanceof Flow ? (Flow) normalStep
							.eContainer() : null;

					// check object __DEC_normalStep_steps_431416 is really bound
					JavaSDM.ensure(__DEC_normalStep_steps_431416 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_normalStep_steps_431416.getSteps()
							.contains(normalStep));

					// check isomorphic binding between objects __DEC_normalStep_steps_431416 and flow 
					JavaSDM.ensure(!__DEC_normalStep_steps_431416.equals(flow));
				...
				try {
					...
					// iterate to-many link next from normalStep to __DEC_normalStep_next_752030
					fujaba__Success = false;

					fujaba__IterNormalStepTo__DEC_normalStep_next_752030 = new ArrayList(
							org.moflon.util.eMoflonEMFUtil
									.getOppositeReference(normalStep,
											Step.class, "next")).iterator();

					while (!(fujaba__Success)
							&& fujaba__IterNormalStepTo__DEC_normalStep_next_752030
									.hasNext()) {
						try {
							__DEC_normalStep_next_752030 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_752030
									.next();

							// check object __DEC_normalStep_next_752030 is really bound
							JavaSDM.ensure(__DEC_normalStep_next_752030 != null);
							// check isomorphic binding between objects __DEC_normalStep_next_752030 and normalStep 
							JavaSDM.ensure(!__DEC_normalStep_next_752030
									.equals(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_next_752030 and prevStep 
							JavaSDM.ensure(!__DEC_normalStep_next_752030
									.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_20(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_72761 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_515920 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_215849 = null;
		ExclusiveGateway __DEC_outFlow_default_215849 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_172925 = null;
		SequenceFlow __DEC_event_targetRef_172925 = null;
		Match match = null;
		FlowNode flowNode = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_72761 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_72761 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_72761 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_72761
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_72761 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_72761
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_515920 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_515920 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_515920 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_515920
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_515920 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_515920
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_215849
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_215849 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_215849
													.hasNext()) {
										try {
											__DEC_outFlow_default_215849 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_215849
													.next();

											// check object __DEC_outFlow_default_215849 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_215849 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_215849 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_215849
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_172925
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_172925 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_172925
													.hasNext()) {
										try {
											__DEC_event_targetRef_172925 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_172925
													.next();

											// check object __DEC_event_targetRef_172925 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_172925 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_172925 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_172925
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_172925 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_172925
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_21(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_785174 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_856693 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_626668 = null;
		ExclusiveGateway __DEC_outFlow_default_626668 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_835714 = null;
		SequenceFlow __DEC_event_targetRef_835714 = null;
		Match match = null;
		FlowNode flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_785174 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_785174 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_785174 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_785174
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_785174 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_785174
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_856693 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_856693 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_856693 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_856693
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_856693 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_856693
													.equals(process));
										...
										try {
											...
											// iterate to-many link default from outFlow to __DEC_outFlow_default_626668
											fujaba__Success = false;

											fujaba__IterOutFlowTo__DEC_outFlow_default_626668 = new ArrayList(
													org.moflon.util.eMoflonEMFUtil
															.getOppositeReference(
																	outFlow,
																	ExclusiveGateway.class,
											...
											while (!(fujaba__Success)
													&& fujaba__IterOutFlowTo__DEC_outFlow_default_626668
															.hasNext()) {
												try {
													__DEC_outFlow_default_626668 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_626668
															.next();

													// check object __DEC_outFlow_default_626668 is really bound
													JavaSDM.ensure(__DEC_outFlow_default_626668 != null);
													// check isomorphic binding between objects __DEC_outFlow_default_626668 and flowNode 
													JavaSDM.ensure(!__DEC_outFlow_default_626668
															.equals(flowNode));
										...
										try {
											...
											// iterate to-many link targetRef from event to __DEC_event_targetRef_835714
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_835714 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_835714
															.hasNext()) {
												try {
													__DEC_event_targetRef_835714 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_835714
															.next();

													// check object __DEC_event_targetRef_835714 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_835714 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_835714 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_835714
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_835714 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_835714
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_22(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_62212 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_349381 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_522877 = null;
		ExclusiveGateway __DEC_outFlow_default_522877 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_566131 = null;
		SequenceFlow __DEC_event_targetRef_566131 = null;
		Match match = null;
		Iterator fujaba__IterEventToOutFlow = null;
		SequenceFlow outFlow = null;
		LaneSet laneSet = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_62212 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_62212 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_62212 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_62212
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_62212 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_62212
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_349381 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_349381 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_349381 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_349381
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_349381 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_349381
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_522877
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_522877 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
													.getOppositeReference(
															outFlow,
															ExclusiveGateway.class,
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_522877
													.hasNext()) {
										try {
											__DEC_outFlow_default_522877 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_522877
													.next();

											// check object __DEC_outFlow_default_522877 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_522877 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_522877 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_522877
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_566131
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_566131 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_566131
													.hasNext()) {
										try {
											__DEC_event_targetRef_566131 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_566131
													.next();

											// check object __DEC_event_targetRef_566131 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_566131 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_566131 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_566131
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_566131 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_566131
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_23(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_51401 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_665745 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_8084 = null;
		ExclusiveGateway __DEC_outFlow_default_8084 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_849359 = null;
		SequenceFlow __DEC_event_targetRef_849359 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_51401 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_51401 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_51401 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_51401
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_51401 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_51401
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_665745 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_665745 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_665745 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_665745
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_665745 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_665745
													.equals(process));
										...
										try {
											...
											// iterate to-many link default from outFlow to __DEC_outFlow_default_8084
											fujaba__Success = false;

											fujaba__IterOutFlowTo__DEC_outFlow_default_8084 = new ArrayList(
													org.moflon.util.eMoflonEMFUtil
															.getOppositeReference(
																	outFlow,
																	ExclusiveGateway.class,
											...
											while (!(fujaba__Success)
													&& fujaba__IterOutFlowTo__DEC_outFlow_default_8084
															.hasNext()) {
												try {
													__DEC_outFlow_default_8084 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_8084
															.next();

													// check object __DEC_outFlow_default_8084 is really bound
													JavaSDM.ensure(__DEC_outFlow_default_8084 != null);
													// check isomorphic binding between objects __DEC_outFlow_default_8084 and flowNode 
													JavaSDM.ensure(!__DEC_outFlow_default_8084
															.equals(flowNode));
										...
										try {
											...
											// iterate to-many link targetRef from event to __DEC_event_targetRef_849359
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_849359 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_849359
															.hasNext()) {
												try {
													__DEC_event_targetRef_849359 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_849359
															.next();

													// check object __DEC_event_targetRef_849359 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_849359 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_849359 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_849359
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_849359 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_849359
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_24(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_91203 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_987232 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_321481 = null;
		ExclusiveGateway __DEC_outFlow_default_321481 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_461303 = null;
		SequenceFlow __DEC_event_targetRef_461303 = null;
		Match match = null;
		FlowNode flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_91203 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_91203 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_91203 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_91203
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_91203 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_91203
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_987232 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_987232 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_987232 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_987232
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_987232 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_987232
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_321481
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_321481 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
													.getOppositeReference(
															outFlow,
															ExclusiveGateway.class,
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_321481
													.hasNext()) {
										try {
											__DEC_outFlow_default_321481 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_321481
													.next();

											// check object __DEC_outFlow_default_321481 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_321481 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_321481 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_321481
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_461303
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_461303 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_461303
													.hasNext()) {
										try {
											__DEC_event_targetRef_461303 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_461303
													.next();

											// check object __DEC_event_targetRef_461303 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_461303 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_461303 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_461303
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_461303 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_461303
													.equals(outFlow));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_25(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_671564 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_680095 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_730436 = null;
		ExclusiveGateway __DEC_outFlow_default_730436 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_278134 = null;
		SequenceFlow __DEC_event_targetRef_278134 = null;
		Match match = null;
								...
								try {
									...
									try {
										...
										try {
											...
											// bind object
											__DEC_event_flowElements_671564 = event
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
													.eContainer() : null;

											// check object __DEC_event_flowElements_671564 is really bound
											JavaSDM.ensure(__DEC_event_flowElements_671564 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_event_flowElements_671564
													.getFlowElements()
													.contains(event));

											// check isomorphic binding between objects __DEC_event_flowElements_671564 and process 
											JavaSDM.ensure(!__DEC_event_flowElements_671564
													.equals(process));
										...
										try {
											...
											// bind object
											__DEC_outFlow_flowElements_680095 = outFlow
													.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
													.eContainer() : null;

											// check object __DEC_outFlow_flowElements_680095 is really bound
											JavaSDM.ensure(__DEC_outFlow_flowElements_680095 != null);

											// check if contained via correct reference
											JavaSDM.ensure(__DEC_outFlow_flowElements_680095
													.getFlowElements()
													.contains(outFlow));

											// check isomorphic binding between objects __DEC_outFlow_flowElements_680095 and process 
											JavaSDM.ensure(!__DEC_outFlow_flowElements_680095
													.equals(process));
										...
										try {
											...
											// iterate to-many link default from outFlow to __DEC_outFlow_default_730436
											fujaba__Success = false;

											fujaba__IterOutFlowTo__DEC_outFlow_default_730436 = new ArrayList(
													org.moflon.util.eMoflonEMFUtil
															.getOppositeReference(
																	outFlow,
																	ExclusiveGateway.class,
											...
											while (!(fujaba__Success)
													&& fujaba__IterOutFlowTo__DEC_outFlow_default_730436
															.hasNext()) {
												try {
													__DEC_outFlow_default_730436 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_730436
															.next();

													// check object __DEC_outFlow_default_730436 is really bound
													JavaSDM.ensure(__DEC_outFlow_default_730436 != null);
													// check isomorphic binding between objects __DEC_outFlow_default_730436 and flowNode 
													JavaSDM.ensure(!__DEC_outFlow_default_730436
															.equals(flowNode));
										...
										try {
											...
											// iterate to-many link targetRef from event to __DEC_event_targetRef_278134
											fujaba__Success = false;

											fujaba__IterEventTo__DEC_event_targetRef_278134 = new ArrayList(
													event.getIncoming())
													.iterator();

											while (!(fujaba__Success)
													&& fujaba__IterEventTo__DEC_event_targetRef_278134
															.hasNext()) {
												try {
													__DEC_event_targetRef_278134 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_278134
															.next();

													// check object __DEC_event_targetRef_278134 is really bound
													JavaSDM.ensure(__DEC_event_targetRef_278134 != null);
													// check isomorphic binding between objects __DEC_event_targetRef_278134 and inFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_278134
															.equals(inFlow));

													// check isomorphic binding between objects __DEC_event_targetRef_278134 and outFlow 
													JavaSDM.ensure(!__DEC_event_targetRef_278134
															.equals(outFlow));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_12(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_66924 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_170352 = null;
		Step __DEC_normalStep_next_170352 = null;
		Match match = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_66924 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_66924 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_66924 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_66924
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_66924 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_66924
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_170352
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_170352 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_170352
											.hasNext()) {
								try {
									__DEC_normalStep_next_170352 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_170352
											.next();

									// check object __DEC_normalStep_next_170352 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_170352 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_170352 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_170352
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_170352 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_170352
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_13(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Flow __DEC_normalStep_steps_636735 = null;
		Iterator fujaba__IterNormalStepTo__DEC_normalStep_next_390299 = null;
		Step __DEC_normalStep_next_390299 = null;
		Match match = null;
		Iterator fujaba__IterNormalStepToPrevStep = null;
		Step prevStep = null;
		Actor actor = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_normalStep_steps_636735 = normalStep
									.eContainer() instanceof Flow ? (Flow) normalStep
									.eContainer() : null;

							// check object __DEC_normalStep_steps_636735 is really bound
							JavaSDM.ensure(__DEC_normalStep_steps_636735 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_normalStep_steps_636735
									.getSteps().contains(normalStep));

							// check isomorphic binding between objects __DEC_normalStep_steps_636735 and flow 
							JavaSDM.ensure(!__DEC_normalStep_steps_636735
									.equals(flow));
						...
						try {
							...
							// iterate to-many link next from normalStep to __DEC_normalStep_next_390299
							fujaba__Success = false;

							fujaba__IterNormalStepTo__DEC_normalStep_next_390299 = new ArrayList(
									org.moflon.util.eMoflonEMFUtil
											.getOppositeReference(normalStep,
													Step.class, "next"))
									.iterator();
							...
							while (!(fujaba__Success)
									&& fujaba__IterNormalStepTo__DEC_normalStep_next_390299
											.hasNext()) {
								try {
									__DEC_normalStep_next_390299 = (Step) fujaba__IterNormalStepTo__DEC_normalStep_next_390299
											.next();

									// check object __DEC_normalStep_next_390299 is really bound
									JavaSDM.ensure(__DEC_normalStep_next_390299 != null);
									// check isomorphic binding between objects __DEC_normalStep_next_390299 and normalStep 
									JavaSDM.ensure(!__DEC_normalStep_next_390299
											.equals(normalStep));

									// check isomorphic binding between objects __DEC_normalStep_next_390299 and prevStep 
									JavaSDM.ensure(!__DEC_normalStep_next_390299
											.equals(prevStep));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_26(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		FlowElementsContainer __DEC_event_flowElements_707739 = null;
		FlowElementsContainer __DEC_outFlow_flowElements_658231 = null;
		Iterator fujaba__IterOutFlowTo__DEC_outFlow_default_855642 = null;
		ExclusiveGateway __DEC_outFlow_default_855642 = null;
		Iterator fujaba__IterEventTo__DEC_event_targetRef_59390 = null;
		SequenceFlow __DEC_event_targetRef_59390 = null;
		Match match = null;
		FlowNode flowNode = null;
		Iterator fujaba__IterEventToInFlow = null;
		SequenceFlow inFlow = null;
						...
						try {
							...
							try {
								...
								try {
									...
									// bind object
									__DEC_event_flowElements_707739 = event
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) event
											.eContainer() : null;

									// check object __DEC_event_flowElements_707739 is really bound
									JavaSDM.ensure(__DEC_event_flowElements_707739 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_event_flowElements_707739
											.getFlowElements().contains(event));

									// check isomorphic binding between objects __DEC_event_flowElements_707739 and process 
									JavaSDM.ensure(!__DEC_event_flowElements_707739
											.equals(process));
								...
								try {
									...
									// bind object
									__DEC_outFlow_flowElements_658231 = outFlow
											.eContainer() instanceof FlowElementsContainer ? (FlowElementsContainer) outFlow
											.eContainer() : null;

									// check object __DEC_outFlow_flowElements_658231 is really bound
									JavaSDM.ensure(__DEC_outFlow_flowElements_658231 != null);

									// check if contained via correct reference
									JavaSDM.ensure(__DEC_outFlow_flowElements_658231
											.getFlowElements()
											.contains(outFlow));

									// check isomorphic binding between objects __DEC_outFlow_flowElements_658231 and process 
									JavaSDM.ensure(!__DEC_outFlow_flowElements_658231
											.equals(process));
								...
								try {
									...
									// iterate to-many link default from outFlow to __DEC_outFlow_default_855642
									fujaba__Success = false;

									fujaba__IterOutFlowTo__DEC_outFlow_default_855642 = new ArrayList(
											org.moflon.util.eMoflonEMFUtil
													.getOppositeReference(
															outFlow,
															ExclusiveGateway.class,
									...
									while (!(fujaba__Success)
											&& fujaba__IterOutFlowTo__DEC_outFlow_default_855642
													.hasNext()) {
										try {
											__DEC_outFlow_default_855642 = (ExclusiveGateway) fujaba__IterOutFlowTo__DEC_outFlow_default_855642
													.next();

											// check object __DEC_outFlow_default_855642 is really bound
											JavaSDM.ensure(__DEC_outFlow_default_855642 != null);
											// check isomorphic binding between objects __DEC_outFlow_default_855642 and flowNode 
											JavaSDM.ensure(!__DEC_outFlow_default_855642
													.equals(flowNode));
								...
								try {
									...
									// iterate to-many link targetRef from event to __DEC_event_targetRef_59390
									fujaba__Success = false;

									fujaba__IterEventTo__DEC_event_targetRef_59390 = new ArrayList(
											event.getIncoming()).iterator();

									while (!(fujaba__Success)
											&& fujaba__IterEventTo__DEC_event_targetRef_59390
													.hasNext()) {
										try {
											__DEC_event_targetRef_59390 = (SequenceFlow) fujaba__IterEventTo__DEC_event_targetRef_59390
													.next();

											// check object __DEC_event_targetRef_59390 is really bound
											JavaSDM.ensure(__DEC_event_targetRef_59390 != null);
											// check isomorphic binding between objects __DEC_event_targetRef_59390 and inFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_59390
													.equals(inFlow));

											// check isomorphic binding between objects __DEC_event_targetRef_59390 and outFlow 
											JavaSDM.ensure(!__DEC_event_targetRef_59390
													.equals(outFlow));
