...
public class DefinitionsToPackageRuleImpl extends AbstractRuleImpl implements
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			JavaSDM.ensure(_TmpObject instanceof DocumentRootToUseCasesModel);
			documentRootToUseCasesModel = (DocumentRootToUseCasesModel) _TmpObject;
			...
			// create object definitionsToPackageDeclaration
		...
		try {
			...
			// check isomorphic binding between objects documentRoot and definitionsToPackageDeclaration 
			JavaSDM.ensure(!documentRoot
					.equals(definitionsToPackageDeclaration));

			// check isomorphic binding between objects documentRootToUseCasesModel and definitionsToPackageDeclaration 
			...
			// check isomorphic binding between objects useCasesModel and definitionsToPackageDeclaration 
			...
			// assign attribute definitionsToPackageDeclaration__source__definitions
			definitionsToPackageDeclaration__source__definitions
					.setName("source");
			// assign attribute definitionsToPackageDeclaration__target__packageDeclaration
		...
		this.registerObjects_FWD(ruleresult, definitions, packageDeclaration,
				definitionsToPackageDeclaration, documentRoot, useCasesModel,
		...
		try {
			...
			fujaba__IterDocumentRootToDocumentRootToUseCasesModel = new ArrayList(
					org.moflon.util.eMoflonEMFUtil.getOppositeReference(
							documentRoot, DocumentRootToUseCasesModel.class,
							"source")).iterator();

			while (fujaba__IterDocumentRootToDocumentRootToUseCasesModel
					.hasNext()) {
				try {
					documentRootToUseCasesModel = (DocumentRootToUseCasesModel) fujaba__IterDocumentRootToDocumentRootToUseCasesModel
							.next();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult,
			...
			EObject definitionsToPackageDeclaration, EObject documentRoot,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		try {
			...
			fujaba__IterUseCasesModelToDocumentRootToUseCasesModel = new ArrayList(
					org.moflon.util.eMoflonEMFUtil.getOppositeReference(
							useCasesModel, DocumentRootToUseCasesModel.class,
							"target")).iterator();

			while (fujaba__IterUseCasesModelToDocumentRootToUseCasesModel
					.hasNext()) {
				try {
					documentRootToUseCasesModel = (DocumentRootToUseCasesModel) fujaba__IterUseCasesModelToDocumentRootToUseCasesModel
							.next();
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_109(
		...
		DocumentRoot __DEC_definitions_definitions_921013 = null;
		Match match = null;
		Definitions definitions = null;
		DocumentRoot documentRoot = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_definitions_definitions_921013 = definitions
							.eContainer() instanceof DocumentRoot ? (DocumentRoot) definitions
							.eContainer() : null;

					// check object __DEC_definitions_definitions_921013 is really bound
					JavaSDM.ensure(__DEC_definitions_definitions_921013 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_definitions_definitions_921013
							.getDefinitions().contains(definitions));

					// check isomorphic binding between objects __DEC_definitions_definitions_921013 and documentRoot 
					JavaSDM.ensure(!__DEC_definitions_definitions_921013
							.equals(documentRoot));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_46(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		UseCasesModel __DEC_packageDeclaration_packages_225435 = null;
		Match match = null;
		PackageDeclaration packageDeclaration = null;
		UseCasesModel useCasesModel = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_packageDeclaration_packages_225435 = packageDeclaration
							.eContainer() instanceof UseCasesModel ? (UseCasesModel) packageDeclaration
							.eContainer() : null;

					// check object __DEC_packageDeclaration_packages_225435 is really bound
					JavaSDM.ensure(__DEC_packageDeclaration_packages_225435 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_packageDeclaration_packages_225435
							.getPackages().contains(packageDeclaration));

					// check isomorphic binding between objects __DEC_packageDeclaration_packages_225435 and useCasesModel 
					JavaSDM.ensure(!__DEC_packageDeclaration_packages_225435
	...
	public ModelgeneratorRuleResult generateModel(
			...
			DocumentRootToUseCasesModel documentRootToUseCasesModelDummyParameter) {
		boolean fujaba__Success = false;
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.DEFINITIONS_TO_PACKAGE_RULE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_DEFINITIONS_DOCUMENTROOT_USECASESMODEL_DOCUMENTROOTTOUSECASESMODEL:
			return isApplicable_solveCsp_FWD(
					(IsApplicableMatch) arguments.get(0),
					(Definitions) arguments.get(1),
					(DocumentRoot) arguments.get(2),
					(UseCasesModel) arguments.get(3),
					(DocumentRootToUseCasesModel) arguments.get(4));
		...
		case RulesPackage.DEFINITIONS_TO_PACKAGE_RULE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGEDECLARATION_DOCUMENTROOT_USECASESMODEL_DOCUMENTROOTTOUSECASESMODEL:
		...
		case RulesPackage.DEFINITIONS_TO_PACKAGE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_109__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_109((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.DEFINITIONS_TO_PACKAGE_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_46__EMOFLONEDGE:
		...
		case RulesPackage.DEFINITIONS_TO_PACKAGE_RULE___GENERATE_MODEL__RULEENTRYCONTAINER_DOCUMENTROOTTOUSECASESMODEL:
			return generateModel((RuleEntryContainer) arguments.get(0),
					(DocumentRootToUseCasesModel) arguments.get(1));
		case RulesPackage.DEFINITIONS_TO_PACKAGE_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_DEFINITIONS_PACKAGEDECLARATION_DEFINITIONSTOPACKAGEDECLARATION_DOCUMENTROOT_USECASESMODEL_DOCUMENTROOTTOUSECASESMODEL_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD(
					...
					(DocumentRootToUseCasesModel) arguments.get(6),
