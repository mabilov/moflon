...
public class ServiceTaskToStepAfterSERuleImpl extends AbstractRuleImpl
	...
	public boolean isAppropriate_FWD(Match match, StartEvent flowNode,
		...
		// initial bindings
		Object[] result1_black = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_0_1_blackBBBBBBBBB(this,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_0_2_bindingAndBlackFBBBBBBBBB(
		...
		// Check CSP
		if (ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_0_3_expressionFBB(this,
						csp)) {

			// collect elements to be translated
			Object[] result4_black = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_0_4_blackBBBBBBBB(
							match, flowNode, process, task, inFlow, outFlow,
							laneSet, lane);
			...
			ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_0_4_greenBBBBBBFFFFFFF(
			...
			Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_0_5_blackBBBBBBBB(
							match, flowNode, process, task, inFlow, outFlow,
							laneSet, lane);
			...
			ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_0_5_greenBBBBBBFFFFFF(
			...
			ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_0_6_expressionBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane);
			return ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_0_7_expressionF();
		} else {
			return ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_1_bindingAndBlackFFFFFFFFFFFFBB(
		...
		StartEvent flowNode = (StartEvent) result1_bindingAndBlack[0];
		...
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_1_greenBBBFFFFBB(actor,
						task, outFlow, flow, csp);
		...
		Object[] result2_black = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_2_blackBBBBBB(task,
		...
		Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_2_greenFBBBBBB(task,
						outFlow, normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		// bookkeeping for edges
		Object[] result3_black = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_3_blackBBBBBBBBBBBBBBBB(
		...
		ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		// register objects
		ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_5_expressionBBBBBBBBBBBBBBBBB(
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_2_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_2_1_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_2_2_bindingFFFFFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException("Binding in node core match failed."
					+ " Variables: " + "[match] = " + match + ".");
		}
		StartEvent flowNode = (StartEvent) result2_binding[0];
		...
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_2_2_blackBBFFBBBFFBBB(
			...
			for (Object[] result3_black : ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_2_3_blackBBBBBBBBBBB(
							flowNode, process, actor, processToActor, task,
							inFlow, outFlow, inFlowToFlow, flow, laneSet, lane)) {
				Object[] result3_green = ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_2_3_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFF(
								flowNode, process, actor, processToActor, task,
				...
				// solve CSP
				Object[] result4_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_2_4_bindingAndBlackFBBBBBBBBBBBBB(
				...
				// check CSP
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_2_5_expressionFBB(
								this, csp)) {

					// add match to rule result
					Object[] result6_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_2_6_blackBB(
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_2_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_2_7_expressionFB(ruleresult);
	}
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, StartEvent flowNode,
			bpmn2.Process process, ServiceTask task, SequenceFlow inFlow,
			SequenceFlow outFlow, LaneSet laneSet, Lane lane) {// Create CSP
	...
	public boolean isAppropriate_BWD(Match match, Actor actor,
		...
		// initial bindings
		Object[] result1_black = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_10_1_blackBBBBB(this,
		...
		// Solve CSP
		Object[] result2_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_10_2_bindingAndBlackFBBBBB(
		...
		// Check CSP
		if (ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_10_3_expressionFBB(this,
						csp)) {

			// collect elements to be translated
			Object[] result4_black = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_10_4_blackBBBB(match,
			...
			ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_10_4_greenBBBBFF(
							match, actor, normalStep, flow);
			...
			// collect context elements
			Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_10_5_blackBBBB(match,
							actor, normalStep, flow);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching in node [collect context elements] failed."
			...
			ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_10_5_greenBBB(match,
							actor, flow);

			// register objects to match
			ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_10_6_expressionBBBBB(
							this, match, actor, normalStep, flow);
			return ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_10_7_expressionF();
		} else {
			return ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		// perform transformation
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_1_bindingAndBlackFFFFFFFFFFFBB(
						this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [perform transformation] failed."
		...
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_1_greenBFBFBFFFBBB(
		...
		// collect translated elements
		Object[] result2_black = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_2_blackBBBBBB(task,
						outFlow, normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep);
		if (result2_black == null) {
			throw new RuntimeException(
		...
		Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_2_greenFBBBBBB(task,
						outFlow, normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		// bookkeeping for edges
		Object[] result3_black = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_3_blackBBBBBBBBBBBBBBBB(
						ruleresult, flowNode, process, actor, processToActor,
						task, inFlow, outFlow, normalStep, taskToNormalStep,
						outFlowToFlow, outFlowToNormalStep, inFlowToFlow, flow,
						laneSet, lane);
		...
		ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
						ruleresult, process, actor, task, inFlow, outFlow,
						normalStep, taskToNormalStep, outFlowToFlow,
						outFlowToNormalStep, flow, lane);
		// EMoflonEdge process__task____flowElements = (EMoflonEdge) result3_green[12];
		...
		// register objects
		ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_5_expressionBBBBBBBBBBBBBBBBB(
						this, ruleresult, flowNode, process, actor,
						processToActor, task, inFlow, outFlow, normalStep,
						taskToNormalStep, outFlowToFlow, outFlowToNormalStep,
						inFlowToFlow, flow, laneSet, lane);
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_12_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		// EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_12_1_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach core match
		Object[] result2_binding = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_12_2_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException("Binding in node core match failed."
					+ " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_12_2_blackFBFFBFBB(actor,
			...
			// ForEach find context
			for (Object[] result3_black : ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_12_3_blackFBBBBBBBFF(
							process, actor, processToActor, inFlow, normalStep,
							inFlowToFlow, flow)) {
				StartEvent flowNode = (StartEvent) result3_black[0];
				LaneSet laneSet = (LaneSet) result3_black[8];
				Lane lane = (Lane) result3_black[9];
				Object[] result3_green = ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_12_3_greenBBBBBBBBBBFFFFFFFFFFFFF(
				...
				// solve CSP
				Object[] result4_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_12_4_bindingAndBlackFBBBBBBBBBBBB(
								this, isApplicableMatch, flowNode, process,
				...
				// check CSP
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_12_5_expressionFBB(
								this, csp)) {

					// add match to rule result
					Object[] result6_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_12_6_blackBB(
									ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_12_6_greenBB(
									ruleresult, isApplicableMatch);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_12_7_expressionFB(ruleresult);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_368(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_20_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_20_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_20_2_blackFFFFFFFB(_edge_flowElements)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			...
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_20_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_20_3_expressionFBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_20_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_20_5_blackBBB(
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_20_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_20_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_369(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_21_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_21_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_21_2_blackFFFFFFFB(_edge_targetRef)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			bpmn2.Process process = (bpmn2.Process) result2_black[1];
			ServiceTask task = (ServiceTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			Lane lane = (Lane) result2_black[6];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_21_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_21_3_expressionFBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_21_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_21_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_21_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_21_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_370(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_22_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_22_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_22_2_blackFFFFFFFB(_edge_incoming)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			bpmn2.Process process = (bpmn2.Process) result2_black[1];
			ServiceTask task = (ServiceTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			Lane lane = (Lane) result2_black[6];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_22_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_22_3_expressionFBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_22_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_22_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_22_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_22_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_371(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_23_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_23_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_23_2_blackFFFFFFFB(_edge_flowElements)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			bpmn2.Process process = (bpmn2.Process) result2_black[1];
			ServiceTask task = (ServiceTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			Lane lane = (Lane) result2_black[6];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_23_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_23_3_expressionFBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_23_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_23_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_23_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_23_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_372(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_24_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_24_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_24_2_blackFFFFFFFB(_edge_sourceRef)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			bpmn2.Process process = (bpmn2.Process) result2_black[1];
			ServiceTask task = (ServiceTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			Lane lane = (Lane) result2_black[6];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_24_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_24_3_expressionFBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_24_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_24_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_24_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_24_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_373(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_25_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_25_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_25_2_blackFFFFFFFB(_edge_outgoing)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			bpmn2.Process process = (bpmn2.Process) result2_black[1];
			ServiceTask task = (ServiceTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			Lane lane = (Lane) result2_black[6];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_25_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_25_3_expressionFBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_25_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_25_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_25_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_25_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_853(
			EMoflonEdge _edge_actor) {
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_26_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_26_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_26_2_blackFFFB(_edge_actor)) {
			Actor actor = (Actor) result2_black[0];
			NormalStep normalStep = (NormalStep) result2_black[1];
			Flow flow = (Flow) result2_black[2];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_26_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_26_3_expressionFBBBBB(
							this, match, actor, normalStep, flow)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_26_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_26_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_26_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_26_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_854(
			EMoflonEdge _edge_steps) {
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_27_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_27_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_27_2_blackFFFB(_edge_steps)) {
			Actor actor = (Actor) result2_black[0];
			NormalStep normalStep = (NormalStep) result2_black[1];
			Flow flow = (Flow) result2_black[2];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_27_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_27_3_expressionFBBBBB(
							this, match, actor, normalStep, flow)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_27_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_27_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_27_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_27_6_expressionFB(__result);
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_374(
		...
		// prepare return value
		Object[] result1_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_28_1_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching in node [prepare return value] failed."
							+ " Variables: " + "[this] = " + this + ".");
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_28_1_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach test core match and DECs
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_28_2_blackFFFFFFFB(_edge_flowNodeRefs)) {
			StartEvent flowNode = (StartEvent) result2_black[0];
			bpmn2.Process process = (bpmn2.Process) result2_black[1];
			ServiceTask task = (ServiceTask) result2_black[2];
			SequenceFlow inFlow = (SequenceFlow) result2_black[3];
			...
			Lane lane = (Lane) result2_black[6];
			Object[] result2_green = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_28_2_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// bookkeeping with generic isAppropriate method
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_28_3_expressionFBBBBBBBBB(
							this, match, flowNode, process, task, inFlow,
							outFlow, laneSet, lane)) {
				// Ensure that the correct types of elements are matched
				if (ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_28_4_expressionFBB(
								this, match)) {

					// Add match to rule result
					Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_28_5_blackBBB(
									match, __performOperation, __result);
					if (result5_black == null) {
						throw new RuntimeException(
								"Pattern matching in node [Add match to rule result] failed."
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_28_5_greenBBB(
									match, __performOperation, __result);
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_28_6_expressionFB(__result);
	}
	...
	public ModelgeneratorRuleResult generateModel(
		...
		// create result
		Object[] result1_black = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_31_1_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		Object[] result1_green = ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_31_1_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach is applicable core
		for (Object[] result2_black : ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_31_2_blackFFFFFFFFFFBB(
			...
			// solve CSP
			Object[] result3_bindingAndBlack = ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_31_3_bindingAndBlackFBBBBBBBBBBBB(
			...
			// check CSP
			if (ServiceTaskToStepAfterSERuleImpl
					.pattern_ServiceTaskToStepAfterSERule_31_4_expressionFBB(
							this, csp)) {
				// check nacs
				Object[] result5_black = ServiceTaskToStepAfterSERuleImpl
						.pattern_ServiceTaskToStepAfterSERule_31_5_blackBBBBBBBBB(
								flowNode, process, actor, processToActor,
				...
				if (result5_black != null) {
					...
					// perform
					Object[] result6_black = ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_31_6_blackBBBBBBBBBB(
									flowNode, process, actor, processToActor,
									inFlow, inFlowToFlow, flow, laneSet, lane,
									ruleResult);
					if (result6_black == null) {
					...
					ServiceTaskToStepAfterSERuleImpl
							.pattern_ServiceTaskToStepAfterSERule_31_6_greenBBFBFFFFFBBBB(
		...
		return ServiceTaskToStepAfterSERuleImpl
				.pattern_ServiceTaskToStepAfterSERule_31_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_368__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_368((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_369__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_369((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_370__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_370((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_371__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_371((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_372__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_372((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_373__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_373((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_853__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_853((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_854__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_854((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_374__EMOFLONEDGE:
		...
		case RulesPackage.SERVICE_TASK_TO_STEP_AFTER_SE_RULE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_STARTEVENT_PROCESS_ACTOR_PROCESSTOACTOR_SEQUENCEFLOW_SEQUENCEFLOWTOUCFLOW_FLOW_LANESET_LANE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_1_blackBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_2_bindingFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_2_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_2_bindingAndBlackFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_0_2_binding = pattern_ServiceTaskToStepAfterSERule_0_2_bindingFBBBBBBBBB(
				_this, match, flowNode, process, task, inFlow, outFlow,
				laneSet, lane);
		if (result_pattern_ServiceTaskToStepAfterSERule_0_2_binding != null) {
			CSP csp = (CSP) result_pattern_ServiceTaskToStepAfterSERule_0_2_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_0_2_black = pattern_ServiceTaskToStepAfterSERule_0_2_blackB(csp);
			if (result_pattern_ServiceTaskToStepAfterSERule_0_2_black != null) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_0_3_expressionFBB(
			ServiceTaskToStepAfterSERule _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_4_blackBBBBBBBB(
			Match match, StartEvent flowNode, bpmn2.Process process,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_4_greenBBBBBBFFFFFFF(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_5_blackBBBBBBBB(
			Match match, StartEvent flowNode, bpmn2.Process process,
			ServiceTask task, SequenceFlow inFlow, SequenceFlow outFlow,
			LaneSet laneSet, Lane lane) {
		if (!inFlow.equals(outFlow)) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_0_5_greenBBBBBBFFFFFF(
			Match match, StartEvent flowNode, bpmn2.Process process,
	...
	public static final void pattern_ServiceTaskToStepAfterSERule_0_6_expressionBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ServiceTaskToStepAfterSERule_0_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_1_bindingFFFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_1_blackBBBBBBBBBBBFBB(
			StartEvent flowNode, bpmn2.Process process, Actor actor,
			ProcessToActor processToActor, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
			Lane lane, ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch) {
		if (!inFlow.equals(outFlow)) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_1_bindingAndBlackFFFFFFFFFFFFBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_1_1_binding = pattern_ServiceTaskToStepAfterSERule_1_1_bindingFFFFFFFFFFFB(isApplicableMatch);
		if (result_pattern_ServiceTaskToStepAfterSERule_1_1_binding != null) {
			StartEvent flowNode = (StartEvent) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[0];
			bpmn2.Process process = (bpmn2.Process) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[1];
			Actor actor = (Actor) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[2];
			ProcessToActor processToActor = (ProcessToActor) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[3];
			ServiceTask task = (ServiceTask) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[4];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[5];
			SequenceFlow outFlow = (SequenceFlow) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[6];
			SequenceFlowToUCFlow inFlowToFlow = (SequenceFlowToUCFlow) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[7];
			Flow flow = (Flow) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[8];
			LaneSet laneSet = (LaneSet) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[9];
			Lane lane = (Lane) result_pattern_ServiceTaskToStepAfterSERule_1_1_binding[10];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_1_1_black = pattern_ServiceTaskToStepAfterSERule_1_1_blackBBBBBBBBBBBFBB(
					flowNode, process, actor, processToActor, task, inFlow,
					outFlow, inFlowToFlow, flow, laneSet, lane, _this,
					isApplicableMatch);
			if (result_pattern_ServiceTaskToStepAfterSERule_1_1_black != null) {
				CSP csp = (CSP) result_pattern_ServiceTaskToStepAfterSERule_1_1_black[11];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_1_greenBBBFFFFBB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_2_blackBBBBBB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_2_greenFBBBBBB(
			ServiceTask task, SequenceFlow outFlow, NormalStep normalStep,
			FlowNodeToStep taskToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow,
			SequenceFlowToStep outFlowToNormalStep) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_3_blackBBBBBBBBBBBBBBBB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_1_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		EMoflonEdge lane__task____flowNodeRefs = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		String ruleresult_ruleName_prime = "ServiceTaskToStepAfterSERule";
		String process__task____flowElements_name_prime = "flowElements";
		String inFlow__task____targetRef_name_prime = "targetRef";
		String task__inFlow____incoming_name_prime = "incoming";
		String process__outFlow____flowElements_name_prime = "flowElements";
	...
	public static final void pattern_ServiceTaskToStepAfterSERule_1_5_expressionBBBBBBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, PerformRuleResult ruleresult,
			EObject flowNode, EObject process, EObject actor,
			EObject processToActor, EObject task, EObject inFlow,
			EObject outFlow, EObject normalStep, EObject taskToNormalStep,
			EObject outFlowToFlow, EObject outFlowToNormalStep,
	...
	public static final PerformRuleResult pattern_ServiceTaskToStepAfterSERule_1_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_1_blackFBB(
			EClass eClass, ServiceTaskToStepAfterSERule _this) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_2_1_binding = pattern_ServiceTaskToStepAfterSERule_2_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_2_1_binding != null) {
			EClass eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_2_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_2_1_black = pattern_ServiceTaskToStepAfterSERule_2_1_blackFBB(
					eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_2_1_black != null) {
				EOperation performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_2_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
		String ruleresult_rule_prime = "ServiceTaskToStepAfterSERule";
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_2_bindingFFFFFFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_2_2_blackBBFFBBBFFBBB(
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_2_3_blackBBBBBBBBBBB(
			StartEvent flowNode, bpmn2.Process process, Actor actor,
			ProcessToActor processToActor, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_3_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFF(
			StartEvent flowNode, bpmn2.Process process, Actor actor,
			ProcessToActor processToActor, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_4_bindingFBBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_4_bindingAndBlackFBBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			bpmn2.Process process, Actor actor, ProcessToActor processToActor,
			ServiceTask task, SequenceFlow inFlow, SequenceFlow outFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
			Lane lane) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_2_4_binding = pattern_ServiceTaskToStepAfterSERule_2_4_bindingFBBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, process, actor,
				processToActor, task, inFlow, outFlow, inFlowToFlow, flow,
				laneSet, lane);
		if (result_pattern_ServiceTaskToStepAfterSERule_2_4_binding != null) {
			CSP csp = (CSP) result_pattern_ServiceTaskToStepAfterSERule_2_4_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_2_4_black = pattern_ServiceTaskToStepAfterSERule_2_4_blackB(csp);
			if (result_pattern_ServiceTaskToStepAfterSERule_2_4_black != null) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_2_5_expressionFBB(
			ServiceTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_2_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "ServiceTaskToStepAfterSERule";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_ServiceTaskToStepAfterSERule_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_1_blackBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
		return new Object[] { _this, match, actor, normalStep, flow };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_2_bindingFBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_2_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_2_bindingAndBlackFBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_10_2_binding = pattern_ServiceTaskToStepAfterSERule_10_2_bindingFBBBBB(
				_this, match, actor, normalStep, flow);
		if (result_pattern_ServiceTaskToStepAfterSERule_10_2_binding != null) {
			CSP csp = (CSP) result_pattern_ServiceTaskToStepAfterSERule_10_2_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_10_2_black = pattern_ServiceTaskToStepAfterSERule_10_2_blackB(csp);
			if (result_pattern_ServiceTaskToStepAfterSERule_10_2_black != null) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_10_3_expressionFBB(
			ServiceTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_4_blackBBBB(
			Match match, Actor actor, NormalStep normalStep, Flow flow) {
		return new Object[] { match, actor, normalStep, flow };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_4_greenBBBBFF(
			Match match, Actor actor, NormalStep normalStep, Flow flow) {
		EMoflonEdge normalStep__actor____actor = TGGRuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge flow__normalStep____steps = TGGRuntimeFactory.eINSTANCE
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_5_blackBBBB(
			Match match, Actor actor, NormalStep normalStep, Flow flow) {
		return new Object[] { match, actor, normalStep, flow };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_10_5_greenBBB(
	...
	public static final void pattern_ServiceTaskToStepAfterSERule_10_6_expressionBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ServiceTaskToStepAfterSERule_10_8_expressionF() {
		boolean _result = false;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_1_bindingFFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("flowNode");
		EObject _localVariable_1 = isApplicableMatch.getObject("process");
		EObject _localVariable_2 = isApplicableMatch.getObject("actor");
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_1_blackBBBBBBBBBBFBB(
			StartEvent flowNode, bpmn2.Process process, Actor actor,
			ProcessToActor processToActor, SequenceFlow inFlow,
			NormalStep normalStep, SequenceFlowToUCFlow inFlowToFlow,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_1_bindingAndBlackFFFFFFFFFFFBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_11_1_binding = pattern_ServiceTaskToStepAfterSERule_11_1_bindingFFFFFFFFFFB(isApplicableMatch);
		if (result_pattern_ServiceTaskToStepAfterSERule_11_1_binding != null) {
			StartEvent flowNode = (StartEvent) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[0];
			bpmn2.Process process = (bpmn2.Process) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[1];
			Actor actor = (Actor) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[2];
			ProcessToActor processToActor = (ProcessToActor) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[3];
			SequenceFlow inFlow = (SequenceFlow) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[4];
			NormalStep normalStep = (NormalStep) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[5];
			SequenceFlowToUCFlow inFlowToFlow = (SequenceFlowToUCFlow) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[6];
			Flow flow = (Flow) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[7];
			LaneSet laneSet = (LaneSet) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[8];
			Lane lane = (Lane) result_pattern_ServiceTaskToStepAfterSERule_11_1_binding[9];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_11_1_black = pattern_ServiceTaskToStepAfterSERule_11_1_blackBBBBBBBBBBFBB(
					flowNode, process, actor, processToActor, inFlow,
					normalStep, inFlowToFlow, flow, laneSet, lane, _this,
					isApplicableMatch);
			if (result_pattern_ServiceTaskToStepAfterSERule_11_1_black != null) {
				CSP csp = (CSP) result_pattern_ServiceTaskToStepAfterSERule_11_1_black[10];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_1_greenBFBFBFFFBBB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_2_blackBBBBBB(
			ServiceTask task, SequenceFlow outFlow, NormalStep normalStep,
			FlowNodeToStep taskToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow,
			SequenceFlowToStep outFlowToNormalStep) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_2_greenFBBBBBB(
			ServiceTask task, SequenceFlow outFlow, NormalStep normalStep,
			FlowNodeToStep taskToNormalStep,
			SequenceFlowToUCFlow outFlowToFlow,
			SequenceFlowToStep outFlowToNormalStep) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_3_blackBBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject flowNode, EObject process,
			EObject actor, EObject processToActor, EObject task,
			EObject inFlow, EObject outFlow, EObject normalStep,
			EObject taskToNormalStep, EObject outFlowToFlow,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_11_3_greenBBBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject process, EObject actor,
			EObject task, EObject inFlow, EObject outFlow, EObject normalStep,
			EObject taskToNormalStep, EObject outFlowToFlow,
			EObject outFlowToNormalStep, EObject flow, EObject lane) {
	...
	public static final void pattern_ServiceTaskToStepAfterSERule_11_5_expressionBBBBBBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, PerformRuleResult ruleresult,
			EObject flowNode, EObject process, EObject actor,
			EObject processToActor, EObject task, EObject inFlow,
			EObject outFlow, EObject normalStep, EObject taskToNormalStep,
	...
	public static final PerformRuleResult pattern_ServiceTaskToStepAfterSERule_11_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_1_blackFBB(
			EClass eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperationname = performOperation.getName();
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_12_1_binding = pattern_ServiceTaskToStepAfterSERule_12_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_12_1_binding != null) {
			EClass eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_12_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_12_1_black = pattern_ServiceTaskToStepAfterSERule_12_1_blackFBB(
					eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_12_1_black != null) {
				EOperation performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_12_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_1_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = false;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_2_bindingFFFB(
			Match match) {
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_12_2_blackFBFFBFBB(
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_12_3_blackFBBBBBBBFF(
			bpmn2.Process process, Actor actor, ProcessToActor processToActor,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_3_greenBBBBBBBBBBFFFFFFFFFFFFF(
			StartEvent flowNode, bpmn2.Process process, Actor actor,
			ProcessToActor processToActor, SequenceFlow inFlow,
			NormalStep normalStep, SequenceFlowToUCFlow inFlowToFlow,
			Flow flow, LaneSet laneSet, Lane lane) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_4_bindingFBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			bpmn2.Process process, Actor actor, ProcessToActor processToActor,
			SequenceFlow inFlow, NormalStep normalStep,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_4_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_4_bindingAndBlackFBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			bpmn2.Process process, Actor actor, ProcessToActor processToActor,
			SequenceFlow inFlow, NormalStep normalStep,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
			Lane lane) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_12_4_binding = pattern_ServiceTaskToStepAfterSERule_12_4_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, process, actor,
				processToActor, inFlow, normalStep, inFlowToFlow, flow,
				laneSet, lane);
		if (result_pattern_ServiceTaskToStepAfterSERule_12_4_binding != null) {
			CSP csp = (CSP) result_pattern_ServiceTaskToStepAfterSERule_12_4_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_12_4_black = pattern_ServiceTaskToStepAfterSERule_12_4_blackB(csp);
			if (result_pattern_ServiceTaskToStepAfterSERule_12_4_black != null) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_12_5_expressionFBB(
			ServiceTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_6_blackBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_12_6_greenBB(
			IsApplicableRuleResult ruleresult,
			IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
	...
	public static final IsApplicableRuleResult pattern_ServiceTaskToStepAfterSERule_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_20_1_binding = pattern_ServiceTaskToStepAfterSERule_20_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_20_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_20_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_20_1_black = pattern_ServiceTaskToStepAfterSERule_20_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_20_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_20_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_640354 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_2_black_nac_1BB(
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_20_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
												...
												for (FlowElement tmpOutFlow : process
													...
													if (tmpOutFlow instanceof SequenceFlow) {
														...
														if (!inFlow
															...
															if (task.equals(outFlow
																	.getSourceRef())) {
																if (pattern_ServiceTaskToStepAfterSERule_20_2_black_nac_0B(outFlow) == null) {
																	if (pattern_ServiceTaskToStepAfterSERule_20_2_black_nac_1BB(
																			outFlow,
																			task) == null) {
																		for (Lane lane : laneSet
																				.getLanes()) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_2_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_20_3_expressionFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_20_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_20_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_20_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_21_1_binding = pattern_ServiceTaskToStepAfterSERule_21_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_21_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_21_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_21_1_black = pattern_ServiceTaskToStepAfterSERule_21_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_21_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_21_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_388686 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_2_black_nac_1BB(
			SequenceFlow outFlow, ServiceTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_21_2_blackFFFFFFFB(
			EMoflonEdge _edge_targetRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (task.equals(inFlow.getTargetRef())) {
					...
					if (tmpFlowNode instanceof StartEvent) {
						...
						for (SequenceFlow outFlow : task.getOutgoing()) {
							if (!inFlow.equals(outFlow)) {
								if (pattern_ServiceTaskToStepAfterSERule_21_2_black_nac_0B(outFlow) == null) {
									if (pattern_ServiceTaskToStepAfterSERule_21_2_black_nac_1BB(
											outFlow, task) == null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_21_3_expressionFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_21_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_21_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_21_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_22_1_binding = pattern_ServiceTaskToStepAfterSERule_22_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_22_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_22_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_22_1_black = pattern_ServiceTaskToStepAfterSERule_22_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_22_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_22_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_970380 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_2_black_nac_1BB(
			SequenceFlow outFlow, ServiceTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_22_2_blackFFFFFFFB(
			EMoflonEdge _edge_incoming) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
			...
			if (tmpInFlow instanceof SequenceFlow) {
				...
				if (task.equals(inFlow.getTargetRef())) {
					...
					if (tmpFlowNode instanceof StartEvent) {
						...
						for (SequenceFlow outFlow : task.getOutgoing()) {
							if (!inFlow.equals(outFlow)) {
								if (pattern_ServiceTaskToStepAfterSERule_22_2_black_nac_0B(outFlow) == null) {
									if (pattern_ServiceTaskToStepAfterSERule_22_2_black_nac_1BB(
											outFlow, task) == null) {
										for (FlowElementsContainer tmpProcess : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(
														task,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_22_3_expressionFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_22_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_22_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_22_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_23_1_binding = pattern_ServiceTaskToStepAfterSERule_23_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_23_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_23_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_23_1_black = pattern_ServiceTaskToStepAfterSERule_23_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_23_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_23_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_160419 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_2_black_nac_1BB(
			SequenceFlow outFlow, ServiceTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_23_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowElements) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpProcess = _edge_flowElements.getSrc();
		if (tmpProcess instanceof bpmn2.Process) {
			...
			if (tmpOutFlow instanceof SequenceFlow) {
				...
				if (process.getFlowElements().contains(outFlow)) {
					...
					if (tmpTask instanceof ServiceTask) {
						ServiceTask task = (ServiceTask) tmpTask;
						if (process.getFlowElements().contains(task)) {
							if (pattern_ServiceTaskToStepAfterSERule_23_2_black_nac_0B(outFlow) == null) {
								if (pattern_ServiceTaskToStepAfterSERule_23_2_black_nac_1BB(
										outFlow, task) == null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_23_3_expressionFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_23_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_23_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_23_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_24_1_binding = pattern_ServiceTaskToStepAfterSERule_24_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_24_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_24_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_24_1_black = pattern_ServiceTaskToStepAfterSERule_24_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_24_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_24_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_852307 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_2_black_nac_1BB(
			SequenceFlow outFlow, ServiceTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_24_2_blackFFFFFFFB(
			EMoflonEdge _edge_sourceRef) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpOutFlow instanceof SequenceFlow) {
			...
			if (tmpTask instanceof ServiceTask) {
				...
				if (task.equals(outFlow.getSourceRef())) {
					if (pattern_ServiceTaskToStepAfterSERule_24_2_black_nac_0B(outFlow) == null) {
						if (pattern_ServiceTaskToStepAfterSERule_24_2_black_nac_1BB(
								outFlow, task) == null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_24_3_expressionFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_24_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_24_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_24_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_25_1_binding = pattern_ServiceTaskToStepAfterSERule_25_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_25_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_25_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_25_1_black = pattern_ServiceTaskToStepAfterSERule_25_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_25_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_25_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_431907 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_2_black_nac_1BB(
			SequenceFlow outFlow, ServiceTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_25_2_blackFFFFFFFB(
			EMoflonEdge _edge_outgoing) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		...
		if (tmpTask instanceof ServiceTask) {
			...
			if (tmpOutFlow instanceof SequenceFlow) {
				SequenceFlow outFlow = (SequenceFlow) tmpOutFlow;
				if (task.equals(outFlow.getSourceRef())) {
					if (pattern_ServiceTaskToStepAfterSERule_25_2_black_nac_0B(outFlow) == null) {
						if (pattern_ServiceTaskToStepAfterSERule_25_2_black_nac_1BB(
								outFlow, task) == null) {
							for (SequenceFlow inFlow : task.getIncoming()) {
								if (!inFlow.equals(outFlow)) {
									FlowNode tmpFlowNode = inFlow
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_25_3_expressionFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_25_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_25_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_25_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_26_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_26_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_26_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_26_1_binding = pattern_ServiceTaskToStepAfterSERule_26_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_26_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_26_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_26_1_black = pattern_ServiceTaskToStepAfterSERule_26_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_26_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_26_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_26_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_26_2_blackFFFB(
			EMoflonEdge _edge_actor) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_26_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_26_3_expressionFBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_26_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_26_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_26_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_26_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_27_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_27_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_BWD")) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_27_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_27_1_binding = pattern_ServiceTaskToStepAfterSERule_27_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_27_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_27_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_27_1_black = pattern_ServiceTaskToStepAfterSERule_27_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_27_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_27_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_27_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_27_2_blackFFFB(
			EMoflonEdge _edge_steps) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_27_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_27_3_expressionFBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match, Actor actor,
			NormalStep normalStep, Flow flow) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, actor,
				normalStep, flow);
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_27_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_27_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_27_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_27_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_1_bindingFB(
			ServiceTaskToStepAfterSERule _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_1_blackFBB(
			EClass __eClass, ServiceTaskToStepAfterSERule _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperationname = __performOperation.getName();
			if (__performOperationname.equals("isApplicable_FWD")) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_1_bindingAndBlackFFB(
			ServiceTaskToStepAfterSERule _this) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_28_1_binding = pattern_ServiceTaskToStepAfterSERule_28_1_bindingFB(_this);
		if (result_pattern_ServiceTaskToStepAfterSERule_28_1_binding != null) {
			EClass __eClass = (EClass) result_pattern_ServiceTaskToStepAfterSERule_28_1_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_28_1_black = pattern_ServiceTaskToStepAfterSERule_28_1_blackFBB(
					__eClass, _this);
			if (result_pattern_ServiceTaskToStepAfterSERule_28_1_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ServiceTaskToStepAfterSERule_28_1_black[0];
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_1_greenF() {
		EObjectContainer __result = TGGRuntimeFactory.eINSTANCE
				.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_2_black_nac_0B(
			SequenceFlow outFlow) {
		for (ExclusiveGateway __DEC_outFlow_default_486503 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(outFlow, ExclusiveGateway.class,
						"default")) {
			return new Object[] { outFlow };
		}
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_2_black_nac_1BB(
			SequenceFlow outFlow, ServiceTask task) {
		if (task.equals(outFlow.getTargetRef())) {
			return new Object[] { outFlow, task };
		}
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_28_2_blackFFFFFFFB(
			EMoflonEdge _edge_flowNodeRefs) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (lane.getFlowNodeRefs().contains(task)) {
					for (SequenceFlow inFlow : task.getIncoming()) {
						...
						if (tmpFlowNode instanceof StartEvent) {
							...
							for (SequenceFlow outFlow : task.getOutgoing()) {
								if (!inFlow.equals(outFlow)) {
									if (pattern_ServiceTaskToStepAfterSERule_28_2_black_nac_0B(outFlow) == null) {
										if (pattern_ServiceTaskToStepAfterSERule_28_2_black_nac_1BB(
												outFlow, task) == null) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_2_greenFB(
			EClass __eClass) {
		Match match = TGGRuntimeFactory.eINSTANCE.createMatch();
		String __eClassname = __eClass.getName();
		String match_ruleName_prime = __eClassname;
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_28_3_expressionFBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this, Match match,
			StartEvent flowNode, bpmn2.Process process, ServiceTask task,
			SequenceFlow inFlow, SequenceFlow outFlow, LaneSet laneSet,
			Lane lane) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_28_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_FWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_5_blackBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		return new Object[] { match, __performOperation, __result };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_28_5_greenBBB(
			Match match, EOperation __performOperation,
			EObjectContainer __result) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
	...
	public static final EObjectContainer pattern_ServiceTaskToStepAfterSERule_28_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_1_blackB(
			ServiceTaskToStepAfterSERule _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_1_greenFF() {
		IsApplicableMatch isApplicableMatch = TGGRuntimeFactory.eINSTANCE
				.createIsApplicableMatch();
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_0BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_1BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_2BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_3BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_4BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_5BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_6BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_7BB(
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_8BB(
	...
	public static final Iterable<Object[]> pattern_ServiceTaskToStepAfterSERule_31_2_blackFFFFFFFFFFBB(
			RuleEntryContainer ruleEntryContainer,
			ModelgeneratorRuleResult ruleResult) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (tmpInFlowToFlow instanceof SequenceFlowToUCFlow) {
					...
					if (inFlow != null) {
						...
						if (flow != null) {
							...
							if (tmpFlowNode instanceof StartEvent) {
								StartEvent flowNode = (StartEvent) tmpFlowNode;
								if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_5BB(
										ruleResult, inFlowToFlow) == null) {
									if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_4BB(
											ruleResult, inFlow) == null) {
										if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_6BB(
												ruleResult, flow) == null) {
											if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_0BB(
												...
												for (FlowElementsContainer tmpProcess : org.moflon.core.utilities.eMoflonEMFUtil
													...
													if (tmpProcess instanceof bpmn2.Process) {
														...
														if (process
																...
																.contains(
																		flowNode)) {
															if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_1BB(
																	ruleResult,
																	process) == null) {
																for (LaneSet laneSet : process
																		.getLaneSets()) {
																	if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_2BB(
																			ruleResult,
																			laneSet) == null) {
																		for (Lane lane : laneSet
																				.getLanes()) {
																			if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_3BB(
																					ruleResult,
																					lane) == null) {
																				for (ProcessToActor processToActor : org.moflon.core.utilities.eMoflonEMFUtil
																						.getOppositeReferenceTyped(
																					...
																					Actor actor = processToActor
																							.getTarget();
																					if (actor != null) {
																						if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_7BB(
																								ruleResult,
																								processToActor) == null) {
																							if (pattern_ServiceTaskToStepAfterSERule_31_2_black_nac_8BB(
																									ruleResult,
																									actor) == null) {
																								_result.add(new Object[] {
																										inFlowToFlowList,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_3_bindingFBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			bpmn2.Process process, Actor actor, ProcessToActor processToActor,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_3_blackB(
			CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_3_bindingAndBlackFBBBBBBBBBBBB(
			ServiceTaskToStepAfterSERule _this,
			IsApplicableMatch isApplicableMatch, StartEvent flowNode,
			bpmn2.Process process, Actor actor, ProcessToActor processToActor,
			SequenceFlow inFlow, SequenceFlowToUCFlow inFlowToFlow, Flow flow,
			LaneSet laneSet, Lane lane, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_ServiceTaskToStepAfterSERule_31_3_binding = pattern_ServiceTaskToStepAfterSERule_31_3_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, flowNode, process, actor,
				processToActor, inFlow, inFlowToFlow, flow, laneSet, lane,
				ruleResult);
		if (result_pattern_ServiceTaskToStepAfterSERule_31_3_binding != null) {
			CSP csp = (CSP) result_pattern_ServiceTaskToStepAfterSERule_31_3_binding[0];

			Object[] result_pattern_ServiceTaskToStepAfterSERule_31_3_black = pattern_ServiceTaskToStepAfterSERule_31_3_blackB(csp);
			if (result_pattern_ServiceTaskToStepAfterSERule_31_3_black != null) {
	...
	public static final boolean pattern_ServiceTaskToStepAfterSERule_31_4_expressionFBB(
			ServiceTaskToStepAfterSERule _this, CSP csp) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_5_blackBBBBBBBBB(
			StartEvent flowNode, bpmn2.Process process, Actor actor,
			ProcessToActor processToActor, SequenceFlow inFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
			Lane lane) {
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_6_blackBBBBBBBBBB(
			StartEvent flowNode, bpmn2.Process process, Actor actor,
			ProcessToActor processToActor, SequenceFlow inFlow,
			SequenceFlowToUCFlow inFlowToFlow, Flow flow, LaneSet laneSet,
	...
	public static final Object[] pattern_ServiceTaskToStepAfterSERule_31_6_greenBBFBFFFFFBBBB(
	...
	public static final ModelgeneratorRuleResult pattern_ServiceTaskToStepAfterSERule_31_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
