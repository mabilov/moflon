...
public class UseCaseCodeAdapterModelGenScalabilityTest extends DebugSynchronizationHelper {

	public UseCaseCodeAdapterModelGenScalabilityTest() throws IOException {
		// Register packages
	...
	public static void main(String[] args) throws IOException
	{
		...
		UseCaseCodeAdapterModelGenScalabilityTest test = new UseCaseCodeAdapterModelGenScalabilityTest();
      	test.initWriter();
		...
		for (int duration : durations)
		{
			...
			ModelGenerator gen = new ModelGenerator(UseCaseCodeAdapterPackage.eINSTANCE, controller, false, false);
