...
public class UseCaseCodeAdapterTrafoScalabilityTest extends DebugSynchronizationHelper {

	public UseCaseCodeAdapterTrafoScalabilityTest() throws IOException {
		// Register packages
   ...
   private static long runTrafoOnGeneratedModel(int modelElementCount, DomainType domainType) throws IOException
   {
      ...
      ModelGenerator gen = new ModelGenerator(UseCaseCodeAdapterPackage.eINSTANCE, controller, false, true);
   ...
   private static PrintWriter createWriter(int modelElementCount, DomainType domainType) throws IOException
   {
      ...
      file.mkdirs();
      String fileName = folderName + "/UseCaseCodeAdapter_" + modelElementCount + "_" + fwdBwd + ".txt";
