...
public class UseCaseToModalSequenceDiagramIntegrationTrafoScalabilityTest extends DebugSynchronizationHelper{

   public UseCaseToModalSequenceDiagramIntegrationTrafoScalabilityTest()
   {
   ...
   {
      UseCaseToModalSequenceDiagramIntegrationTrafoScalabilityTest helper = new UseCaseToModalSequenceDiagramIntegrationTrafoScalabilityTest();
      ...
      ModelGenerator gen = new ModelGenerator(UseCaseToModalSequenceDiagramIntegrationPackage.eINSTANCE, controller, false, true);
   ...
   private static PrintWriter createWriter(int modelElementCount, DomainType domainType) throws IOException
   {
      ...
      file.mkdirs();
      String fileName = folderName + "/UseCaseToModalSequenceDiagramIntegration_" + modelElementCount + "_" + fwdBwd + ".txt";
