...
public class UseCaseToModalSequenceDiagramIntegrationModelGenScalabilityTest extends DebugSynchronizationHelper {

	public UseCaseToModalSequenceDiagramIntegrationModelGenScalabilityTest() throws IOException {
		// Register packages
	...
	public static void main(String[] args) throws IOException
	{
		...
		UseCaseToModalSequenceDiagramIntegrationModelGenScalabilityTest test = new UseCaseToModalSequenceDiagramIntegrationModelGenScalabilityTest();
      	test.initWriter();
		...
		for (int duration : durations)
		{
			...
			ModelGenerator gen = new ModelGenerator(UseCaseToModalSequenceDiagramIntegrationPackage.eINSTANCE, controller, false, false);
