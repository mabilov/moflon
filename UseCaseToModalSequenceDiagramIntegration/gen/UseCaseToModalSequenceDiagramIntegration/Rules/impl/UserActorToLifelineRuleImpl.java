...
public class UserActorToLifelineRuleImpl extends AbstractRuleImpl implements
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			ruleresult.setRuleName("UserActorToLifelineRule");
			// assign attribute __packageDeclaration_actors_actor
			__packageDeclaration_actors_actor.setName("actors");
		...
		this.registerObjects_FWD(ruleresult, actor, packageDeclaration, p,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRule("UserActorToLifelineRule");
							...
							try {
								...
								if (fujaba__Success) {
									...
									try {
										...
										isApplicableMatch
												.setRuleName("UserActorToLifelineRule");
										// assign attribute ruleresult
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// No post processing method found
		// statement node 'register objects'
		this.registerObjects_BWD(ruleresult, actor, packageDeclaration, p,
				packageDeclarationToP, line, actorToLine, interaction);
		return ruleresult;
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_77(
		...
		PackageDeclaration __DEC_actor_actors_135991 = null;
		Match match = null;
		Actor actor = null;
		PackageDeclaration packageDeclaration = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_actor_actors_135991 = actor.eContainer() instanceof PackageDeclaration ? (PackageDeclaration) actor
							.eContainer() : null;

					// check object __DEC_actor_actors_135991 is really bound
					JavaSDM.ensure(__DEC_actor_actors_135991 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_actor_actors_135991.getActors()
							.contains(actor));

					// check isomorphic binding between objects __DEC_actor_actors_135991 and packageDeclaration 
					JavaSDM.ensure(!__DEC_actor_actors_135991
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.USER_ACTOR_TO_LIFELINE_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_77__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_77((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_ACTOR_TO_LIFELINE_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_324__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_324((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USER_ACTOR_TO_LIFELINE_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_325__EMOFLONEDGE:
