...
public class UseCaseNoPrecondRuleImpl extends AbstractRuleImpl implements
	...
	public boolean isAppropriate_FWD(Match match, UseCase useCase,
		...
		if (fujaba__Success) {
			...
			this.registerObjectsToMatch_FWD(match, useCase, packageDeclaration,
					basicFlow);
			return true;
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		try {
			...
			ruleresult.setRuleName("UseCaseNoPrecondRule");
			// assign attribute __packageDeclaration_useCases_useCase
			__packageDeclaration_useCases_useCase.setName("useCases");
		...
		this.registerObjects_FWD(ruleresult, useCase, packageDeclaration,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		try {
			...
			// assign attribute ruleresult
			ruleresult.setRule("UseCaseNoPrecondRule");
					...
					try {
						...
						if (fujaba__Success) {
							...
							try {
								...
								isApplicableMatch
										.setRuleName("UseCaseNoPrecondRule");
								// assign attribute ruleresult
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, UseCase useCase,
		...
		var_useCase_preConditions.setType("EObject");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// No post processing method found
		// statement node 'register objects'
		this.registerObjects_BWD(ruleresult, useCase, packageDeclaration,
				_package, packageDeclarationToPackage, interaction,
				useCaseToInteraction, basicFlow, basicFlowToInteraction);
		return ruleresult;
	}
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_75(
		...
		UseCase __DEC_basicFlow_flows_631735 = null;
		PackageDeclaration __DEC_useCase_useCases_656698 = null;
		Match match = null;
				...
				try {
					...
					try {
						...
						try {
							...
							// bind object
							__DEC_basicFlow_flows_631735 = basicFlow
									.eContainer() instanceof UseCase ? (UseCase) basicFlow
									.eContainer() : null;

							// check object __DEC_basicFlow_flows_631735 is really bound
							JavaSDM.ensure(__DEC_basicFlow_flows_631735 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_basicFlow_flows_631735
									.getFlows().contains(basicFlow));

							// check isomorphic binding between objects __DEC_basicFlow_flows_631735 and useCase 
							JavaSDM.ensure(!__DEC_basicFlow_flows_631735
									.equals(useCase));
						...
						try {
							...
							// bind object
							__DEC_useCase_useCases_656698 = useCase
									.eContainer() instanceof PackageDeclaration ? (PackageDeclaration) useCase
									.eContainer() : null;

							// check object __DEC_useCase_useCases_656698 is really bound
							JavaSDM.ensure(__DEC_useCase_useCases_656698 != null);

							// check if contained via correct reference
							JavaSDM.ensure(__DEC_useCase_useCases_656698
									.getUseCases().contains(useCase));

							// check isomorphic binding between objects __DEC_useCase_useCases_656698 and packageDeclaration 
							JavaSDM.ensure(!__DEC_useCase_useCases_656698
									.equals(packageDeclaration));
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_323(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		Interaction __DEC_interaction_enclosingInteraction_220465 = null;
		ModalSequenceDiagram.Package __DEC_interaction_packagedElement_735932 = null;
		Match match = null;
		Interaction interaction = null;
		ModalSequenceDiagram.Package _package = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_interaction_enclosingInteraction_220465 = interaction
							.getEnclosingInteraction();

					// check object __DEC_interaction_enclosingInteraction_220465 is really bound
					JavaSDM.ensure(__DEC_interaction_enclosingInteraction_220465 != null);

					// check isomorphic binding between objects __DEC_interaction_enclosingInteraction_220465 and interaction 
					JavaSDM.ensure(!__DEC_interaction_enclosingInteraction_220465
							.equals(interaction));
				...
				try {
					...
					// bind object
					__DEC_interaction_packagedElement_735932 = interaction
							.eContainer() instanceof ModalSequenceDiagram.Package ? (ModalSequenceDiagram.Package) interaction
							.eContainer() : null;

					// check object __DEC_interaction_packagedElement_735932 is really bound
					JavaSDM.ensure(__DEC_interaction_packagedElement_735932 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_interaction_packagedElement_735932
							.getPackagedElement().contains(interaction));

					// check isomorphic binding between objects __DEC_interaction_packagedElement_735932 and _package 
					JavaSDM.ensure(!__DEC_interaction_packagedElement_735932
							.equals(_package));
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_76(
		...
		EOperation __performOperation = null;
		EObjectContainer __result = null;
		UseCase __DEC_basicFlow_flows_946831 = null;
		PackageDeclaration __DEC_useCase_useCases_238161 = null;
		Match match = null;
		PackageDeclaration packageDeclaration = null;
		BasicFlow basicFlow = null;
		UseCase useCase = null;
		...
		try {
			...
			try {
				...
				try {
					...
					// bind object
					__DEC_basicFlow_flows_946831 = basicFlow.eContainer() instanceof UseCase ? (UseCase) basicFlow
							.eContainer() : null;

					// check object __DEC_basicFlow_flows_946831 is really bound
					JavaSDM.ensure(__DEC_basicFlow_flows_946831 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_basicFlow_flows_946831.getFlows()
							.contains(basicFlow));

					// check isomorphic binding between objects __DEC_basicFlow_flows_946831 and useCase 
					JavaSDM.ensure(!__DEC_basicFlow_flows_946831
							.equals(useCase));
				...
				try {
					...
					// bind object
					__DEC_useCase_useCases_238161 = useCase.eContainer() instanceof PackageDeclaration ? (PackageDeclaration) useCase
							.eContainer() : null;

					// check object __DEC_useCase_useCases_238161 is really bound
					JavaSDM.ensure(__DEC_useCase_useCases_238161 != null);

					// check if contained via correct reference
					JavaSDM.ensure(__DEC_useCase_useCases_238161.getUseCases()
							.contains(useCase));

					// check isomorphic binding between objects __DEC_useCase_useCases_238161 and packageDeclaration 
					JavaSDM.ensure(!__DEC_useCase_useCases_238161
							.equals(packageDeclaration));
				...
				match.setRuleName(__eClass.getName());
				// statement node 'bookkeeping with generic isAppropriate method'
				fujaba__Success = this.isAppropriate_FWD(match, useCase,
						packageDeclaration, basicFlow);
				if (fujaba__Success) {
					// statement node 'Ensure that the correct types of elements are matched'
					fujaba__Success = this.checkTypes_FWD(match);
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case RulesPackage.USE_CASE_NO_PRECOND_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_75__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_75((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USE_CASE_NO_PRECOND_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_323__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_323((EMoflonEdge) arguments
					.get(0));
		case RulesPackage.USE_CASE_NO_PRECOND_RULE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_76__EMOFLONEDGE:
