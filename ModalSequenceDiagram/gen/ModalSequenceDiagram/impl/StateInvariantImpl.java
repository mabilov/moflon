 ...
 * <ul>
 *   <li>{@link ModalSequenceDiagram.impl.StateInvariantImpl#getInvariant <em>Invariant</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StateInvariantImpl extends InteractionFragmentImpl implements
		StateInvariant {
	/**
	...
	protected EClass eStaticClass() {
		return ModalSequenceDiagramPackage.Literals.STATE_INVARIANT;
	}
	...
	public NotificationChain basicSetInvariant(Constraint newInvariant,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ModalSequenceDiagramPackage.STATE_INVARIANT__INVARIANT,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ModalSequenceDiagramPackage.STATE_INVARIANT__INVARIANT:
