 ...
 * <ul>
 *   <li>{@link ModalSequenceDiagram.impl.InteractionOperandImpl#getFragment <em>Fragment</em>}</li>
 *   <li>{@link ModalSequenceDiagram.impl.InteractionOperandImpl#getGuard <em>Guard</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InteractionOperandImpl extends InteractionFragmentImpl implements
		InteractionOperand {
	/**
	...
	protected EClass eStaticClass() {
		return ModalSequenceDiagramPackage.Literals.INTERACTION_OPERAND;
	}
	...
	public NotificationChain basicSetGuard(InteractionConstraint newGuard,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ModalSequenceDiagramPackage.INTERACTION_OPERAND__GUARD,
					oldGuard, newGuard);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ModalSequenceDiagramPackage.INTERACTION_OPERAND__FRAGMENT:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ModalSequenceDiagramPackage.INTERACTION_OPERAND__FRAGMENT:
			return ((InternalEList<?>) getFragment()).basicRemove(otherEnd,
					msgs);
		case ModalSequenceDiagramPackage.INTERACTION_OPERAND__GUARD:
