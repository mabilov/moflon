 ...
 * <ul>
 *   <li>{@link ModalSequenceDiagram.impl.MessageEndImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageEndImpl extends NamedElementImpl implements MessageEnd {
	...
	protected EClass eStaticClass() {
		return ModalSequenceDiagramPackage.Literals.MESSAGE_END;
	}
			...
			if (message != oldMessage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModalSequenceDiagramPackage.MESSAGE_END__MESSAGE,
							oldMessage, message));
			}
		}
		return message;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModalSequenceDiagramPackage.MESSAGE_END__MESSAGE:
			if (resolve)
				return getMessage();
