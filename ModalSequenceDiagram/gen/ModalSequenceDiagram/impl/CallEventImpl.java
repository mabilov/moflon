 ...
 * <ul>
 *   <li>{@link ModalSequenceDiagram.impl.CallEventImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CallEventImpl extends MessageEventImpl implements CallEvent {
	...
	protected EClass eStaticClass() {
		return ModalSequenceDiagramPackage.Literals.CALL_EVENT;
	}
			...
			if (operation != oldOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModalSequenceDiagramPackage.CALL_EVENT__OPERATION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModalSequenceDiagramPackage.CALL_EVENT__OPERATION:
			if (resolve)
				return getOperation();
