 ...
 * <ul>
 *   <li>{@link ModalSequenceDiagram.impl.OpaqueExpressionImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OpaqueExpressionImpl extends ValueSpecificationImpl implements
		OpaqueExpression {
	/**
	...
	protected EClass eStaticClass() {
		return ModalSequenceDiagramPackage.Literals.OPAQUE_EXPRESSION;
	}
	...
	public EList<String> getBody() {
		if (body == null) {
			body = new EDataTypeUniqueEList<String>(String.class, this,
					ModalSequenceDiagramPackage.OPAQUE_EXPRESSION__BODY);
		}
		return body;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModalSequenceDiagramPackage.OPAQUE_EXPRESSION__BODY:
			return getBody();
		}
