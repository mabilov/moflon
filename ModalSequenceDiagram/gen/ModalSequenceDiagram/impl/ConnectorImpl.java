 ...
 * <ul>
 *   <li>{@link ModalSequenceDiagram.impl.ConnectorImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends FeatureImpl implements Connector {
	...
	protected EClass eStaticClass() {
		return ModalSequenceDiagramPackage.Literals.CONNECTOR;
	}
	...
	public EList<ConnectorEnd> getEnd() {
		if (end == null) {
			end = new EObjectContainmentEList<ConnectorEnd>(ConnectorEnd.class,
					this, ModalSequenceDiagramPackage.CONNECTOR__END);
		}
		return end;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ModalSequenceDiagramPackage.CONNECTOR__END:
