...
public interface Bpmn2Package extends EPackage {
	 ...
	 * @ordered
	 */
	int DEFINITIONS__TARGET_NAMESPACE = 2;
	 ...
	 * @ordered
	 */
	int PROCESS___REMOVE_NODE__FLOWNODE = CALLABLE_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PROCESS_OPERATION_COUNT = CALLABLE_ELEMENT_OPERATION_COUNT + 1;
	...
	/**
	 * Returns the meta object for the '{@link bpmn2.Process#removeNode(bpmn2.FlowNode) <em>Remove Node</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Remove Node</em>' operation.
	 * @see bpmn2.Process#removeNode(bpmn2.FlowNode)
	 * @generated
	 */
	EOperation getProcess__RemoveNode__FlowNode();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation PROCESS___REMOVE_NODE__FLOWNODE = eINSTANCE
				.getProcess__RemoveNode__FlowNode();
