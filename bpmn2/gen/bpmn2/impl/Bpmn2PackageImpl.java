...
public class Bpmn2PackageImpl extends EPackageImpl implements Bpmn2Package {
	 ...
	 * @generated
	 */
	public EOperation getProcess__RemoveNode__FlowNode() {
	...
	public void createPackageContents() {
		...
		createEOperation(processEClass, PROCESS___REMOVE_NODE__FLOWNODE);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getProcess__RemoveNode__FlowNode(),
				this.getFlowNode(), "removeNode", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getFlowNode(), "node", 0, 1, IS_UNIQUE,
				IS_ORDERED);
