...
public class UseCaseDSLPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		initEAttribute(getActor_Description(), ecorePackage.getEString(),
				"description", null, 1, 1, Actor.class, !IS_TRANSIENT,
		...
		initEAttribute(getFlow_FinalState(), ecorePackage.getEString(),
				"finalState", null, 1, 1, Flow.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getNormalStep_CustomStepType(),
				this.getCustomStepType(), "customStepType", null, 1, 1,
		...
		initEAttribute(getStep_Label(), ecorePackage.getEString(), "label",
				null, 1, 1, Step.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		...
		initEAttribute(getUseCase_Description(), ecorePackage.getEString(),
				"description", null, 1, 1, UseCase.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getUseCase_PreConditions(), ecorePackage.getEString(),
				"preConditions", null, 1, 1, UseCase.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
		initEAttribute(getUseCase_Postcondition(), ecorePackage.getEString(),
				"postcondition", null, 1, 1, UseCase.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, !IS_ORDERED);
