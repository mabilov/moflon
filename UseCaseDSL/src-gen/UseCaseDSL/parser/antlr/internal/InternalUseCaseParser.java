...
public class InternalUseCaseParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'package'", "'actors'", "'end package'", "'usecase'", "'extends'", "'preconditions'", "'postcondition'", "'end usecase'", "'as'", "'basic flow'", "'end flow'", "'with postcondition'", "'exception flow'", "'if'", "'then'", "'alternative flow'", "'parallel flow'", "'continue with step'", "'invoke usecase'", "'parallel step'", "','", "'next'", "'step'", "'by'", "'alternatives'", "'else'", "'.'", "'person'", "'system'", "'organization'", "'wait'", "'send'", "'perform'", "'call'", "'alt'", "'wait-alt'"
    };
    ...
    public final EObject ruleUseCasesModel() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:81:1: ( (lv_packages_0_0= rulePackageDeclaration ) )*
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:81:1: ( (lv_packages_0_0= rulePackageDeclaration ) )*
            loop1:
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:82:1: (lv_packages_0_0= rulePackageDeclaration )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:82:1: (lv_packages_0_0= rulePackageDeclaration )
    ...
    public final EObject rulePackageDeclaration() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:120:1: (otherlv_0= 'package' ( (lv_name_1_0= ruleQualifiedName ) ) ( (lv_description_2_0= RULE_STRING ) )? (otherlv_3= 'actors' ( (lv_actors_4_0= ruleActor ) )+ )? ( (lv_useCases_5_0= ruleUseCase ) )* otherlv_6= 'end package' )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:120:1: (otherlv_0= 'package' ( (lv_name_1_0= ruleQualifiedName ) ) ( (lv_description_2_0= RULE_STRING ) )? (otherlv_3= 'actors' ( (lv_actors_4_0= ruleActor ) )+ )? ( (lv_useCases_5_0= ruleUseCase ) )* otherlv_6= 'end package' )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:124:1: ( (lv_name_1_0= ruleQualifiedName ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:125:1: (lv_name_1_0= ruleQualifiedName )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:125:1: (lv_name_1_0= ruleQualifiedName )
            ...
            switch (alt2) {
                case 1 :
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:143:1: (lv_description_2_0= RULE_STRING )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:143:1: (lv_description_2_0= RULE_STRING )
            ...
            switch (alt4) {
                case 1 :
                    ...
                    {
                    otherlv_3=(Token)match(input,12,FOLLOW_12_in_rulePackageDeclaration270); 

                        	newLeafNode(otherlv_3, grammarAccess.getPackageDeclarationAccess().getActorsKeyword_3_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:164:1: ( (lv_actors_4_0= ruleActor ) )+
                    int cnt3=0;
                    loop3:
                    do {
                        int alt3=2;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:165:1: (lv_actors_4_0= ruleActor )
                    	    {
                    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:165:1: (lv_actors_4_0= ruleActor )
            ...
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:183:1: (lv_useCases_5_0= ruleUseCase )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:183:1: (lv_useCases_5_0= ruleUseCase )
            ...
            otherlv_6=(Token)match(input,13,FOLLOW_13_in_rulePackageDeclaration328); 
    ...
    public final EObject ruleUseCase() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:225:1: (otherlv_0= 'usecase' ( (lv_name_1_0= RULE_ID ) ) ( (lv_description_2_0= RULE_STRING ) )? (otherlv_3= 'extends' ( (otherlv_4= RULE_ID ) ) )? ( ( ( ( ({...}? => ( ({...}? => (otherlv_6= 'preconditions' ( (lv_preconditions_7_0= ruleUCCondition ) )+ ) ) ) ) | ({...}? => ( ({...}? => (otherlv_8= 'postcondition' ( (lv_postconditions_9_0= ruleUCCondition ) )+ ) ) ) ) )* ) ) ) ( (lv_flows_10_0= ruleFlow ) )* otherlv_11= 'end usecase' )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:225:1: (otherlv_0= 'usecase' ( (lv_name_1_0= RULE_ID ) ) ( (lv_description_2_0= RULE_STRING ) )? (otherlv_3= 'extends' ( (otherlv_4= RULE_ID ) ) )? ( ( ( ( ({...}? => ( ({...}? => (otherlv_6= 'preconditions' ( (lv_preconditions_7_0= ruleUCCondition ) )+ ) ) ) ) | ({...}? => ( ({...}? => (otherlv_8= 'postcondition' ( (lv_postconditions_9_0= ruleUCCondition ) )+ ) ) ) ) )* ) ) ) ( (lv_flows_10_0= ruleFlow ) )* otherlv_11= 'end usecase' )
            ...
            {
            otherlv_0=(Token)match(input,14,FOLLOW_14_in_ruleUseCase411); 

                	newLeafNode(otherlv_0, grammarAccess.getUseCaseAccess().getUsecaseKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:229:1: ( (lv_name_1_0= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:230:1: (lv_name_1_0= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:230:1: (lv_name_1_0= RULE_ID )
            ...
            switch (alt6) {
                case 1 :
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:248:1: (lv_description_2_0= RULE_STRING )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:248:1: (lv_description_2_0= RULE_STRING )
            ...
            switch (alt7) {
                case 1 :
                    ...
                    {
                    otherlv_3=(Token)match(input,15,FOLLOW_15_in_ruleUseCase469); 

                        	newLeafNode(otherlv_3, grammarAccess.getUseCaseAccess().getExtendsKeyword_3_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:269:1: ( (otherlv_4= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:270:1: (otherlv_4= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:270:1: (otherlv_4= RULE_ID )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:284:1: ( ( ( ({...}? => ( ({...}? => (otherlv_6= 'preconditions' ( (lv_preconditions_7_0= ruleUCCondition ) )+ ) ) ) ) | ({...}? => ( ({...}? => (otherlv_8= 'postcondition' ( (lv_postconditions_9_0= ruleUCCondition ) )+ ) ) ) ) )* ) )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:284:1: ( ( ( ({...}? => ( ({...}? => (otherlv_6= 'preconditions' ( (lv_preconditions_7_0= ruleUCCondition ) )+ ) ) ) ) | ({...}? => ( ({...}? => (otherlv_8= 'postcondition' ( (lv_postconditions_9_0= ruleUCCondition ) )+ ) ) ) ) )* ) )
            ...
            do {
                ...
                if ( LA10_0 ==16 && getUnorderedGroupHelper().canSelect(grammarAccess.getUseCaseAccess().getUnorderedGroup_4(), 0) ) {
                    alt10=1;
                }
                else if ( LA10_0 ==17 && getUnorderedGroupHelper().canSelect(grammarAccess.getUseCaseAccess().getUnorderedGroup_4(), 1) ) {
                    alt10=2;
                }
            	...
            	case 1 :
            	    ...
            	    {
            	    otherlv_6=(Token)match(input,16,FOLLOW_16_in_ruleUseCase549); 

            	        	newLeafNode(otherlv_6, grammarAccess.getUseCaseAccess().getPreconditionsKeyword_4_0_0());
            	        
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:300:1: ( (lv_preconditions_7_0= ruleUCCondition ) )+
            	    int cnt8=0;
            	    loop8:
            	    do {
            	        int alt8=2;
            	        ...
            	        switch (alt8) {
            	    	case 1 :
            	    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:301:1: (lv_preconditions_7_0= ruleUCCondition )
            	    	    {
            	    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:301:1: (lv_preconditions_7_0= ruleUCCondition )
            	...
            	case 2 :
            	    ...
            	    {
            	    otherlv_8=(Token)match(input,17,FOLLOW_17_in_ruleUseCase639); 

            	        	newLeafNode(otherlv_8, grammarAccess.getUseCaseAccess().getPostconditionKeyword_4_1_0());
            	        
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:334:1: ( (lv_postconditions_9_0= ruleUCCondition ) )+
            	    int cnt9=0;
            	    loop9:
            	    do {
            	        int alt9=2;
            	        ...
            	        switch (alt9) {
            	    	case 1 :
            	    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:335:1: (lv_postconditions_9_0= ruleUCCondition )
            	    	    {
            	    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:335:1: (lv_postconditions_9_0= ruleUCCondition )
            ...
            do {
                ...
                if ( (LA11_0==20||LA11_0==23||(LA11_0>=26 && LA11_0<=27)) ) {
                    alt11=1;
                }
                ...
                switch (alt11) {
            	case 1 :
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:367:1: (lv_flows_10_0= ruleFlow )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:367:1: (lv_flows_10_0= ruleFlow )
            ...
            otherlv_11=(Token)match(input,18,FOLLOW_18_in_ruleUseCase736); 
    ...
    public final EObject ruleUCCondition() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:409:1: ( (lv_name_0_0= RULE_STRING ) )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:409:1: ( (lv_name_0_0= RULE_STRING ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:410:1: (lv_name_0_0= RULE_STRING )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:410:1: (lv_name_0_0= RULE_STRING )
    ...
    public final EObject ruleActor() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:448:1: ( ( (lv_name_0_0= RULE_ID ) ) otherlv_1= 'as' ( (lv_type_2_0= ruleActorType ) ) ( (lv_description_3_0= RULE_STRING ) )? (otherlv_4= 'extends' ( (otherlv_5= RULE_ID ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:448:1: ( ( (lv_name_0_0= RULE_ID ) ) otherlv_1= 'as' ( (lv_type_2_0= ruleActorType ) ) ( (lv_description_3_0= RULE_STRING ) )? (otherlv_4= 'extends' ( (otherlv_5= RULE_ID ) ) )? )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:449:1: (lv_name_0_0= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:449:1: (lv_name_0_0= RULE_ID )
            ...
            otherlv_1=(Token)match(input,19,FOLLOW_19_in_ruleActor932); 

                	newLeafNode(otherlv_1, grammarAccess.getActorAccess().getAsKeyword_1());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:470:1: ( (lv_type_2_0= ruleActorType ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:471:1: (lv_type_2_0= ruleActorType )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:471:1: (lv_type_2_0= ruleActorType )
            ...
            switch (alt12) {
                case 1 :
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:489:1: (lv_description_3_0= RULE_STRING )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:489:1: (lv_description_3_0= RULE_STRING )
            ...
            switch (alt13) {
                case 1 :
                    ...
                    {
                    otherlv_4=(Token)match(input,15,FOLLOW_15_in_ruleActor989); 

                        	newLeafNode(otherlv_4, grammarAccess.getActorAccess().getExtendsKeyword_4_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:510:1: ( (otherlv_5= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:511:1: (otherlv_5= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:511:1: (otherlv_5= RULE_ID )
    ...
    public final EObject ruleStep() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:544:1: (this_NormalStep_0= ruleNormalStep | this_ParallelStep_1= ruleParallelStep )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:544:1: (this_NormalStep_0= ruleNormalStep | this_ParallelStep_1= ruleParallelStep )
            int alt14=2;
    ...
    public final EObject ruleFlow() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:584:1: (this_BasicFlow_0= ruleBasicFlow | this_NamedFlow_1= ruleNamedFlow )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:584:1: (this_BasicFlow_0= ruleBasicFlow | this_NamedFlow_1= ruleNamedFlow )
            int alt15=2;
            ...
            else if ( (LA15_0==23||(LA15_0>=26 && LA15_0<=27)) ) {
                alt15=2;
            }
            else {
                NoViableAltException nvae =
    ...
    public final EObject ruleBasicFlow() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:624:1: (otherlv_0= 'basic flow' () ( (lv_steps_2_0= ruleStep ) )* otherlv_3= 'end flow' (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:624:1: (otherlv_0= 'basic flow' () ( (lv_steps_2_0= ruleStep ) )* otherlv_3= 'end flow' (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,20,FOLLOW_20_in_ruleBasicFlow1332); 

                	newLeafNode(otherlv_0, grammarAccess.getBasicFlowAccess().getBasicFlowKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:628:1: ()
            ...
            do {
                ...
                switch (alt16) {
            	case 1 :
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:635:1: (lv_steps_2_0= ruleStep )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:635:1: (lv_steps_2_0= ruleStep )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:656:1: (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    ...
                    {
                    otherlv_4=(Token)match(input,22,FOLLOW_22_in_ruleBasicFlow1388); 

                        	newLeafNode(otherlv_4, grammarAccess.getBasicFlowAccess().getWithPostconditionKeyword_4_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:660:1: ( (lv_finalState_5_0= ruleUCCondition ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:661:1: (lv_finalState_5_0= ruleUCCondition )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:661:1: (lv_finalState_5_0= ruleUCCondition )
    ...
    public final EObject ruleNamedFlow() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:699:1: (this_ExceptionFlow_0= ruleExceptionFlow | this_AlternativeFlow_1= ruleAlternativeFlow | this_ParallelFlow_2= ruleParallelFlow )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:699:1: (this_ExceptionFlow_0= ruleExceptionFlow | this_AlternativeFlow_1= ruleAlternativeFlow | this_ParallelFlow_2= ruleParallelFlow )
            int alt18=3;
            switch ( input.LA(1) ) {
    ...
    public final EObject ruleExceptionFlow() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:749:1: (otherlv_0= 'exception flow' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= 'if' ( (lv_condition_3_0= RULE_STRING ) ) otherlv_4= 'then' ( (lv_steps_5_0= ruleStep ) )* otherlv_6= 'end flow' (otherlv_7= 'with postcondition' ( (lv_finalState_8_0= ruleUCCondition ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:749:1: (otherlv_0= 'exception flow' ( (lv_name_1_0= RULE_ID ) ) otherlv_2= 'if' ( (lv_condition_3_0= RULE_STRING ) ) otherlv_4= 'then' ( (lv_steps_5_0= ruleStep ) )* otherlv_6= 'end flow' (otherlv_7= 'with postcondition' ( (lv_finalState_8_0= ruleUCCondition ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,23,FOLLOW_23_in_ruleExceptionFlow1640); 

                	newLeafNode(otherlv_0, grammarAccess.getExceptionFlowAccess().getExceptionFlowKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:753:1: ( (lv_name_1_0= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:754:1: (lv_name_1_0= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:754:1: (lv_name_1_0= RULE_ID )
            ...
            otherlv_2=(Token)match(input,24,FOLLOW_24_in_ruleExceptionFlow1674); 

                	newLeafNode(otherlv_2, grammarAccess.getExceptionFlowAccess().getIfKeyword_2());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:775:1: ( (lv_condition_3_0= RULE_STRING ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:776:1: (lv_condition_3_0= RULE_STRING )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:776:1: (lv_condition_3_0= RULE_STRING )
            ...
            otherlv_4=(Token)match(input,25,FOLLOW_25_in_ruleExceptionFlow1708); 

                	newLeafNode(otherlv_4, grammarAccess.getExceptionFlowAccess().getThenKeyword_4());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:797:1: ( (lv_steps_5_0= ruleStep ) )*
            loop19:
            do {
                int alt19=2;
                ...
                switch (alt19) {
            	case 1 :
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:798:1: (lv_steps_5_0= ruleStep )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:798:1: (lv_steps_5_0= ruleStep )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:819:1: (otherlv_7= 'with postcondition' ( (lv_finalState_8_0= ruleUCCondition ) ) )?
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    ...
                    {
                    otherlv_7=(Token)match(input,22,FOLLOW_22_in_ruleExceptionFlow1755); 

                        	newLeafNode(otherlv_7, grammarAccess.getExceptionFlowAccess().getWithPostconditionKeyword_7_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:823:1: ( (lv_finalState_8_0= ruleUCCondition ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:824:1: (lv_finalState_8_0= ruleUCCondition )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:824:1: (lv_finalState_8_0= ruleUCCondition )
    ...
    public final EObject ruleAlternativeFlow() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:862:1: (otherlv_0= 'alternative flow' ( (lv_name_1_0= RULE_ID ) ) ( (lv_steps_2_0= ruleStep ) )* otherlv_3= 'end flow' (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:862:1: (otherlv_0= 'alternative flow' ( (lv_name_1_0= RULE_ID ) ) ( (lv_steps_2_0= ruleStep ) )* otherlv_3= 'end flow' (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,26,FOLLOW_26_in_ruleAlternativeFlow1861); 

                	newLeafNode(otherlv_0, grammarAccess.getAlternativeFlowAccess().getAlternativeFlowKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:866:1: ( (lv_name_1_0= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:867:1: (lv_name_1_0= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:867:1: (lv_name_1_0= RULE_ID )
            ...
            do {
                ...
                switch (alt21) {
            	case 1 :
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:885:1: (lv_steps_2_0= ruleStep )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:885:1: (lv_steps_2_0= ruleStep )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:906:1: (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )?
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    ...
                    {
                    otherlv_4=(Token)match(input,22,FOLLOW_22_in_ruleAlternativeFlow1930); 

                        	newLeafNode(otherlv_4, grammarAccess.getAlternativeFlowAccess().getWithPostconditionKeyword_4_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:910:1: ( (lv_finalState_5_0= ruleUCCondition ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:911:1: (lv_finalState_5_0= ruleUCCondition )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:911:1: (lv_finalState_5_0= ruleUCCondition )
    ...
    public final EObject ruleParallelFlow() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:949:1: (otherlv_0= 'parallel flow' ( (lv_name_1_0= RULE_ID ) ) ( (lv_steps_2_0= ruleStep ) )* otherlv_3= 'end flow' (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:949:1: (otherlv_0= 'parallel flow' ( (lv_name_1_0= RULE_ID ) ) ( (lv_steps_2_0= ruleStep ) )* otherlv_3= 'end flow' (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,27,FOLLOW_27_in_ruleParallelFlow2036); 

                	newLeafNode(otherlv_0, grammarAccess.getParallelFlowAccess().getParallelFlowKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:953:1: ( (lv_name_1_0= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:954:1: (lv_name_1_0= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:954:1: (lv_name_1_0= RULE_ID )
            ...
            do {
                ...
                switch (alt23) {
            	case 1 :
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:972:1: (lv_steps_2_0= ruleStep )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:972:1: (lv_steps_2_0= ruleStep )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:993:1: (otherlv_4= 'with postcondition' ( (lv_finalState_5_0= ruleUCCondition ) ) )?
            int alt24=2;
            ...
            switch (alt24) {
                case 1 :
                    ...
                    {
                    otherlv_4=(Token)match(input,22,FOLLOW_22_in_ruleParallelFlow2105); 

                        	newLeafNode(otherlv_4, grammarAccess.getParallelFlowAccess().getWithPostconditionKeyword_4_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:997:1: ( (lv_finalState_5_0= ruleUCCondition ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:998:1: (lv_finalState_5_0= ruleUCCondition )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:998:1: (lv_finalState_5_0= ruleUCCondition )
    ...
    public final EObject ruleStepAlternative() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1036:1: (this_Condition_0= ruleCondition | this_LocalAlternative_1= ruleLocalAlternative | this_AlternativeFlowAlternative_2= ruleAlternativeFlowAlternative )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1036:1: (this_Condition_0= ruleCondition | this_LocalAlternative_1= ruleLocalAlternative | this_AlternativeFlowAlternative_2= ruleAlternativeFlowAlternative )
            int alt25=3;
    ...
    public final EObject ruleCondition() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1086:1: (otherlv_0= 'if' ( (lv_condition_1_0= RULE_STRING ) ) otherlv_2= 'then' (otherlv_3= 'continue with step' ( (otherlv_4= RULE_ID ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1086:1: (otherlv_0= 'if' ( (lv_condition_1_0= RULE_STRING ) ) otherlv_2= 'then' (otherlv_3= 'continue with step' ( (otherlv_4= RULE_ID ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,24,FOLLOW_24_in_ruleCondition2357); 

                	newLeafNode(otherlv_0, grammarAccess.getConditionAccess().getIfKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1090:1: ( (lv_condition_1_0= RULE_STRING ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1091:1: (lv_condition_1_0= RULE_STRING )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1091:1: (lv_condition_1_0= RULE_STRING )
            ...
            otherlv_2=(Token)match(input,25,FOLLOW_25_in_ruleCondition2391); 

                	newLeafNode(otherlv_2, grammarAccess.getConditionAccess().getThenKeyword_2());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1112:1: (otherlv_3= 'continue with step' ( (otherlv_4= RULE_ID ) ) )?
            int alt26=2;
            ...
            switch (alt26) {
                case 1 :
                    ...
                    {
                    otherlv_3=(Token)match(input,28,FOLLOW_28_in_ruleCondition2404); 

                        	newLeafNode(otherlv_3, grammarAccess.getConditionAccess().getContinueWithStepKeyword_3_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1116:1: ( (otherlv_4= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1117:1: (otherlv_4= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1117:1: (otherlv_4= RULE_ID )
    ...
    public final EObject ruleLocalAlternative() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1150:1: (otherlv_0= 'if' ( (lv_condition_1_0= RULE_STRING ) ) otherlv_2= 'then' ( ( (lv_description_3_0= RULE_STRING ) ) | (otherlv_4= 'invoke usecase' ( (otherlv_5= RULE_ID ) ) ) ) (otherlv_6= 'continue with step' ( (otherlv_7= RULE_ID ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1150:1: (otherlv_0= 'if' ( (lv_condition_1_0= RULE_STRING ) ) otherlv_2= 'then' ( ( (lv_description_3_0= RULE_STRING ) ) | (otherlv_4= 'invoke usecase' ( (otherlv_5= RULE_ID ) ) ) ) (otherlv_6= 'continue with step' ( (otherlv_7= RULE_ID ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,24,FOLLOW_24_in_ruleLocalAlternative2509); 

                	newLeafNode(otherlv_0, grammarAccess.getLocalAlternativeAccess().getIfKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1154:1: ( (lv_condition_1_0= RULE_STRING ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1155:1: (lv_condition_1_0= RULE_STRING )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1155:1: (lv_condition_1_0= RULE_STRING )
            ...
            otherlv_2=(Token)match(input,25,FOLLOW_25_in_ruleLocalAlternative2543); 

                	newLeafNode(otherlv_2, grammarAccess.getLocalAlternativeAccess().getThenKeyword_2());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1176:1: ( ( (lv_description_3_0= RULE_STRING ) ) | (otherlv_4= 'invoke usecase' ( (otherlv_5= RULE_ID ) ) ) )
            int alt27=2;
            ...
            switch (alt27) {
                case 1 :
                    ...
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1176:2: ( (lv_description_3_0= RULE_STRING ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1177:1: (lv_description_3_0= RULE_STRING )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1177:1: (lv_description_3_0= RULE_STRING )
                ...
                case 2 :
                    ...
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1199:1: ( (otherlv_5= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1200:1: (otherlv_5= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1200:1: (otherlv_5= RULE_ID )
            ...
            switch (alt28) {
                case 1 :
                    ...
                    {
                    otherlv_6=(Token)match(input,28,FOLLOW_28_in_ruleLocalAlternative2620); 

                        	newLeafNode(otherlv_6, grammarAccess.getLocalAlternativeAccess().getContinueWithStepKeyword_4_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1216:1: ( (otherlv_7= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1217:1: (otherlv_7= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1217:1: (otherlv_7= RULE_ID )
    ...
    public final EObject ruleAlternativeFlowAlternative() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1250:1: (otherlv_0= 'if' ( (lv_condition_1_0= RULE_STRING ) ) otherlv_2= 'then' otherlv_3= 'alternative flow' ( (otherlv_4= RULE_ID ) ) (otherlv_5= 'continue with step' ( (otherlv_6= RULE_ID ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1250:1: (otherlv_0= 'if' ( (lv_condition_1_0= RULE_STRING ) ) otherlv_2= 'then' otherlv_3= 'alternative flow' ( (otherlv_4= RULE_ID ) ) (otherlv_5= 'continue with step' ( (otherlv_6= RULE_ID ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,24,FOLLOW_24_in_ruleAlternativeFlowAlternative2725); 

                	newLeafNode(otherlv_0, grammarAccess.getAlternativeFlowAlternativeAccess().getIfKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1254:1: ( (lv_condition_1_0= RULE_STRING ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1255:1: (lv_condition_1_0= RULE_STRING )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1255:1: (lv_condition_1_0= RULE_STRING )
            ...
            otherlv_2=(Token)match(input,25,FOLLOW_25_in_ruleAlternativeFlowAlternative2759); 

                	newLeafNode(otherlv_2, grammarAccess.getAlternativeFlowAlternativeAccess().getThenKeyword_2());
                
            otherlv_3=(Token)match(input,26,FOLLOW_26_in_ruleAlternativeFlowAlternative2771); 

                	newLeafNode(otherlv_3, grammarAccess.getAlternativeFlowAlternativeAccess().getAlternativeFlowKeyword_3());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1280:1: ( (otherlv_4= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1281:1: (otherlv_4= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1281:1: (otherlv_4= RULE_ID )
            ...
            switch (alt29) {
                case 1 :
                    ...
                    {
                    otherlv_5=(Token)match(input,28,FOLLOW_28_in_ruleAlternativeFlowAlternative2804); 

                        	newLeafNode(otherlv_5, grammarAccess.getAlternativeFlowAlternativeAccess().getContinueWithStepKeyword_5_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1297:1: ( (otherlv_6= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1298:1: (otherlv_6= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1298:1: (otherlv_6= RULE_ID )
    ...
    public final EObject ruleParallelStep() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1331:1: (otherlv_0= 'parallel step' ( (lv_name_1_0= RULE_ID ) ) ( (lv_label_2_0= RULE_STRING ) )? ( (otherlv_3= RULE_ID ) ) (otherlv_4= ',' ( (otherlv_5= RULE_ID ) ) )* (otherlv_6= 'next' ( (otherlv_7= RULE_ID ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1331:1: (otherlv_0= 'parallel step' ( (lv_name_1_0= RULE_ID ) ) ( (lv_label_2_0= RULE_STRING ) )? ( (otherlv_3= RULE_ID ) ) (otherlv_4= ',' ( (otherlv_5= RULE_ID ) ) )* (otherlv_6= 'next' ( (otherlv_7= RULE_ID ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,30,FOLLOW_30_in_ruleParallelStep2909); 

                	newLeafNode(otherlv_0, grammarAccess.getParallelStepAccess().getParallelStepKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1335:1: ( (lv_name_1_0= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1336:1: (lv_name_1_0= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1336:1: (lv_name_1_0= RULE_ID )
            ...
            switch (alt30) {
                case 1 :
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1354:1: (lv_label_2_0= RULE_STRING )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1354:1: (lv_label_2_0= RULE_STRING )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1372:1: (otherlv_3= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1372:1: (otherlv_3= RULE_ID )
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    otherlv_4=(Token)match(input,31,FOLLOW_31_in_ruleParallelStep2987); 

            	        	newLeafNode(otherlv_4, grammarAccess.getParallelStepAccess().getCommaKeyword_4_0());
            	        
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1388:1: ( (otherlv_5= RULE_ID ) )
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1389:1: (otherlv_5= RULE_ID )
            	    {
            	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1389:1: (otherlv_5= RULE_ID )
            ...
            switch (alt32) {
                case 1 :
                    ...
                    {
                    otherlv_6=(Token)match(input,32,FOLLOW_32_in_ruleParallelStep3022); 

                        	newLeafNode(otherlv_6, grammarAccess.getParallelStepAccess().getNextKeyword_5_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1405:1: ( (otherlv_7= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1406:1: (otherlv_7= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1406:1: (otherlv_7= RULE_ID )
    ...
    public final EObject ruleNormalStep() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1439:1: (otherlv_0= 'step' ( (lv_name_1_0= RULE_ID ) ) ( (lv_label_2_0= RULE_STRING ) )? ( (lv_type_3_0= ruleStepType ) ) otherlv_4= 'by' ( (otherlv_5= RULE_ID ) ) ( (otherlv_6= 'alternatives' ( (lv_stepAlternative_7_0= ruleStepAlternative ) )+ otherlv_8= 'else' ) | (otherlv_9= 'invoke usecase' ( (otherlv_10= RULE_ID ) ) ) )? (otherlv_11= 'next' ( (otherlv_12= RULE_ID ) ) )? )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1439:1: (otherlv_0= 'step' ( (lv_name_1_0= RULE_ID ) ) ( (lv_label_2_0= RULE_STRING ) )? ( (lv_type_3_0= ruleStepType ) ) otherlv_4= 'by' ( (otherlv_5= RULE_ID ) ) ( (otherlv_6= 'alternatives' ( (lv_stepAlternative_7_0= ruleStepAlternative ) )+ otherlv_8= 'else' ) | (otherlv_9= 'invoke usecase' ( (otherlv_10= RULE_ID ) ) ) )? (otherlv_11= 'next' ( (otherlv_12= RULE_ID ) ) )? )
            ...
            {
            otherlv_0=(Token)match(input,33,FOLLOW_33_in_ruleNormalStep3127); 

                	newLeafNode(otherlv_0, grammarAccess.getNormalStepAccess().getStepKeyword_0());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1443:1: ( (lv_name_1_0= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1444:1: (lv_name_1_0= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1444:1: (lv_name_1_0= RULE_ID )
            ...
            switch (alt33) {
                case 1 :
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1462:1: (lv_label_2_0= RULE_STRING )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1462:1: (lv_label_2_0= RULE_STRING )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1480:1: (lv_type_3_0= ruleStepType )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1480:1: (lv_type_3_0= ruleStepType )
            ...
            otherlv_4=(Token)match(input,34,FOLLOW_34_in_ruleNormalStep3205); 

                	newLeafNode(otherlv_4, grammarAccess.getNormalStepAccess().getByKeyword_4());
                
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1501:1: ( (otherlv_5= RULE_ID ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1502:1: (otherlv_5= RULE_ID )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1502:1: (otherlv_5= RULE_ID )
            ...
            switch (alt35) {
                case 1 :
                    ...
                    {
                    otherlv_6=(Token)match(input,35,FOLLOW_35_in_ruleNormalStep3239); 

                        	newLeafNode(otherlv_6, grammarAccess.getNormalStepAccess().getAlternativesKeyword_6_0_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1518:1: ( (lv_stepAlternative_7_0= ruleStepAlternative ) )+
                    int cnt34=0;
                    loop34:
                    do {
                        int alt34=2;
                        ...
                        switch (alt34) {
                    	case 1 :
                    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1519:1: (lv_stepAlternative_7_0= ruleStepAlternative )
                    	    {
                    	    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1519:1: (lv_stepAlternative_7_0= ruleStepAlternative )
                    ...
                    otherlv_8=(Token)match(input,36,FOLLOW_36_in_ruleNormalStep3273); 
                ...
                case 2 :
                    ...
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1545:1: ( (otherlv_10= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1546:1: (otherlv_10= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1546:1: (otherlv_10= RULE_ID )
            ...
            switch (alt36) {
                case 1 :
                    ...
                    {
                    otherlv_11=(Token)match(input,32,FOLLOW_32_in_ruleNormalStep3329); 

                        	newLeafNode(otherlv_11, grammarAccess.getNormalStepAccess().getNextKeyword_7_0());
                        
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1562:1: ( (otherlv_12= RULE_ID ) )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1563:1: (otherlv_12= RULE_ID )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1563:1: (otherlv_12= RULE_ID )
    ...
    public final AntlrDatatypeRuleToken ruleQualifiedName() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1596:1: (this_ID_0= RULE_ID (kw= '.' this_ID_2= RULE_ID )* )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1596:1: (this_ID_0= RULE_ID (kw= '.' this_ID_2= RULE_ID )* )
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1603:1: (kw= '.' this_ID_2= RULE_ID )*
            loop37:
            do {
                int alt37=2;
            	...
            	case 1 :
            	    ...
            	    {
            	    kw=(Token)match(input,37,FOLLOW_37_in_ruleQualifiedName3458); 
    ...
    public final Enumerator ruleActorType() throws RecognitionException {
        ...
        try {
            ...
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1627:1: ( (enumLiteral_0= 'person' ) | (enumLiteral_1= 'system' ) | (enumLiteral_2= 'organization' ) )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1627:1: ( (enumLiteral_0= 'person' ) | (enumLiteral_1= 'system' ) | (enumLiteral_2= 'organization' ) )
            int alt38=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt38) {
                case 1 :
                    ...
                    {
                    enumLiteral_0=(Token)match(input,38,FOLLOW_38_in_ruleActorType3534); 
                ...
                case 2 :
                    ...
                    {
                    enumLiteral_1=(Token)match(input,39,FOLLOW_39_in_ruleActorType3551); 
                ...
                case 3 :
                    ...
                    {
                    enumLiteral_2=(Token)match(input,40,FOLLOW_40_in_ruleActorType3568); 
    ...
    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1649:1: ruleStepType returns [Enumerator current=null] : ( (enumLiteral_0= 'wait' ) | (enumLiteral_1= 'send' ) | (enumLiteral_2= 'perform' ) | (enumLiteral_3= 'call' ) | (enumLiteral_4= 'alt' ) | (enumLiteral_5= 'wait-alt' ) ) ;
    public final Enumerator ruleStepType() throws RecognitionException {
        ...
        Token enumLiteral_5=null;
         ...
         enterRule(); 
        try {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1651:28: ( ( (enumLiteral_0= 'wait' ) | (enumLiteral_1= 'send' ) | (enumLiteral_2= 'perform' ) | (enumLiteral_3= 'call' ) | (enumLiteral_4= 'alt' ) | (enumLiteral_5= 'wait-alt' ) ) )
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1652:1: ( (enumLiteral_0= 'wait' ) | (enumLiteral_1= 'send' ) | (enumLiteral_2= 'perform' ) | (enumLiteral_3= 'call' ) | (enumLiteral_4= 'alt' ) | (enumLiteral_5= 'wait-alt' ) )
            {
            // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1652:1: ( (enumLiteral_0= 'wait' ) | (enumLiteral_1= 'send' ) | (enumLiteral_2= 'perform' ) | (enumLiteral_3= 'call' ) | (enumLiteral_4= 'alt' ) | (enumLiteral_5= 'wait-alt' ) )
            int alt39=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt39) {
                case 1 :
                    ...
                    {
                    enumLiteral_0=(Token)match(input,41,FOLLOW_41_in_ruleStepType3613); 
                ...
                case 2 :
                    ...
                    {
                    enumLiteral_1=(Token)match(input,42,FOLLOW_42_in_ruleStepType3630); 
                ...
                case 3 :
                    ...
                    {
                    enumLiteral_2=(Token)match(input,43,FOLLOW_43_in_ruleStepType3647); 
                ...
                case 4 :
                    ...
                    {
                    enumLiteral_3=(Token)match(input,44,FOLLOW_44_in_ruleStepType3664); 
                ...
                case 5 :
                    ...
                    {
                    enumLiteral_4=(Token)match(input,45,FOLLOW_45_in_ruleStepType3681); 
                    ...
                    break;
                case 6 :
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1682:6: (enumLiteral_5= 'wait-alt' )
                    {
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1682:6: (enumLiteral_5= 'wait-alt' )
                    // ../UseCaseDSL/src-gen/UseCaseDSL/parser/antlr/internal/InternalUseCase.g:1682:8: enumLiteral_5= 'wait-alt'
                    {
                    enumLiteral_5=(Token)match(input,46,FOLLOW_46_in_ruleStepType3698); 
    ...
    public static final BitSet FOLLOW_rulePackageDeclaration_in_ruleUseCasesModel130 = new BitSet(new long[]{0x0000000000000802L});
    ...
    public static final BitSet FOLLOW_11_in_rulePackageDeclaration213 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_ruleQualifiedName_in_rulePackageDeclaration234 = new BitSet(new long[]{0x0000000000007010L});
    public static final BitSet FOLLOW_RULE_STRING_in_rulePackageDeclaration251 = new BitSet(new long[]{0x0000000000007000L});
    public static final BitSet FOLLOW_12_in_rulePackageDeclaration270 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_ruleActor_in_rulePackageDeclaration291 = new BitSet(new long[]{0x0000000000006020L});
    public static final BitSet FOLLOW_ruleUseCase_in_rulePackageDeclaration315 = new BitSet(new long[]{0x0000000000006000L});
    public static final BitSet FOLLOW_13_in_rulePackageDeclaration328 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_14_in_ruleUseCase411 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleUseCase428 = new BitSet(new long[]{0x000000000C978010L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleUseCase450 = new BitSet(new long[]{0x000000000C978000L});
    public static final BitSet FOLLOW_15_in_ruleUseCase469 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleUseCase489 = new BitSet(new long[]{0x000000000C970000L});
    public static final BitSet FOLLOW_16_in_ruleUseCase549 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleUCCondition_in_ruleUseCase570 = new BitSet(new long[]{0x000000000C970010L});
    public static final BitSet FOLLOW_17_in_ruleUseCase639 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_ruleUCCondition_in_ruleUseCase660 = new BitSet(new long[]{0x000000000C970010L});
    public static final BitSet FOLLOW_ruleFlow_in_ruleUseCase723 = new BitSet(new long[]{0x000000000C940000L});
    public static final BitSet FOLLOW_18_in_ruleUseCase736 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleActor915 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_ruleActor932 = new BitSet(new long[]{0x000001C000000000L});
    public static final BitSet FOLLOW_ruleActorType_in_ruleActor953 = new BitSet(new long[]{0x0000000000008012L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleActor970 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_15_in_ruleActor989 = new BitSet(new long[]{0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_20_in_ruleBasicFlow1332 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_ruleStep_in_ruleBasicFlow1362 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_21_in_ruleBasicFlow1375 = new BitSet(new long[]{0x0000000000400002L});
    public static final BitSet FOLLOW_22_in_ruleBasicFlow1388 = new BitSet(new long[]{0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_23_in_ruleExceptionFlow1640 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleExceptionFlow1657 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_ruleExceptionFlow1674 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleExceptionFlow1691 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_25_in_ruleExceptionFlow1708 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_ruleStep_in_ruleExceptionFlow1729 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_21_in_ruleExceptionFlow1742 = new BitSet(new long[]{0x0000000000400002L});
    public static final BitSet FOLLOW_22_in_ruleExceptionFlow1755 = new BitSet(new long[]{0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_26_in_ruleAlternativeFlow1861 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleAlternativeFlow1878 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_ruleStep_in_ruleAlternativeFlow1904 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_21_in_ruleAlternativeFlow1917 = new BitSet(new long[]{0x0000000000400002L});
    public static final BitSet FOLLOW_22_in_ruleAlternativeFlow1930 = new BitSet(new long[]{0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_27_in_ruleParallelFlow2036 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleParallelFlow2053 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_ruleStep_in_ruleParallelFlow2079 = new BitSet(new long[]{0x0000000240200000L});
    public static final BitSet FOLLOW_21_in_ruleParallelFlow2092 = new BitSet(new long[]{0x0000000000400002L});
    public static final BitSet FOLLOW_22_in_ruleParallelFlow2105 = new BitSet(new long[]{0x0000000000000010L});
    ...
    public static final BitSet FOLLOW_24_in_ruleCondition2357 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleCondition2374 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_25_in_ruleCondition2391 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_28_in_ruleCondition2404 = new BitSet(new long[]{0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_24_in_ruleLocalAlternative2509 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleLocalAlternative2526 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_25_in_ruleLocalAlternative2543 = new BitSet(new long[]{0x0000000020000010L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleLocalAlternative2561 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_29_in_ruleLocalAlternative2585 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleLocalAlternative2605 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_28_in_ruleLocalAlternative2620 = new BitSet(new long[]{0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_24_in_ruleAlternativeFlowAlternative2725 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleAlternativeFlowAlternative2742 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_25_in_ruleAlternativeFlowAlternative2759 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_ruleAlternativeFlowAlternative2771 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleAlternativeFlowAlternative2791 = new BitSet(new long[]{0x0000000010000002L});
    public static final BitSet FOLLOW_28_in_ruleAlternativeFlowAlternative2804 = new BitSet(new long[]{0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_30_in_ruleParallelStep2909 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleParallelStep2926 = new BitSet(new long[]{0x0000000000000030L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleParallelStep2948 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleParallelStep2974 = new BitSet(new long[]{0x0000000180000002L});
    public static final BitSet FOLLOW_31_in_ruleParallelStep2987 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleParallelStep3007 = new BitSet(new long[]{0x0000000180000002L});
    public static final BitSet FOLLOW_32_in_ruleParallelStep3022 = new BitSet(new long[]{0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_33_in_ruleNormalStep3127 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleNormalStep3144 = new BitSet(new long[]{0x00007E0000000010L});
    public static final BitSet FOLLOW_RULE_STRING_in_ruleNormalStep3166 = new BitSet(new long[]{0x00007E0000000010L});
    public static final BitSet FOLLOW_ruleStepType_in_ruleNormalStep3193 = new BitSet(new long[]{0x0000000400000000L});
    public static final BitSet FOLLOW_34_in_ruleNormalStep3205 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleNormalStep3225 = new BitSet(new long[]{0x0000000920000002L});
    public static final BitSet FOLLOW_35_in_ruleNormalStep3239 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_ruleStepAlternative_in_ruleNormalStep3260 = new BitSet(new long[]{0x0000001001000000L});
    public static final BitSet FOLLOW_36_in_ruleNormalStep3273 = new BitSet(new long[]{0x0000000100000002L});
    public static final BitSet FOLLOW_29_in_ruleNormalStep3293 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleNormalStep3313 = new BitSet(new long[]{0x0000000100000002L});
    public static final BitSet FOLLOW_32_in_ruleNormalStep3329 = new BitSet(new long[]{0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleQualifiedName3439 = new BitSet(new long[]{0x0000002000000002L});
    public static final BitSet FOLLOW_37_in_ruleQualifiedName3458 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleQualifiedName3473 = new BitSet(new long[]{0x0000002000000002L});
    public static final BitSet FOLLOW_38_in_ruleActorType3534 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_39_in_ruleActorType3551 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_40_in_ruleActorType3568 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_41_in_ruleStepType3613 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_42_in_ruleStepType3630 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_43_in_ruleStepType3647 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_44_in_ruleStepType3664 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_45_in_ruleStepType3681 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_46_in_ruleStepType3698 = new BitSet(new long[]{0x0000000000000002L});
