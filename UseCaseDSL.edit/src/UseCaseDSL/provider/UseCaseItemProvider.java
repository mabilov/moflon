...
/**
 * This is the item provider adapter for a {@link UseCaseDSL.UseCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseItemProvider extends ItemProviderAdapter implements
	...
	/**
	 * This adds a property descriptor for the Super Case feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSuperCasePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_UseCase_superCase_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_UseCase_superCase_feature", "_UI_UseCase_type"),
				UseCaseDSLPackage.Literals.USE_CASE__SUPER_CASE, true, false,
				true, null, null, null));
	}
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_UseCase_description_feature", "_UI_UseCase_type"),
				UseCaseDSLPackage.Literals.USE_CASE__DESCRIPTION, true, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_UseCase_name_feature", "_UI_UseCase_type"),
				UseCaseDSLPackage.Literals.USE_CASE__NAME, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/UseCase"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				...
				UseCaseDSLFactory.eINSTANCE.createAlternativeFlow()));

		newChildDescriptors.add(createChildParameter(
				UseCaseDSLPackage.Literals.USE_CASE__FLOWS,
				UseCaseDSLFactory.eINSTANCE.createBasicFlow()));

		newChildDescriptors.add(createChildParameter(
				UseCaseDSLPackage.Literals.USE_CASE__FLOWS,
				UseCaseDSLFactory.eINSTANCE.createExceptionFlow()));
